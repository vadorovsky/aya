 ...
 * **Uncategorized**
    ...
    - Honor `RUSTC_BOOTSTRAP` ([`4cc1402`](https://github.com/vadorovsky/aya/commit/4cc14020fb855472b30ea4927bd2a2a3e6023ce2))
    - Dial the lints to 100 ([`2f8759c`](https://github.com/vadorovsky/aya/commit/2f8759cc62e2a420eef463e271d354fcf65eca9d))
    - Try to build when rustup is not found ([`dc12998`](https://github.com/vadorovsky/aya/commit/dc129982687754ebef39d9f5e24e20d5f4acad84))
    ...
    - Allow to opt out ([`388d1f9`](https://github.com/vadorovsky/aya/commit/388d1f9694f5eb49f1030caf9a17e71679e153e9))
    - Avoid OUT_DIR collisions ([`5c0ebe8`](https://github.com/vadorovsky/aya/commit/5c0ebe8684cd0b3477a7f2dce88230c632237283))
</details>
 ...
 * **Uncategorized**
    ...
    - Plumb features of ebpf crates ([`17573e0`](https://github.com/vadorovsky/aya/commit/17573e0e47fd53c24097a1f92b3e0ecf66a298d4))
    - Guess `bpf_target_arch` from `HOST` ([`948b855`](https://github.com/vadorovsky/aya/commit/948b8553ee72ab72d91c9a16e7e937a75eb0e155))
    - Read AYA_BPF_TARGET_ARCH ([`fe3f5c4`](https://github.com/vadorovsky/aya/commit/fe3f5c4e7dfddd1d4e6496ceadb1752b8522495c))
    - Simplify ([`4b0ddfc`](https://github.com/vadorovsky/aya/commit/4b0ddfc2b0f671d43fbcdeb78c9e46b099404f53))
    - Clarify naming ([`0c7c809`](https://github.com/vadorovsky/aya/commit/0c7c8097b20b11a89238b2102af47efbf95f7a4d))
    - Use OsString::into_string ([`e2c50ac`](https://github.com/vadorovsky/aya/commit/e2c50ac221cf80f33c7e08c65692bb939c396a9e))
    - Pass bpf_target_arch with cfg ([`b4bcf52`](https://github.com/vadorovsky/aya/commit/b4bcf52ef1747932ee581bee803cea3a56ab9f11))
    - Remove cargo_metadata from public API ([`d9704be`](https://github.com/vadorovsky/aya/commit/d9704be77d5020669405c0cdbd98daec66700a8a))
    ...
    - Merge pull request #1273 from aya-rs/dependabot/cargo/cargo-crates-af2cda06bf ([`d1ed76e`](https://github.com/vadorovsky/aya/commit/d1ed76e626acb85bdb33ffe0470435fd963f64d6))
    - Bump the cargo-crates group with 2 updates ([`a7e3e6d`](https://github.com/vadorovsky/aya/commit/a7e3e6d4d90767d40a015a473a7d0623031ff6ee))
    - Enable BTF ([`eab5661`](https://github.com/vadorovsky/aya/commit/eab5661a0eff32e5f85fdf903acfdacf259ddbe1))
    - Allow setting Rust nightly version ([`6d36fe1`](https://github.com/vadorovsky/aya/commit/6d36fe13d31fd4d1ed14d2dbe33f9536c5398993))
    ...
    - Add explicit irrefutable pattern ([`3d8cb08`](https://github.com/vadorovsky/aya/commit/3d8cb08b7f067a5d57a7268d0b53131b527f4583))
    - Enable anyhow/std ([`015c0df`](https://github.com/vadorovsky/aya/commit/015c0df0f41f9aa20556dadd282899afb2e2123d))
    - Add description ([`6970353`](https://github.com/vadorovsky/aya/commit/6970353b58852f8732a8d37f1b281662aab8a11d))
    - Extract aya-build for building eBPF crates ([`2b2af44`](https://github.com/vadorovsky/aya/commit/2b2af44915166f1e942daf6598072aeea27f1ba5))
</details>
