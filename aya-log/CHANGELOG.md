...
<csr-read-only-do-not-edit/>
 ...
 - 2 unique issues were worked on: [#1008](https://github.com/vadorovsky/aya/issues/1008), [#1428](https://github.com/vadorovsky/aya/issues/1428)
 ...
 * **[#1008](https://github.com/vadorovsky/aya/issues/1008)**
    - Print &[u8] using full width ([`55ed9e0`](https://github.com/vadorovsky/aya/commit/55ed9e054665ba303e1fb381c7ac590056da7724))
 * **[#1428](https://github.com/vadorovsky/aya/issues/1428)**
    - Symlink licenses into aya log ([`ac85ad2`](https://github.com/vadorovsky/aya/commit/ac85ad27df867526f7ed7fd9b8fe41303878c98d))
 * **Uncategorized**
    ...
    - Add `#[must_use]` attribute to `EbpfLogger` ([`e2a68ee`](https://github.com/vadorovsky/aya/commit/e2a68ee38412d6a523e803fc077e8baf834545ba))
    - Zero copy! ([`353b833`](https://github.com/vadorovsky/aya/commit/353b83383dccc430619f3c6d95e17edd6ca8a96c))
    - Implement load-time log level mask ([`b36cbc3`](https://github.com/vadorovsky/aya/commit/b36cbc3eb8413d4fba4f2d820fec8176751457ac))
    - Implement `AsFd` for `EbpfLogger` ([`44ec978`](https://github.com/vadorovsky/aya/commit/44ec978bd35c5af484b73c273b5bd18886033b5a))
    - Simplify map name matching using direct Option comparison ([`0b732c3`](https://github.com/vadorovsky/aya/commit/0b732c3d468ecb9855b58bd61be2b0972baa3a8a))
    - Use `None` instead of wildcard in `Format` impls ([`cab559b`](https://github.com/vadorovsky/aya/commit/cab559b9d954a02237636f704bfd23909d524732))
    - Remove tokio dep ([`61376c4`](https://github.com/vadorovsky/aya/commit/61376c4608ebd2c10f05f3e917833832158d7c87))
    ...
    - Remove pointless `map_err` calls ([`87188f6`](https://github.com/vadorovsky/aya/commit/87188f621a1cc347240eb05248ac9df61feb9f57))
    - Remove dead code expectation fixed upstream ([`30d5c9f`](https://github.com/vadorovsky/aya/commit/30d5c9f53e08d059d2c0a3252508aab242b68c44))
    ...
    - Release aya-log v0.2.1 ([`0e70838`](https://github.com/vadorovsky/aya/commit/0e70838b0f896ec73a4c7a51cab29625e7c87f9a))
    ...
    - Revert "Remove unused `allow(dead_code)`" ([`4161993`](https://github.com/vadorovsky/aya/commit/41619933d64289bec02c6672bd2248a8075eff3e))
    - Remove unused `allow(dead_code)` ([`5397c1c`](https://github.com/vadorovsky/aya/commit/5397c1ca4b77cd27082e96aab9ab931631df7fa8))
    ...
    - Merge pull request #900 from catalin-h/log_init_from_program_id ([`e5d107d`](https://github.com/vadorovsky/aya/commit/e5d107dd50b13ccf9783b9af4e79b57b02c1f0f3))
    - Reword rustdocs a bit ([`8830c0b`](https://github.com/vadorovsky/aya/commit/8830c0bc20c6e3dbbddf63533d4623fcd45dd9af))
    - Allow re-attach and read previously created logs ([`e66f954`](https://github.com/vadorovsky/aya/commit/e66f9540c9196ecce16431542366771b6505124f))
    ...
    - Rename BpfLogger to EbpfLogger ([`a93e354`](https://github.com/vadorovsky/aya/commit/a93e3546204115631c11bc0601905c205bf8a584))
 ...
 * **Uncategorized**
    ...
    - Add CHANGELOG ([`9abb716`](https://github.com/vadorovsky/aya/commit/9abb7160e51dd18c509049b1371acd96515d8f04))
    ...
    - Merge pull request #736 from aya-rs/logging-better ([`45df251`](https://github.com/vadorovsky/aya/commit/45df2519b60613310e8827fbb4076f60c393c3bb))
    ...
    - Remove pointless DefaultLogger ([`00d265c`](https://github.com/vadorovsky/aya/commit/00d265c51b69e672457502593fbc63d0ac953e27))
    ...
    - Check errors in tests ([`e4537e3`](https://github.com/vadorovsky/aya/commit/e4537e389ad7ac6f09fc89349444e37fe01e4af4))
    - Aya-log, aya-log-common: Remove duplicate struct ([`490d7d5`](https://github.com/vadorovsky/aya/commit/490d7d587ad90b899aff2a30d65db8641ceb32df))
    ...
    - Don't panic in init when bpf programs don't log ([`12927cf`](https://github.com/vadorovsky/aya/commit/12927cf6992bc0f8b1e4221d48b34f4c0098b93d))
    ...
    - Merge pull request #449 from aya-rs/dependabot/cargo/env_logger-0.10 ([`f9bef9f`](https://github.com/vadorovsky/aya/commit/f9bef9f8c0d2c5b21809e037b8e9782f3c761df3))
    - Update env_logger requirement from 0.9 to 0.10 ([`1c8088b`](https://github.com/vadorovsky/aya/commit/1c8088b16cc255fc188b0b9a84b550a5c50a9003))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #390 from dave-tucker/clippy-up ([`367ab20`](https://github.com/vadorovsky/aya/commit/367ab203057329ea32eea34ddc97452e0c03fda6))
    - Make miri happy ([`b2924a3`](https://github.com/vadorovsky/aya/commit/b2924a3a264732e6de6898a1f03d7cb22d1d0dc5))
    ...
    - Merge pull request #361 from chenhengqi/fix-aya-log-links ([`632ea30`](https://github.com/vadorovsky/aya/commit/632ea300ed8dcb3a277447a57b528b8d89b0c10a))
    - Fix links to aya-log repo ([`b8b291c`](https://github.com/vadorovsky/aya/commit/b8b291c51ba1b43ff27c6aab6b55d6af77334aae))
    - Merge pull request #357 from vadorovsky/env_logger ([`3d5ab0b`](https://github.com/vadorovsky/aya/commit/3d5ab0b17de0e4f1453a88ed00823d04db0845a6))
    - Aya-log, test: Switch from simplelog to env_logger ([`3664e1e`](https://github.com/vadorovsky/aya/commit/3664e1ea0d42985bd88129cfd338bacff2456398))
    ...
    - Fix the log buffer bounds ([`28abaec`](https://github.com/vadorovsky/aya/commit/28abaece2af732cf2b2b2f8b12aeb02439e76d4c))
    - Ensure log buffer bounds ([`2e07028`](https://github.com/vadorovsky/aya/commit/2e0702854b0e2428f6b5b32678f5f79ca341c619))
    - Use new PerCpuArray::get_ptr_mut API ([`6aea880`](https://github.com/vadorovsky/aya/commit/6aea88089087194c831b259a61eef5ccebcb45bc))
    - Aya-log, aya-log-common: start next development iteration 0.1.11-dev.0 ([`526493b`](https://github.com/vadorovsky/aya/commit/526493b444ed91f1c315ace494b41b8f4178fe65))
    - Aya-log, aya-log-common: release version 0.1.10 ([`3abd973`](https://github.com/vadorovsky/aya/commit/3abd97307ef32bfbd384f38f7a0de40cc7afa0b1))
    - Update aya requirement from 0.10.7 to 0.11.0 ([`060ba45`](https://github.com/vadorovsky/aya/commit/060ba451535b1a90c2faaf2dcd634fa36e784efb))
    - Add CI ([`0038b43`](https://github.com/vadorovsky/aya/commit/0038b43627e6564b03d9837f535ec64ada6d70f2))
    - Add vim/vscode rust-analyzer settings ([`c1bb790`](https://github.com/vadorovsky/aya/commit/c1bb790c0d8d467ac41603b15b56823c7ba0f663))
    - Add rustfmt.toml ([`3f00851`](https://github.com/vadorovsky/aya/commit/3f0085195f178fdba6c214b4129f8321e612d4e7))
    - Add example ([`5789585`](https://github.com/vadorovsky/aya/commit/5789585994776d18afa58f3bb816cfcb1367298e))
    - Add Tests ([`5d82d9a`](https://github.com/vadorovsky/aya/commit/5d82d9a73e77d386c8be3dc3764b3dd361fcac71))
    - Ensure the bounds of log buffer ([`628b473`](https://github.com/vadorovsky/aya/commit/628b473e0937eef94b0b337608a5d6c51ad2fd2a))
    - Bump the buffer size ([`70b4e68`](https://github.com/vadorovsky/aya/commit/70b4e681301eb23ca776cd703e11f19cc879ac69))
    - Aya-log, aya-log-common: start next development iteration 0.1.10-dev.0 ([`bd9a5c8`](https://github.com/vadorovsky/aya/commit/bd9a5c8fdff9c20952137908388b1d833ab60fcc))
    - Aya-log, aya-log-common: release version 0.1.9 ([`8bc1bbb`](https://github.com/vadorovsky/aya/commit/8bc1bbb3abe588e89161e67ad013c34f1ec3ab6d))
    - Add cargo-release config ([`a8d133f`](https://github.com/vadorovsky/aya/commit/a8d133f6b0919bb7d8e821f1309ee264d8b03a71))
    - Do not release ([`d1a0ce5`](https://github.com/vadorovsky/aya/commit/d1a0ce51ee4e67cf9b03b695940f356ee950f8c2))
    - Use stricter version for the aya-log-common dep ([`c4d89fa`](https://github.com/vadorovsky/aya/commit/c4d89fa13cb4e96a62ccd5cae7cf1834c3c582f6))
    - Inline write_record_header ([`bdb2750`](https://github.com/vadorovsky/aya/commit/bdb2750e66f922ebfbcba7250add38e2c932c293))
    - Update aya to 0.10.7 ([`81befa0`](https://github.com/vadorovsky/aya/commit/81befa06610b9e771523bceee4871a704851b1f0))
    - Format arguments in userspace ([`ca1fe7e`](https://github.com/vadorovsky/aya/commit/ca1fe7e05f7b52c5e864680abeda29e640617d40))
    - Don't recompute the record length ([`9b229d0`](https://github.com/vadorovsky/aya/commit/9b229d00e110a5b3b610ad567f8d15682c0b78e1))
    - Initialize AYA_LOGS with max_entries=0 ([`7f8d705`](https://github.com/vadorovsky/aya/commit/7f8d7057df11f41d0869f7f713d121785934adca))
    - Fix clippy warning ([`2800454`](https://github.com/vadorovsky/aya/commit/2800454763f5f0250c46c87f9cfb2e3d1f5f0a7e))
    - Add copy of README.md inside aya-log/ ([`8bde15d`](https://github.com/vadorovsky/aya/commit/8bde15dad70016f6fb72a77906da341768d59720))
    - Add missing manifest fields ([`5e18a71`](https://github.com/vadorovsky/aya/commit/5e18a715b2d1cf153de96d9775dfea762c684258))
    - (cargo-release) version 0.1.1 ([`31e71f8`](https://github.com/vadorovsky/aya/commit/31e71f8db53454ce673bd9891be06fc002af5721))
    - (cargo-release) version 0.1.1 ([`29955b2`](https://github.com/vadorovsky/aya/commit/29955b22875b865f567079c76aeba70630fa42dd))
    - Git add .cargo and xtask ([`6d14a16`](https://github.com/vadorovsky/aya/commit/6d14a16d8ed54d90e9dfdbdca1fb2caf0a15c017))
    - Update to aya 0.10.5 ([`cced3da`](https://github.com/vadorovsky/aya/commit/cced3da5c8ff45df0596e25123071a4a761286d6))
    - Simplify BpfLogger::init ([`9ab9c80`](https://github.com/vadorovsky/aya/commit/9ab9c80183edcb23297a644d0e63f7c1f28cd968))
    - Minor tweaks to make the verifier's job easier ([`2ac4334`](https://github.com/vadorovsky/aya/commit/2ac433449cdea32f10c8fc88218799995946032d))
    - Switch to aya-ufmt ([`b14d4ba`](https://github.com/vadorovsky/aya/commit/b14d4bab2fac894d4e47838d7de8a9b63a5ac4c2))
    - Use aya_bpf::maps::PerfEventByteArray to output logs ([`22d8f86`](https://github.com/vadorovsky/aya/commit/22d8f86fbb10ec5e71bca750119f93eb5ba171e5))
    - Use aya_log_ebpf::ufmt instead of ::ufmt ([`741957f`](https://github.com/vadorovsky/aya/commit/741957f94598d149960a5296b2010a07ffac02e5))
    - Add ufmt to readme ([`0d7ac3e`](https://github.com/vadorovsky/aya/commit/0d7ac3eb3ee58bd4ba10af9c49f7c9ef80e09143))
    - Update readme ([`5df853c`](https://github.com/vadorovsky/aya/commit/5df853cfb030c3a37a066b892623546a77c97db2))
    - Initial commit ([`b29a061`](https://github.com/vadorovsky/aya/commit/b29a061bce99d06971dc977ddc075cbf653971d4))
</details>
