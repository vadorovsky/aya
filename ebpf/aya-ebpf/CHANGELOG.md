...
<csr-read-only-do-not-edit/>
 ...
 - 2 unique issues were worked on: [#1139](https://github.com/vadorovsky/aya/issues/1139), [#1501](https://github.com/vadorovsky/aya/issues/1501)
 ...
 * **[#1139](https://github.com/vadorovsky/aya/issues/1139)**
    - Fix aya-ebpf-* riscv64 build ([`1fe12b9`](https://github.com/vadorovsky/aya/commit/1fe12b99907dda6553a6069fa462d6241d3fa171))
 ...
 * **Uncategorized**
    ...
    - Document raw tracepoint args ([`79cdfd8`](https://github.com/vadorovsky/aya/commit/79cdfd802eb6ba2259ffe87e0ca604130e418764))
    ...
    - Document FExit ret kernel range ([`46759c9`](https://github.com/vadorovsky/aya/commit/46759c99560202091983e5741bdb06dce6c1d90b))
    - Add FExitContext::ret ([`a73f864`](https://github.com/vadorovsky/aya/commit/a73f8642328adfc033ed879c1f3638e9c76ac7fe))
    ...
    - Add BTF hash family and seal safe inner lookup ([`e7173fd`](https://github.com/vadorovsky/aya/commit/e7173fd7ce396d03c5af78ec463b80b367f277ad))
    - Add BTF XskMap and CpuMap ([`2b21599`](https://github.com/vadorovsky/aya/commit/2b21599af72a56a432c9e1f823ca089defc1e3f3))
    ...
    - Add BTF DevMap and DevMapHash ([`51f7320`](https://github.com/vadorovsky/aya/commit/51f732091cefd7dc0fac6449ab93e782bf98a458))
    - Add BTF queue/stack maps and propagate errno from legacy ([`32154c1`](https://github.com/vadorovsky/aya/commit/32154c1725fad6ec9233abac58917b58a12a7b62))
    - Add BTF SockMap/SockHash, preserve redirect_sk_lookup errno ([`f404bb7`](https://github.com/vadorovsky/aya/commit/f404bb7bb0484f238ea8ebe93db684f807fcc4b9))
    - Aya-ebpf, integration-ebpf: migrate to StackIdContext::get_stackid ([`6e0ac98`](https://github.com/vadorovsky/aya/commit/6e0ac985a085bd7958bf3ab880802b8049dd8415))
    - Introduce StackIdContext sealed trait ([`4185559`](https://github.com/vadorovsky/aya/commit/418555942721919273015522bee48538ee99bf3f))
    - Add BTF map definition for perf event array ([`ee8110a`](https://github.com/vadorovsky/aya/commit/ee8110a50fe91c0c5553954fbef4d14ca3bd10cd))
    - Add BTF map definition for stack trace ([`9c82966`](https://github.com/vadorovsky/aya/commit/9c82966729f400ebf4d13c6d0308fd7e60acf54d))
    - Aya-ebpf-bindings, aya-ebpf: expose PERF_MAX_STACK_DEPTH ([`61eea8a`](https://github.com/vadorovsky/aya/commit/61eea8ada7ac42270add8f0bf37ea12fed2dc44f))
    ...
    - Add BTF map definition for program array ([`6f34b79`](https://github.com/vadorovsky/aya/commit/6f34b7955799dbf2f33f7030789bd470e019fc28))
    - Allow btf_map_def! with no type params ([`4239f5f`](https://github.com/vadorovsky/aya/commit/4239f5f522efbae1bbdba3b026aa3b572edddb0d))
    - Fix unsound fallthrough in ProgramArray::tail_call ([`8edfe49`](https://github.com/vadorovsky/aya/commit/8edfe492cc4098fe4c9055f71f426f079421d2f0))
    - Add BTF map definition for per-cpu array ([`3e755ab`](https://github.com/vadorovsky/aya/commit/3e755abd7e1957845c8dccc94a84ac9b433922db))
    - Add set to legacy PerCpuArray ([`0bd9b18`](https://github.com/vadorovsky/aya/commit/0bd9b18e62e5420d07c9546f61fe1a1c71764522))
    - Add BTF map definition for LPM trie ([`caa355d`](https://github.com/vadorovsky/aya/commit/caa355d77707b6250653aa2f42311123fe04ee88))
    - Add mips64 arch ([`8799257`](https://github.com/vadorovsky/aya/commit/879925717b88957fcb71e1dd7df3022372dfb796))
    - Use correct types for BPF helper return values ([`df3da54`](https://github.com/vadorovsky/aya/commit/df3da549cb3a9978f8f8113e13733887bff2add6))
    - Fix bpf_printk variadic argument passing ([`8c47886`](https://github.com/vadorovsky/aya/commit/8c47886dea1a6ea7e3d167fdd5340d56532450f9))
    - Add `bpf_f_adj_room_encap_l2` ([`8aeec41`](https://github.com/vadorovsky/aya/commit/8aeec41eec84ef0043ad11932d5f2d5f072c2c12))
    - Use &self for store, set_mark and set_reply ([`a826cc9`](https://github.com/vadorovsky/aya/commit/a826cc92c93d3d8132af55a588f2d2d9d8db5b89))
    ...
    - Use plain arrays in ring buf tests ([`b93ee8c`](https://github.com/vadorovsky/aya/commit/b93ee8c26e96af85d77b040fa4fae8447c8fd7f8))
    - Rename EbpfGlobal to Global ([`b9cb76b`](https://github.com/vadorovsky/aya/commit/b9cb76b302bdd1288b6486fb3a0627ea40cc3dbc))
    - Document nul termination ([`ab7f96d`](https://github.com/vadorovsky/aya/commit/ab7f96dafba47e12c328fddde14c58f2559c000d))
    - Take `&self` in all methods of `BloomFilter` ([`0bf462d`](https://github.com/vadorovsky/aya/commit/0bf462d221af7f86b0f76da996f11445635a33e6))
    - Use `i32` as a type for eBPF helper return codes ([`8962fc7`](https://github.com/vadorovsky/aya/commit/8962fc79c11552ee5193a18663474039371e7671))
    ...
    - Use read_kernel() for read_at() ([`dd9bb52`](https://github.com/vadorovsky/aya/commit/dd9bb520d26d7b86d8ba38119ab52d0252bf4c18))
    - Dial the lints to 100 ([`2f8759c`](https://github.com/vadorovsky/aya/commit/2f8759cc62e2a420eef463e271d354fcf65eca9d))
    - Do not anonymize BTF maps ([`998ad08`](https://github.com/vadorovsky/aya/commit/998ad08ba0612fa5411d1f8bbdd7b07caaacf3b1))
    ...
    - Define hash maps via macro ([`3946688`](https://github.com/vadorovsky/aya/commit/394668806bd96f8f082ce70fe042fa17cdcb3e5e))
    - Aya, aya-ebpf: reduce duplication ([`f35f7a3`](https://github.com/vadorovsky/aya/commit/f35f7a3610d8296d97c6f0a47e75dbb4188f5212))
    - Add BTF ring buffer ([`3eb9cac`](https://github.com/vadorovsky/aya/commit/3eb9cacef4cfefe0832aff36aad2a9e1daeb57ba))
    - Fix redirect_sk_lookup receiver type ([`1d10f87`](https://github.com/vadorovsky/aya/commit/1d10f8751d622b6ac85db228a30aa2bb7e60665e))
    ...
    - Reduce duplication ([`03fea9e`](https://github.com/vadorovsky/aya/commit/03fea9e3042009cc43a76f2d15769ded69532be3))
    - Enable clippy::as_underscore ([`17c7c79`](https://github.com/vadorovsky/aya/commit/17c7c7951cb45a5903134b21658df7e989e672ed))
    - Enable unsafe_op_in_unsafe_fn ([`778b447`](https://github.com/vadorovsky/aya/commit/778b447e3b75497198b567d733ca68d7981e5cde))
    - Extract CARGO_CFG_BPF_TARGET_ARCH logic ([`f610453`](https://github.com/vadorovsky/aya/commit/f610453ec234921c07aeb4d5401d0a8940d513df))
    - Reduce repetition and excessive traits ([`05250da`](https://github.com/vadorovsky/aya/commit/05250da20bffca7742fcdf681392cf17ff02866f))
    - Enable bpf_target_arch = loongarch64 ([`4b4b9f8`](https://github.com/vadorovsky/aya/commit/4b4b9f83bd6c1762a5366d2d89353adf4364f76e))
    - Make use of `Borrow` and `BorrowMut` in map methods ([`98e8c78`](https://github.com/vadorovsky/aya/commit/98e8c78376286bbdc8c7ee3f0292b878cec24b99))
    - Add BPF_MAP_TYPE_SK_STORAGE ([`de42b80`](https://github.com/vadorovsky/aya/commit/de42b80c74883f512542875e7cfa96b8634a8991))
    - Use null pointers at runtime ([`0013ff4`](https://github.com/vadorovsky/aya/commit/0013ff4e9eadd5e97126b0a1916e90772ed87114))
    - Use `ptr::from_ref` ([`275c5b6`](https://github.com/vadorovsky/aya/commit/275c5b6bbc3cf3dfac79d5dacb46377e2d296fe7))
    ...
    - Remove irrelevant `FIXME` comment ([`d5e4e92`](https://github.com/vadorovsky/aya/commit/d5e4e9270ae4214ced858582ecb7ec6fc979d77e))
    - Take `c_void` instead of `bpf_map_def` in map helpers ([`3569c9a`](https://github.com/vadorovsky/aya/commit/3569c9afc3dc7babb6b44aa071828df7c8864834))
    - Add RingBufBytes for raw byte slices ([`3f60168`](https://github.com/vadorovsky/aya/commit/3f60168d4bab042d26094f7962b96f0772b52ae7))
    - Destructure, avoid `as` casts ([`f537dc6`](https://github.com/vadorovsky/aya/commit/f537dc66845e70bc3af2dbb9944562cf38117bcb))
    - Add peak() method to Queue and Stack ([`53ec616`](https://github.com/vadorovsky/aya/commit/53ec6164114bba84be145dc9659aaac917dd7a15))
    - Disable generic_const_exprs ([`ccf6c47`](https://github.com/vadorovsky/aya/commit/ccf6c4707f136e5c026f806774dac89efe7d78e3))
    - Add a dedicated generic_const_exprs cfg ([`4f65486`](https://github.com/vadorovsky/aya/commit/4f654865e9e592a93e11feb8558a461c4b6865b5))
    - Put mem{set,move,cpy} behind cfg(target_arch = "bpf") ([`6004fcd`](https://github.com/vadorovsky/aya/commit/6004fcdb0fb5a6157ba5416f439e5807567c87a7))
    ...
    - Add queue ID matching to AF_XDP test ([`e1cb423`](https://github.com/vadorovsky/aya/commit/e1cb4237bd1e8fdaa0d85f97684c63401ae0ed33))
    - Merge pull request #1141 from gth828r/1140.xdp-context-if-index-support ([`0fa300f`](https://github.com/vadorovsky/aya/commit/0fa300f696ebd98fe2b70f5680fff50a0d02bf42))
    - Add `set` for `Array<T>` ([`2fb19f3`](https://github.com/vadorovsky/aya/commit/2fb19f3ee2c95a34382b33762e9fb8841ec8c048))
    - Extract insert,remove,lookup ([`601c89d`](https://github.com/vadorovsky/aya/commit/601c89dd23d8ac34ebd7cd80af87a3e9ba6da255))
    - Add ifindex support to XdpContext ([`dc543ae`](https://github.com/vadorovsky/aya/commit/dc543ae44aab09ea9ab550b164ca0711293e87fe))
    ...
    - Implement FromPtRegs for mips ([`1ccac3c`](https://github.com/vadorovsky/aya/commit/1ccac3c135f280eead50ff18cd4c4340001018c6))
    - Handle raw tracepoint arguments ([`f34d355`](https://github.com/vadorovsky/aya/commit/f34d355d7d70f8f9ef0f0a01a4338e50cf0080b4))
    - Fix cippy errors ([`4f0559f`](https://github.com/vadorovsky/aya/commit/4f0559f2afeca1dfae120bacf1742d58268bca37))
    - Allow aya-ebpf to clippy with stable rust ([`1de7e72`](https://github.com/vadorovsky/aya/commit/1de7e728b64c1fc706b1802b4eb5d2642570a1f3))
    - Add `bpf_strncmp` helper ([`0b58d3e`](https://github.com/vadorovsky/aya/commit/0b58d3eb6d399c812181d2d64de32cde1b44f6eb))
</details>
 ...
 * **Uncategorized**
    - Release aya-ebpf-cty v0.2.2, aya-ebpf-bindings v0.1.1, aya-ebpf-macros v0.1.1, aya-ebpf v0.1.1 ([`59082f5`](https://github.com/vadorovsky/aya/commit/59082f572c01e8356312ed53bdb818cfbea944b5))
    - Merge pull request #1020 from l2dy/sockops-ctx ([`635ed3b`](https://github.com/vadorovsky/aya/commit/635ed3baed5442c1364a360d7234b72c4ffe3fd8))
    - Add set_reply accessor to SockOpsContext ([`95e1763`](https://github.com/vadorovsky/aya/commit/95e1763e30e0dcfe1256ecd9e32ca27dd65342b4))
    ...
    - Remove PerfEventArray::with_max_entries ([`ef0d125`](https://github.com/vadorovsky/aya/commit/ef0d1253efcc5a385afc74668d4f28580d328822))
    - Implement memmove ([`7ad3926`](https://github.com/vadorovsky/aya/commit/7ad3926d996f6471da05a8f3cab0283bb38c1498))
    - Allowlist expected cfgs ([`e4f9ed8`](https://github.com/vadorovsky/aya/commit/e4f9ed8d79e4cd19ab5124352fca9e6cbdc1030b))
    - Deny warnings ([`b603c66`](https://github.com/vadorovsky/aya/commit/b603c665a9a2ec48de2c4b412876bd015e5ead15))
    - Moved ret from ProbeContext into new RetProbeContext ([`2d38b23`](https://github.com/vadorovsky/aya/commit/2d38b23b99cd259f7a249f4c63b12da909c67015))
    - Appease clippy ([`57cd351`](https://github.com/vadorovsky/aya/commit/57cd35172f1534444a548460de6eae4680488711))
</details>
 ...
 * **Uncategorized**
    - Release aya-ebpf v0.1.0 ([`c3ae6f9`](https://github.com/vadorovsky/aya/commit/c3ae6f90d8d3be8b31d1de9ccc042133f9ac8f44))
    - Release aya-ebpf-macros v0.1.0, aya-ebpf v0.1.0 ([`eb3947b`](https://github.com/vadorovsky/aya/commit/eb3947bf14e8e7ab0f70e12306e38fb8056edf57))
    - Release aya-ebpf-bindings v0.1.0, aya-ebpf-macros v0.1.0, aya-ebpf v0.1.0 ([`a34c5e4`](https://github.com/vadorovsky/aya/commit/a34c5e43b85dd176b9b18f1cc9c9d80d52f10a1f))
    - Add version keys to Cargo.toml(s) ([`a4ae8ad`](https://github.com/vadorovsky/aya/commit/a4ae8adb0db75f2b82b10b0740447a1dbead62c0))
    - Release aya-ebpf-bindings v0.1.0, aya-ebpf-macros v0.1.0, aya-ebpf v0.1.0 ([`b8964d3`](https://github.com/vadorovsky/aya/commit/b8964d3fd27353beb9054dd18fe8d16251f9164b))
    - Add changelogs ([`c7fe60d`](https://github.com/vadorovsky/aya/commit/c7fe60d47e0cc32fc7123e37532d104eaa392b50))
    ...
    - Rename BpfContext -> EbpfContext ([`d7af6ac`](https://github.com/vadorovsky/aya/commit/d7af6acb42055ed1e0571bdc4d7dbbfa46c5835e))
    - Rename bpf -> ebpf ([`ea80737`](https://github.com/vadorovsky/aya/commit/ea8073793e44c593e983e69eaa43a4f72799bfc5))
    - Rename bpf -> ebpf ([`41c6156`](https://github.com/vadorovsky/aya/commit/41c61560eae01a30c703ea22c5bfeeff0ecf6b1b))
</details>
