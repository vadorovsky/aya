...
<csr-read-only-do-not-edit/>
 ...
 - 132 commits were understood as [conventional](https://www.conventionalcommits.org).
 - 4 unique issues were worked on: [#1119](https://github.com/vadorovsky/aya/issues/1119), [#1235](https://github.com/vadorovsky/aya/issues/1235), [#1443](https://github.com/vadorovsky/aya/issues/1443), [#1501](https://github.com/vadorovsky/aya/issues/1501)
 ...
 * **[#1119](https://github.com/vadorovsky/aya/issues/1119)**
    - Update docs for load to mention include_bytes_aligned ([`df053f0`](https://github.com/vadorovsky/aya/commit/df053f095b67f8984ae31fd0ca1042f4e38c3378))
 * **[#1235](https://github.com/vadorovsky/aya/issues/1235)**
    - Fix is_probe_read_kernel_supported in aarch64 kernels 5.5 ([`fc69a06`](https://github.com/vadorovsky/aya/commit/fc69a069727475060ee6d9895ac2745b8965237f))
 * **[#1443](https://github.com/vadorovsky/aya/issues/1443)**
    - Set value_size to 0 if loading ringbuffer ([`d022b8d`](https://github.com/vadorovsky/aya/commit/d022b8dce40fb60271a1270b13efb60951208328))
 ...
 * **Uncategorized**
    - Prevent `NetNsGuard` from crossing threads ([`bf18994`](https://github.com/vadorovsky/aya/commit/bf1899471bda7a97691876a379f3e04ceda685b3))
    - Clean up after errors in `NetNsGuard::new()` ([`e2ab3ee`](https://github.com/vadorovsky/aya/commit/e2ab3ee0e2ec85116f4529bcc97a5da4f7043e70))
    - Return an error instead of panicking ([`8d1d15b`](https://github.com/vadorovsky/aya/commit/8d1d15b7dabe29e3349327f6657e4def391dfe3f))
    - Add a docstring for `NetlinkError::raw_os_error()` ([`745065a`](https://github.com/vadorovsky/aya/commit/745065a74241ae8c39180c0cdc1a5444b5605dfb))
    - Move `utils.rs` from the `integration-test` crate to `aya` ([`b9b92ce`](https://github.com/vadorovsky/aya/commit/b9b92ce197171717d99cd9ea1eed29b1cfa0666b))
    - Fix consumer ordering ([`7277a57`](https://github.com/vadorovsky/aya/commit/7277a57ea8cdb74918d3096a4b22b6d814481973))
    - Aya, aya-ebpf: add InodeStorage and CgrpStorage ([`bd397b6`](https://github.com/vadorovsky/aya/commit/bd397b644723b13bc4397acb0c792546d5df7215))
    - Aya, aya-ebpf: add CgroupStorage and PerCpuCgroupStorage ([`9ec80ac`](https://github.com/vadorovsky/aya/commit/9ec80ac6a91b8edbc51a0476560d38d843bf8031))
    - Support socket filter reuseport attach ([`6fbf4c7`](https://github.com/vadorovsky/aya/commit/6fbf4c751d3e7093379a2f64cdf38b7265ca3c18))
    - Replace test-case with rstest ([`f10988d`](https://github.com/vadorovsky/aya/commit/f10988d56a2ac7575cfd79c0eaec66b62a9b6227))
    - Properly check tracing support ([`b5c672c`](https://github.com/vadorovsky/aya/commit/b5c672c69bf667dd6a0929c6712b535e1b3b3495))
    - Support test-run for fexit ([`3d0c7b8`](https://github.com/vadorovsky/aya/commit/3d0c7b839e09399fb64aaff40342fc2a3395563a))
    - Aya, aya-ebpf: add CgroupArray ([`eb73f8c`](https://github.com/vadorovsky/aya/commit/eb73f8ca9260e48141a1bdf1a492799826a85515))
    ...
    - Add uprobe virtual address helper ([`4bd00c5`](https://github.com/vadorovsky/aya/commit/4bd00c569ef291b20a63a6892a4aae05d6a268d8))
    - Relax SkReuseport receivers ([`1412bb3`](https://github.com/vadorovsky/aya/commit/1412bb3747801644abc773d8a1d7c5123fe7aec7))
    - Remove SocketFilter link abstraction ([`1ade96f`](https://github.com/vadorovsky/aya/commit/1ade96f5f87519c6e879b35412c68ec76759019f))
    - Add classid to SchedClassifier netlink attach ([`98d8feb`](https://github.com/vadorovsky/aya/commit/98d8feb63325c9576caf6aa2040c465c985ef5ee))
    - Introduce TcHandle newtype ([`d82050a`](https://github.com/vadorovsky/aya/commit/d82050acac6fd803f51caa0cba7cb63b59076146))
    - Reuse helper probe internally ([`bed496b`](https://github.com/vadorovsky/aya/commit/bed496b37bd9969372d3263bfd2b02f61bef8def))
    - Add eBPF helper feature probe ([`faae977`](https://github.com/vadorovsky/aya/commit/faae977ae953a23839357e1a53f7419b3781c3a8))
    - Fix program type constants ([`df1e81c`](https://github.com/vadorovsky/aya/commit/df1e81c1302a29c51b6d21a92ee645d637e271ff))
    ...
    - Make XDP attach mode type-safe ([`ae94e9e`](https://github.com/vadorovsky/aya/commit/ae94e9e10719860fefd6199f95ad87ff5367e1db))
    - Implement BPF_PROG_TEST_RUN ([`d10c87e`](https://github.com/vadorovsky/aya/commit/d10c87e2506dfc78de9f79ae443999ae0a05e8e6))
    - Aya, integration-test: replace read_events with try_fold/fold/for_each ([`be9d3fa`](https://github.com/vadorovsky/aya/commit/be9d3faf26115e6ab4a00e41fb6aee966d12743e))
    - Add acquire fence on perf data_head load ([`53cda5f`](https://github.com/vadorovsky/aya/commit/53cda5ffa0934f72f9828833c5dc376517adfd24))
    - Remove the `no_std` support ([`0739126`](https://github.com/vadorovsky/aya/commit/073912689c6c842bba594eae349b8ddd3b0c2d91))
    - Cover BTF type-id strip for blocklisted map types ([`11b7b09`](https://github.com/vadorovsky/aya/commit/11b7b0982dede7f0f5ff4b3e0f0b8e4c0e2e3101))
    - Tighten uprobe basename target check ([`18153c7`](https://github.com/vadorovsky/aya/commit/18153c74fa12c8771e4f7904ed6abcb85261ac96))
    - Skip ProcMap for path-like uprobe targets ([`e25040f`](https://github.com/vadorovsky/aya/commit/e25040ffe14de4521fdcdb539ce0b234aa966e1c))
    - Replace pid Option<u32> with UProbeScope ([`759087b`](https://github.com/vadorovsky/aya/commit/759087ba7bd75267097b5d891a5d2a8be6ccf993))
    - Fix pid=0 handling in uprobe attach ([`8912e41`](https://github.com/vadorovsky/aya/commit/8912e413f36b9839e514f475e8b47029706e9a35))
    - Reject BPF_F_STACK_BUILD_ID in StackTraceMap ([`decfe44`](https://github.com/vadorovsky/aya/commit/decfe44005b4b10cf3a241b21c2c35bdf53fd045))
    ...
    - Fix TryFrom<FdLink> link type checks ([`85246f0`](https://github.com/vadorovsky/aya/commit/85246f00e984b0b3b0ccdaa422d301b31e109881))
    ...
    - Set fixed expected attach types ([`2ed3531`](https://github.com/vadorovsky/aya/commit/2ed3531463d4d7ece84b973f0521d954c629191d))
    ...
    - Make Align not pub ([`48f9e00`](https://github.com/vadorovsky/aya/commit/48f9e00c2e148182172367d26b7e1b9095af16d5))
    - Align by 8b in include_bytes_aligned. ([`a7144b9`](https://github.com/vadorovsky/aya/commit/a7144b9a6efc963e1fdcc0716990846a9d407ae1))
    - Avoid some allocations ([`98960db`](https://github.com/vadorovsky/aya/commit/98960db18a01fe4fa932423e22a712b37d21b03a))
    - Advance through write buffers ([`ed516b3`](https://github.com/vadorovsky/aya/commit/ed516b3ec040aa5f3b1fc4c5aa174fd0f8484355))
    - Use constants more consistently ([`52c33eb`](https://github.com/vadorovsky/aya/commit/52c33ebdf84d0d3f0dcd13d861216d1a052005a3))
    - Use checked accessors ([`68be4b7`](https://github.com/vadorovsky/aya/commit/68be4b7297ce1533904fc54b281aa2e796ad2a6f))
    - Avoid repeating NLA_ALIGNTO everywhere ([`f49ef40`](https://github.com/vadorovsky/aya/commit/f49ef401a794789e1187bb06d506bd8742b66fcc))
    - Rename EbpfGlobal to Global ([`b9cb76b`](https://github.com/vadorovsky/aya/commit/b9cb76b302bdd1288b6486fb3a0627ea40cc3dbc))
    - Fix attach on 6.17 ([`cdfa52d`](https://github.com/vadorovsky/aya/commit/cdfa52de6ed7fb766b3139cf42fcbab06ce12ad3))
    - Fix attachment failure with long program names ([`c42157f`](https://github.com/vadorovsky/aya/commit/c42157f0b566940b849b699109d1c660a0733fd3))
    - Fix `BloomFilter::contains` method ([`ae8c76d`](https://github.com/vadorovsky/aya/commit/ae8c76d03757de8a7c07d2f3022362be179cbb07))
    - Add helper for safe loading of globals ([`294e0c1`](https://github.com/vadorovsky/aya/commit/294e0c19413d5a7c073d17d79ad4d154283499ce))
    ...
    - Use usize::next_multiple_of ([`be872b1`](https://github.com/vadorovsky/aya/commit/be872b1cff07365362925acc875a20609720f646))
    - Aya, aya-ebpf: reduce duplication ([`f35f7a3`](https://github.com/vadorovsky/aya/commit/f35f7a3610d8296d97c6f0a47e75dbb4188f5212))
    - Document tcx link pinning for atomic program replacement ([`7cbd816`](https://github.com/vadorovsky/aya/commit/7cbd816a7701ea414b6367abdee6cae878755d34))
    - Avoid trying to parse paths in proc maps ([`775f42d`](https://github.com/vadorovsky/aya/commit/775f42d781c9379016647f0abf1d42f57522d84d))
    - Avoid some allocations ([`eb25e6a`](https://github.com/vadorovsky/aya/commit/eb25e6af2a14ef65075e75e06d6d7a78b3bc6d82))
    - Trim whitespace just once ([`efecc08`](https://github.com/vadorovsky/aya/commit/efecc088b37a9438cb79f234fbfa735356816a64))
    - Improve `ParseLine as Debug` ([`d1f72a5`](https://github.com/vadorovsky/aya/commit/d1f72a580c640b7ad2ae71c3acd2ff4ef2bf02c0))
    - Move test_resolve_attach_path to tests module ([`80d7952`](https://github.com/vadorovsky/aya/commit/80d79526a6fe3fff0ea07b018d0eed03f6d8de71))
    - Use integer::next_multiple_of ([`4984ddc`](https://github.com/vadorovsky/aya/commit/4984ddc0467a3e0fef92fd8ee6edb83a1274700a))
    - Bundle attach location+cookie via UProbeAttachPoint ([`eb99da3`](https://github.com/vadorovsky/aya/commit/eb99da3cbb4bcf2b20c8d0797566dd330261aadb))
    - Release crates ([`d238b2e`](https://github.com/vadorovsky/aya/commit/d238b2ea6f1b2c1aa09a9050415b1c96329af0aa))
    - Use RAII to clean up in the error path ([`46221ad`](https://github.com/vadorovsky/aya/commit/46221ad11dfb44fc0cc46425e1648c6750d98a5e))
    - ProbeKind is Entry/Return ([`72810f0`](https://github.com/vadorovsky/aya/commit/72810f095f1461d5d254d37e7174bb47bd15f691))
    - Use exhaustive matches ([`a4a3c16`](https://github.com/vadorovsky/aya/commit/a4a3c1641f8b6006363be6c66516daf73a94aec7))
    - Refactor perf_event_open_trace_point ([`1944c4a`](https://github.com/vadorovsky/aya/commit/1944c4aa008d685053bb617b728e3e4f723d7672))
    - Inline `perf_event_open_bpf` ([`d4b2dde`](https://github.com/vadorovsky/aya/commit/d4b2dde78ac88b0e7e9141e0675bd8888f23c1f6))
    - Privatize PerfLink ([`7e07f85`](https://github.com/vadorovsky/aya/commit/7e07f85edcbdbe2f5d1c49a872e56d1ff458991e))
    - Disambiguate `fd` names ([`27c7f1c`](https://github.com/vadorovsky/aya/commit/27c7f1c84f29a6f5e775ce6761a87859a351d95d))
    - Remove superfluous type ascription ([`1791d49`](https://github.com/vadorovsky/aya/commit/1791d497d3af39bd8da4eb666dece22c60e97281))
    - Support hardware breakpoints ([`ab38afe`](https://github.com/vadorovsky/aya/commit/ab38afe95d16226f5a703bbb37c7842ee441c364))
    - Add `Ebpf::maps_disjoint_mut` ([`d8f5497`](https://github.com/vadorovsky/aya/commit/d8f5497884a23bd63f9264dbe3f80081b76f360d))
    - Add clippy coverage for doctests ([`112ab47`](https://github.com/vadorovsky/aya/commit/112ab47fcdf8ba4765e6f6416cbb7000c96292f8))
    - Push down type safety ([`18c7f7c`](https://github.com/vadorovsky/aya/commit/18c7f7ccd6d462516d94b8720d18f8b7b5d98361))
    - Simplify PerfEventScope ([`7e405c2`](https://github.com/vadorovsky/aya/commit/7e405c216e0d806f96c76f2554d069722f97bec3))
    - Tolerate proc map trailing newline ([`4fbce44`](https://github.com/vadorovsky/aya/commit/4fbce44b6a49dd189a7a3520c66db45baf3832ea))
    - Restore must_exist argument to set_global ([`3a3c451`](https://github.com/vadorovsky/aya/commit/3a3c45100942c903c21e69595eff9e4289910835))
    - Add some type ascription ([`d73c65c`](https://github.com/vadorovsky/aya/commit/d73c65caae5b494630a47119bcc571971f227c5a))
    - Enable clippy::as_underscore ([`17c7c79`](https://github.com/vadorovsky/aya/commit/17c7c7951cb45a5903134b21658df7e989e672ed))
    - Rename `set_` methods on `EbpfLoader` ([`03e8487`](https://github.com/vadorovsky/aya/commit/03e84871773e09badf08bdef8e83b4f1256850a4))
    - Fix producer position initialization ([`1717164`](https://github.com/vadorovsky/aya/commit/17171647f7e447698f0d4733a3dbb144ded53466))
    - Allow specifying a pin path for a named map ([`5802dc7`](https://github.com/vadorovsky/aya/commit/5802dc7a23ac878105b55710df6c75cb5e030c3a))
    - Rename map_pin_path to default_map_pin_path ([`1c924bb`](https://github.com/vadorovsky/aya/commit/1c924bb421dd731a7557ae4140f3bed7982894d2))
    - Defer cleanup to ensure unpin ([`0144c0e`](https://github.com/vadorovsky/aya/commit/0144c0eb22d08b29ab6f9f5e97e1ea1d9866fd41))
    - Skip `cpumap_chain` when attachment fails ([`907920a`](https://github.com/vadorovsky/aya/commit/907920a6293af62f2db6accce5a52649731ec2d9))
    - Skip `lsm_cgroup` when loading fails ([`54bd3ac`](https://github.com/vadorovsky/aya/commit/54bd3ac202f4825bbb43719f3d9c350ab3e1513e))
    - Make ProgramInfo a proper enum ([`2e5f5ef`](https://github.com/vadorovsky/aya/commit/2e5f5efbf13c71dc1462d1221e77055c7c3e857a))
    ...
    - Replace kernel version check with fallback ([`4c974d3`](https://github.com/vadorovsky/aya/commit/4c974d33a3b5728b49c82183666153aa20e14b30))
    - Raise RLIMIT_MEMLOCK on kernel version < 5.11.0 ([`984a050`](https://github.com/vadorovsky/aya/commit/984a0501c62251f4813a6758ddda69b5a9cb2325))
    - Enforce valid perf_event type & config combos ([`3d7fbaa`](https://github.com/vadorovsky/aya/commit/3d7fbaad28fc8ad49f0a5afb08c686011ed25c5c))
    - Remove useless impl ([`c2fb7fe`](https://github.com/vadorovsky/aya/commit/c2fb7fed6c4cc2b75a0188cddd8480789e99e0d5))
    - Improve error output ([`f76fdf9`](https://github.com/vadorovsky/aya/commit/f76fdf9da51852f5e13011b2d3ba6f9204943de7))
    - Add missing impl_try_into_fdlink ([`82aec26`](https://github.com/vadorovsky/aya/commit/82aec2696394f953c886f146f02673753a94cb0d))
    - Remove unused error variant ([`6fc06b9`](https://github.com/vadorovsky/aya/commit/6fc06b9fcf073447438b41a066497946293825d5))
    - Cgroup attachment type support ([`fc5387c`](https://github.com/vadorovsky/aya/commit/fc5387c80626957017ceeb988322bc288f438059))
    - Properly check for LSM support ([`8e75214`](https://github.com/vadorovsky/aya/commit/8e752148155b49e3732a6563ee7ce1f8ecbf6307))
    - Add BPF_MAP_TYPE_SK_STORAGE ([`de42b80`](https://github.com/vadorovsky/aya/commit/de42b80c74883f512542875e7cfa96b8634a8991))
    - Use shared helpers ([`6babf17`](https://github.com/vadorovsky/aya/commit/6babf1796988af742711cdcdae691e4dbdd1641e))
    - Downcase log strings ([`75edc3d`](https://github.com/vadorovsky/aya/commit/75edc3d2948bea7b63edc60365e4cc10e414921b))
    - Add newline between doc and imports ([`742f700`](https://github.com/vadorovsky/aya/commit/742f700dcc43fe9ad5ccdd23d1b6e55673807c06))
    ...
    - Deny clippy::unnecessary_cast ([`d1bb7bc`](https://github.com/vadorovsky/aya/commit/d1bb7bcc38a45a3d2e4bcfd6959075e0a035bbca))
    - Deny clippy::fn_to_numeric_cast{,_with_truncation} ([`be4d74f`](https://github.com/vadorovsky/aya/commit/be4d74fd06b0b58313daba2ffa845b0d53ec9e11))
    - Deny clippy::char_lit_as_u8 ([`fa03dbd`](https://github.com/vadorovsky/aya/commit/fa03dbdb46493255bf9cc0aff33e5b79520f14e8))
    - Deny clippy::cast_precision_loss ([`a7206b9`](https://github.com/vadorovsky/aya/commit/a7206b9098c33b8f81255df1d19822ebb0e67a9b))
    - Deny clippy::cast_lossless ([`72104c4`](https://github.com/vadorovsky/aya/commit/72104c4076b8b7b63155b72ef7053d42cd36f1e2))
    - Add Map::from_map_data() for pinned map access ([`263e864`](https://github.com/vadorovsky/aya/commit/263e864cd9e09848a9861a967763cf1069ae01c8))
    - Remove superfluous commas ([`a3aa387`](https://github.com/vadorovsky/aya/commit/a3aa387a2e8035660425cefb4f6171d5fdb7537e))
    - Generate docs in macro ([`0d11937`](https://github.com/vadorovsky/aya/commit/0d1193720bc0e5915eff32b5d4edd21178a98991))
    - Fix rustdoc link in macro ([`8ee12d3`](https://github.com/vadorovsky/aya/commit/8ee12d337fbc1662350815dbde620f2f1b23f962))
    - Remove `AsyncPerfEventArray{,Buffer}` ([`35332f2`](https://github.com/vadorovsky/aya/commit/35332f2288b0bbb8981233ae464715ea9217b081))
    - `construct_debuglink_path()` should be infallible ([`ab182be`](https://github.com/vadorovsky/aya/commit/ab182be622acb245db0adef58591978208bcdb2c))
    - `impl AsFd for RingBuf` ([`3f02127`](https://github.com/vadorovsky/aya/commit/3f02127b6b16f618aa2ccb444fcd1402c887ffaf))
    - Implement TryFrom<[Program Type]> for FdLink for various program types ([`4b5ba53`](https://github.com/vadorovsky/aya/commit/4b5ba53a36b0c920969bbb9016330cd195e457dc))
    - Short-circuit info field if non-zero ([`7a0dabc`](https://github.com/vadorovsky/aya/commit/7a0dabc295a0d856f6c3611331c9434b83f63ae8))
    - Cache feat probed info fields ([`23bc5b5`](https://github.com/vadorovsky/aya/commit/23bc5b5836c3b8383f2f8a78bd3902e193a7a176))
    - Add feature probing for map type ([`bd49286`](https://github.com/vadorovsky/aya/commit/bd492860f585ad8b9612ef9c8addde2fb8d5e814))
    - Add feature probing program type ([`ab77dec`](https://github.com/vadorovsky/aya/commit/ab77decd9a708147e679a12ba6be3774f8946dd8))
    - Merge pull request #1262 from dave-tucker/stabilize-links ([`f74a157`](https://github.com/vadorovsky/aya/commit/f74a1579074016168e4e64a32e902e8b50a75b85))
    - Make LinkInfo and loaded_links public ([`7dba5a4`](https://github.com/vadorovsky/aya/commit/7dba5a41ade97a3744c4cb71a22d7c81699a69e3))
    - Uprobe: use PathBuf for ResolveSymbolError::DebuglinkAccessError ([`33c9f2b`](https://github.com/vadorovsky/aya/commit/33c9f2b2b2cf5587139e36c0e05de13e72cf77fa))
    - Uprobe attach: use mmap instead of reading whole binaries to memory ([`90d5604`](https://github.com/vadorovsky/aya/commit/90d56048777ff571293a99450201562532fcaa7f))
    - Clean up resolve_symbol a bit ([`647100f`](https://github.com/vadorovsky/aya/commit/647100faa7f4dff819642183c94b5a05389eb2af))
    - Move Mmap struct to aya::util ([`3aded0e`](https://github.com/vadorovsky/aya/commit/3aded0e0a5c644569b0a268ea31c6c0edddea3b2))
    ...
    - Merge pull request #1240 from dave-tucker/use-gen-bpf-add ([`4c5fbef`](https://github.com/vadorovsky/aya/commit/4c5fbef8691ce36c547fdf07b7ef8aecf9062c79))
    - Use BPF_ADD from bindings ([`23a5e06`](https://github.com/vadorovsky/aya/commit/23a5e06c75dd418f9e0956db18cbed3b80670440))
    - Merge pull request #1209 from dave-tucker/from_prog_info ([`1db534d`](https://github.com/vadorovsky/aya/commit/1db534defafa3d9529c38dcb165435273c6a827d))
    - Merge pull request #1225 from dave-tucker/fix-clippy ([`d9ef2df`](https://github.com/vadorovsky/aya/commit/d9ef2df2f0cfb402f6781c4684a752435cd309e8))
    - Fix clippy unused cfg_attr ([`e8e268b`](https://github.com/vadorovsky/aya/commit/e8e268ba768e6fc34567aedb5206ff20a958f04e))
    - Allow conversions to Program from ProgramInfo ([`2b0dcfb`](https://github.com/vadorovsky/aya/commit/2b0dcfbd0938252f8ee8752e26abe7581561f9af))
    ...
    - Remove unhelpful comment ([`3edc36a`](https://github.com/vadorovsky/aya/commit/3edc36af9d2a6a90a57d449e66267ca081aa6a86))
    - Reorder-keys ([`49a828e`](https://github.com/vadorovsky/aya/commit/49a828ec5655f6ecd0c38083c6c0dca217bad777))
    - Ensure that truncated map names are NULL terminated ([`f48b5a4`](https://github.com/vadorovsky/aya/commit/f48b5a4a84a858dd3a24101a83a3b03c314f1c5c))
    ...
    - Allow program names to be static strings ([`22c8f78`](https://github.com/vadorovsky/aya/commit/22c8f783e7d5dd2ddc8d973885e1895a6e842440))
    - Add `XskMap::unset` ([`73a34e1`](https://github.com/vadorovsky/aya/commit/73a34e1571a606124c7e89ecf71ff001508643dc))
    - Parse complete entries from /proc/$pid/maps ([`ea76e0f`](https://github.com/vadorovsky/aya/commit/ea76e0f62dbdff618789dfc9a9d8604a89f61f13))
    - Destructure ([`de0b7ce`](https://github.com/vadorovsky/aya/commit/de0b7cee8d2de005bf09c26f4d549036607f6f51))
    - Add punctuation ([`7084df6`](https://github.com/vadorovsky/aya/commit/7084df68aa738f720c94a593ec72935f5a2e356e))
    - Avoid allocations when parsing /proc/{pid}/maps ([`50ae0ee`](https://github.com/vadorovsky/aya/commit/50ae0ee099385d9b8a743ea26529e0dd10dda18e))
    - Revert "ci: remove cross toolchain" ([`e16f048`](https://github.com/vadorovsky/aya/commit/e16f0482f8aafabd65836570ff55293a0681b145))
    ...
    - Remove panics on indeterminate kernel version ([`27d69c3`](https://github.com/vadorovsky/aya/commit/27d69c35f030dda687664af8dc2d2fd52d238c6b))
    - Remove some copies ([`9eefb48`](https://github.com/vadorovsky/aya/commit/9eefb48a0ad90831c09c7bd941d035b34e1f1771))
    - Add TODO to remove once_cell ([`89aa638`](https://github.com/vadorovsky/aya/commit/89aa638e05795be0ab86711d6e2ade2a8dbafcae))
    - Encode perf_event ioctl contract ([`de1e80c`](https://github.com/vadorovsky/aya/commit/de1e80c1d1bab7fd73acc97e5adb0985712c35c7))
    - Remove redundant TEST_SYSCALL use ([`eee7975`](https://github.com/vadorovsky/aya/commit/eee7975ce42520513acda16977b21e19a1cd159d))
    - Encode perf_event_open(2) contract ([`055e36e`](https://github.com/vadorovsky/aya/commit/055e36e8d92c79c1a9cf61f1a08d2d9be4e74d14))
    - Avoid `_` ([`bdd8ae2`](https://github.com/vadorovsky/aya/commit/bdd8ae2d0b443513c73143da968d400df9b05464))
    - Encode bpf(2) contract ([`f6df60f`](https://github.com/vadorovsky/aya/commit/f6df60fa7072dfd7cfb09d0bc3bb1dad0f965940))
    - Avoid Result::is_{ok,err} ([`2d78260`](https://github.com/vadorovsky/aya/commit/2d782606fe984cb2ffebe7b98807a58494441a4c))
    - Avoid retagging in tests ([`dab1aa4`](https://github.com/vadorovsky/aya/commit/dab1aa4e291e4301eca0bd6532449dc7079ff10a))
    - Attempt to preserve provenance ([`f51ab80`](https://github.com/vadorovsky/aya/commit/f51ab800758689a67c312742ffdf9116e1e178c0))
    - Use MMap from ring_buf ([`8887014`](https://github.com/vadorovsky/aya/commit/888701425bbfc48365edd6f03d9872d5c86a3e18))
    - Avoiding casting pointers to usize ([`ff82c24`](https://github.com/vadorovsky/aya/commit/ff82c244f77f46da9245b42ede56c0500cd6b56f))
    - Remove some stale comments ([`e17feca`](https://github.com/vadorovsky/aya/commit/e17feca2d6d45365fc1d717f0735ee4dd9664ec3))
    - Enable test under miri ([`935ba20`](https://github.com/vadorovsky/aya/commit/935ba20224e4e777087151e521b1354f2a9245cd))
    - Preserve pointer provenance ([`9a47495`](https://github.com/vadorovsky/aya/commit/9a47495227a03400fa2549b07fe8af131f21e759))
    - Appease clippy ([`122c49f`](https://github.com/vadorovsky/aya/commit/122c49fca4ea1cdf89bbffbb48a440dfd3744937))
    - Fix PerCpuHashMap NotFound ([`9e1bcd0`](https://github.com/vadorovsky/aya/commit/9e1bcd0ab87f69bcd323eef680957a534b655fac))
    - Remove outdated workaround ([`9198335`](https://github.com/vadorovsky/aya/commit/919833510095cfc49d1b9874429f403167227fbd))
    - Avoid handwritten assembly ([`942ea51`](https://github.com/vadorovsky/aya/commit/942ea51906fea4e3152e1bd3ef5832bc0df5b205))
    - Remove duplication ([`8ea11ef`](https://github.com/vadorovsky/aya/commit/8ea11ef9e84832de6a1f12468e5d93d900ff31f3))
    - Avoid raw slice construction ([`b010b0f`](https://github.com/vadorovsky/aya/commit/b010b0f028409272bf65238834ed625693c0cb09))
    - Remove aya_obj -> obj alias ([`665d4f2`](https://github.com/vadorovsky/aya/commit/665d4f20bb53de0aa10545bb897ab73f0661a337))
    - Merge pull request #690 from dave-tucker/netlink-errors ([`921e457`](https://github.com/vadorovsky/aya/commit/921e45747bd96840b849637468b723ce25e15345))
    - Return error messages from netlink ([`39cf6c1`](https://github.com/vadorovsky/aya/commit/39cf6c12f27f02c945e70efb24b89c1bc372aac0))
    - Appease clippy ([`0429ed2`](https://github.com/vadorovsky/aya/commit/0429ed2fa299636428b65573456cffe0aac2beca))
    - Use Set (instead of Map) to hold links ([`356cf45`](https://github.com/vadorovsky/aya/commit/356cf45914408b1372d33f27a20ebd3ef75759ca))
    - Appease clippy ([`69144a9`](https://github.com/vadorovsky/aya/commit/69144a977ef33613610f0f7b9a94e432da3a2d59))
    - Merge pull request #1133 from ajwerner/uprobe-cookie ([`114e7a6`](https://github.com/vadorovsky/aya/commit/114e7a69069e610f5bdd840dd2f0d4d5de5b0694))
    - :programs::uprobe: add support for cookies ([`628b7fb`](https://github.com/vadorovsky/aya/commit/628b7fb0221321aa0cc649cd738c449a7dbb0108))
    - Avoid useless conversions ([`78ee9a4`](https://github.com/vadorovsky/aya/commit/78ee9a463429a1eda706f8974f965892ad86a6dd))
    - Clean up C type imports ([`4257643`](https://github.com/vadorovsky/aya/commit/4257643354263d69ed02b1e9385675560927da79))
    - Narrow clippy allowances ([`41706d7`](https://github.com/vadorovsky/aya/commit/41706d74e44f2c3589c28a7149beb4db185594f2))
    - Fix cippy errors ([`4f0559f`](https://github.com/vadorovsky/aya/commit/4f0559f2afeca1dfae120bacf1742d58268bca37))
    - Define `{detach,take_link}` in macro when possible ([`119049f`](https://github.com/vadorovsky/aya/commit/119049f2a21045b4f990523ccc95265ef4233d41))
    - Improve the description of `take_link` methods ([`85c73af`](https://github.com/vadorovsky/aya/commit/85c73af1feb8d0b227ca2e7b61b8542c4eb8b918))
    - Add iterator program type ([`bf2164c`](https://github.com/vadorovsky/aya/commit/bf2164c92f5280e8b9c7178b9cbf338931ce778d))
    - Cargo fmt ([`a77db17`](https://github.com/vadorovsky/aya/commit/a77db17ec8dac1ac75c0d0175a1e25749acb44b3))
    - Avoid warning with `allow_unsupported_maps` ([`a167550`](https://github.com/vadorovsky/aya/commit/a16755089bb642ded73a592ac25c6e21771b5792))
</details>
 ...
 * **Uncategorized**
    - Release aya v0.13.1 ([`2791bad`](https://github.com/vadorovsky/aya/commit/2791badd947e3abb459e5339a23a66d0a56c42d0))
    ...
    - Implement TCX ([`5478cac`](https://github.com/vadorovsky/aya/commit/5478cac008471bdb80aa30733e4456b70ec1a5bd))
    - Cache `nr_cpus` in a thread_local ([`d05110f`](https://github.com/vadorovsky/aya/commit/d05110fd86f9b317d47ffb7cf5c00e588635d4cd))
    - Clarify `Arc` usage ([`afd777b`](https://github.com/vadorovsky/aya/commit/afd777b705312b7bafec2a116041a2318d3aa70f))
    - Replace `Arc` with `&'static` ([`e992c28`](https://github.com/vadorovsky/aya/commit/e992c280cbae7af7e484767a0b79314b14a4de84))
    - Avoid intermediate allocations in parse_cpu_ranges ([`0e86757`](https://github.com/vadorovsky/aya/commit/0e867572ff8e009bbcd1a63037b4ab5b80e35549))
    - Reduce duplication in `{nr,possible}_cpus` ([`f3b2744`](https://github.com/vadorovsky/aya/commit/f3b27440725a0eb2f1615c92cb0047e3b1548d66))
    - Replace `lazy_static` with `std::sync::LazyLock` ([`2b299d4`](https://github.com/vadorovsky/aya/commit/2b299d4fba1ddda70c2e8af324f999cb23683559))
    - Appease clippy ([`0f16363`](https://github.com/vadorovsky/aya/commit/0f163633e3d73c59f857880c967c27e9f52e8610))
    - Merge pull request #1023 from l2dy/fdlink/sockops ([`2cd3576`](https://github.com/vadorovsky/aya/commit/2cd35769dce05b46a4dd07381c990c6acd4cfe0d))
    - Use FdLink in SockOps programs ([`c44f8b0`](https://github.com/vadorovsky/aya/commit/c44f8b0f5bddd820a4a98cff293126c0146b827a))
    - Remove unwrap and NonZero* in info ([`02d1db5`](https://github.com/vadorovsky/aya/commit/02d1db5fc043fb7af90c14d13de6419ec5b9bcb5))
    - Merge pull request #985 from reyzell/main ([`40f3032`](https://github.com/vadorovsky/aya/commit/40f303205f7a800877fe3f9a4fb1893141741e13))
    - Add the option to support multiple and overrideable programs per cgroup ([`f790685`](https://github.com/vadorovsky/aya/commit/f790685d759cbd97cb09ad48d87cdece28fbe579))
    ...
    - Improve integration tests for info API ([`cb8e478`](https://github.com/vadorovsky/aya/commit/cb8e47880082ccfcd75b02209b686e15426e9b6a))
    - Merge pull request #959 from tyrone-wu/aya/program_info_stats ([`ab000ad`](https://github.com/vadorovsky/aya/commit/ab000ad7c3b0715c3cdd9798bd08fc834b114f1a))
    ...
    - Adjust bpf programs for big endian ([`cd1db86`](https://github.com/vadorovsky/aya/commit/cd1db86fd490b3c0f03229bd8999a2e67ccecfc4))
    ...
    - Simplify doctest ([`4362020`](https://github.com/vadorovsky/aya/commit/43620206918facbf003d8b878ae28c5b07955167))
    - Appease nightly clippy ([`bce3c4f`](https://github.com/vadorovsky/aya/commit/bce3c4fb1d0cd6e8f9f64420c59e02a42c96b2c8))
    - Expose run_time_ns and run_cnt fields in ProgramInfo ([`a25f501`](https://github.com/vadorovsky/aya/commit/a25f501ecebaceaacdd1212fac34f528b51ad0fd))
    - Add BPF_ENABLE_STATS syscall function ([`fa6af6a`](https://github.com/vadorovsky/aya/commit/fa6af6a20439cccd8ab961f83dce545fb5884dd4))
    - Fix PerfEventArray resize logic ([`3d57d35`](https://github.com/vadorovsky/aya/commit/3d57d358e40591acf23dfde740697fbfff026410))
    - Add comments in `*_wrong_map` tests ([`e575712`](https://github.com/vadorovsky/aya/commit/e575712c596d03b93f75d160e3d95241eb895d39))
    - Set PerfEventArray max_entries to nCPUs ([`25d986a`](https://github.com/vadorovsky/aya/commit/25d986a26d9c88cd499a8b795054d583f01476b2))
    - Use MockableFd everywhere ([`e12fcf4`](https://github.com/vadorovsky/aya/commit/e12fcf46cb1e0856a8105ed43fda184fa4648713))
    - Merge pull request #991 from l2dy/typo-1 ([`2cd9858`](https://github.com/vadorovsky/aya/commit/2cd9858ea9381232acaffcb5a08bc74e90a8863e))
    - Fix typo ([`f1773d5`](https://github.com/vadorovsky/aya/commit/f1773d5af43f5f29b100572e65a60d58f2ce7fac))
    - Merge pull request #983 from ajwerner/fix-variable-name ([`d5414bf`](https://github.com/vadorovsky/aya/commit/d5414bf10c80ae8cef757f0cdf06bfdd38746daa))
    - :programs::uprobe: fix bad variable name ([`d413e2f`](https://github.com/vadorovsky/aya/commit/d413e2f285643cbeb665fd3c517e2c9d93d45825))
    - Fix panic when creating map on custom ubuntu kernel ([`38d8e32`](https://github.com/vadorovsky/aya/commit/38d8e32baa5a4538de9daa6fae634aea6372573c))
    - Appease clippy ([`78acd74`](https://github.com/vadorovsky/aya/commit/78acd74badb6aa2463f89fbdf713325dad75dc9e))
    - Don't deny unused_qualifications ([`781914f`](https://github.com/vadorovsky/aya/commit/781914f058ef805bd0780ff72a2a66c63255bc07))
    - Fix rustdocs-args ordering in taplo to -D warnings ([`5e13283`](https://github.com/vadorovsky/aya/commit/5e13283f59b0c3b4cb47de1e31d8d0960e80b4cc))
    - Remove deny(pointer_structural_match) ([`4e843a3`](https://github.com/vadorovsky/aya/commit/4e843a35237c2de49d17621dccb4a2a35bb4030c))
    - Merge pull request #938 from swananan/enhance_urpobe_symbol_lookup ([`bde4b5f`](https://github.com/vadorovsky/aya/commit/bde4b5f86b12a3e4ac2f99898edb1b564fe9dd7e))
    - Fix clippy ([`c7898c5`](https://github.com/vadorovsky/aya/commit/c7898c596f2f74f29570101d0f71f35b0ab4104b))
    - Adjust symbol lookup tests for object crate alignment requirements ([`462514e`](https://github.com/vadorovsky/aya/commit/462514ed4c4c06e9618d029a57708c7fa14ab748))
    - Add symbol lookup in associated debug files ([`e6e1bfe`](https://github.com/vadorovsky/aya/commit/e6e1bfeb58ac392637061640365b057182ee1b39))
    - Merge pull request #928 from seanyoung/io-error ([`d0e9b95`](https://github.com/vadorovsky/aya/commit/d0e9b95aa5edc6c056687caeb950e1ce44b18d66))
    - S/MiriSafeFd/MockableFd/ ([`a11b61e`](https://github.com/vadorovsky/aya/commit/a11b61ebfde8713c35b6f2a760e470d3586803a7))
    - Remove miri ignores ([`cb6d3bd`](https://github.com/vadorovsky/aya/commit/cb6d3bd75d162e4928fdf4daa7f515e1ad85ae85))
    - Document miri skip reasons ([`35962a4`](https://github.com/vadorovsky/aya/commit/35962a4794484aa3b37dadc98a70a659fd107b75))
    - Avoid crashing under Miri ([`7a7d168`](https://github.com/vadorovsky/aya/commit/7a7d16885a89af8c10a52e5aba0927784d42f551))
    - Deduplicate test helpers ([`7e1666f`](https://github.com/vadorovsky/aya/commit/7e1666fb83e5c2b270cb24becb84adebbe29be1a))
    - Reduce duplication ([`58e154e`](https://github.com/vadorovsky/aya/commit/58e154e1bc4846a6a2afcb8397aa599cfb7ea6fd))
    - Expose io_error in SyscallError ([`a6c45f6`](https://github.com/vadorovsky/aya/commit/a6c45f61c77c4bbec4409debb8447cd606f0db5d))
    ...
    - Appease clippy ([`0a32dac`](https://github.com/vadorovsky/aya/commit/0a32dacd2fd2f225f4a3709ac4ea2838a9937378))
    ...
    - Include license in crate workspace ([`a4e68eb`](https://github.com/vadorovsky/aya/commit/a4e68ebdbf0e0b591509f36316d12d9689d23f89))
    - Use `Ebpf` instead of `Bpf` ([`57a69fe`](https://github.com/vadorovsky/aya/commit/57a69fe9d28e858562a429bacd9a0a7700b96726))
    - Provide a deprecated `BpfError` alias ([`110a76c`](https://github.com/vadorovsky/aya/commit/110a76cb9a1b2ab5c5ad3b6c0828a4ae670e67a0))
    ...
    - Rename bpf -> ebpf ([`70ac91d`](https://github.com/vadorovsky/aya/commit/70ac91dc1e6f209a701cd868db215763d65efa73))
    - Fix unused_qualifications lints ([`481b73b`](https://github.com/vadorovsky/aya/commit/481b73b6d8dd9a796d891bba137400c2a43a0afe))
    - Add `CgroupDevice::query` ([`542306d`](https://github.com/vadorovsky/aya/commit/542306d295e51ac1ec117ce453544f201875af3d))
    - Appease new nightly clippy lints ([`e38eac6`](https://github.com/vadorovsky/aya/commit/e38eac6352ccb5c2b44d621161a27898744ea397))
</details>
 ...
 * **Uncategorized**
    ...
    - Don't use path deps in workspace ([`13b1fc6`](https://github.com/vadorovsky/aya/commit/13b1fc63ef2ae083ba03ce9de24cb4f31f989d21))
    - Merge pull request #892 from dave-tucker/breaking-changes-v2 ([`daa5a47`](https://github.com/vadorovsky/aya/commit/daa5a473105e0c99f5f171ba519d076a7157af6e))
    ...
    - Document more breaking changes ([`2d9d7a1`](https://github.com/vadorovsky/aya/commit/2d9d7a1a0b8fb944a9843642e85480b16c11bd11))
    - Add CHANGELOG ([`12280a8`](https://github.com/vadorovsky/aya/commit/12280a83f967ba9a90dcd066b3470f4bcc4ea77c))
    - Merge pull request #889 from dave-tucker/breaking-changes ([`5c9c044`](https://github.com/vadorovsky/aya/commit/5c9c044719f84dcb76edfa496e3999194253b5c4))
    - Document breaking changes ([`281ac1a`](https://github.com/vadorovsky/aya/commit/281ac1ac02cf0da7be1161b25c2ef023b922bc0c))
    ...
    - Appease rustc dead_code lint ([`963dd13`](https://github.com/vadorovsky/aya/commit/963dd1321925c95f80c8a2bf656b88a39497ca01))
    - Invalid transmute when calling fd ([`c31cce4`](https://github.com/vadorovsky/aya/commit/c31cce4a368ac56b42196604ef110139d28a2f8e))
    - Merge pull request #878 from alessandrod/missing-exports ([`46b4805`](https://github.com/vadorovsky/aya/commit/46b48053df07d813ee519598382f74cead5fd602))
    - Reformat to please rustfmt ([`2be705b`](https://github.com/vadorovsky/aya/commit/2be705bfa04a80b1c4b58a69750e485aa0f2639a))
    - Reorder imports a bit ([`9b4f876`](https://github.com/vadorovsky/aya/commit/9b4f87646d2e0973be6ff30cb1acf26e1f416b3f))
    - Export some missing modules ([`d570450`](https://github.com/vadorovsky/aya/commit/d570450a0c4622a5a8e7e62b321847d3155af1ea))
    - Perf_event: add inherit argument to attach() ([`0f6a734`](https://github.com/vadorovsky/aya/commit/0f6a7343926b23190483bed49855fdc9bb10988d))
    - Add StackTraceMap::remove() ([`92b1947`](https://github.com/vadorovsky/aya/commit/92b194788527b1318e262a3b9bb4558339aee05b))
    - Merge pull request #865 from tamird/appease-lint ([`09851a2`](https://github.com/vadorovsky/aya/commit/09851a2090287b531652e8547a14c70532633d6c))
    - Appease new nightly clippy lints ([`7022528`](https://github.com/vadorovsky/aya/commit/7022528f04e08ef1a79ef0fee78323f29b6cc81c))
    - Merge pull request #861 from tamird/appease-lint ([`604742a`](https://github.com/vadorovsky/aya/commit/604742a2f218012ea967d220ecf7be9b74cda8b8))
    - Appease nightly lint ([`7c1bfef`](https://github.com/vadorovsky/aya/commit/7c1bfeffe8988bb60020d6b61ee0f10aa5f1e1e7))
    - Add SchedClassifier::attach_to_link ([`2257cbe`](https://github.com/vadorovsky/aya/commit/2257cbeccb18a3f486c9d64b52b33a331c89531e))
    - Add SchedClassifierLink::attach_type() getter ([`b13645b`](https://github.com/vadorovsky/aya/commit/b13645b13da5b843728959e0416617ea19096613))
    - Merge pull request #858 from dave-tucker/ringbuf-doctests ([`13f21dc`](https://github.com/vadorovsky/aya/commit/13f21dce1b875b225e6561b2b734411cde2a225a))
    - Fix ringbuf docs ([`e9e2f48`](https://github.com/vadorovsky/aya/commit/e9e2f48d4fa8825fec9d343e76999d58b170cdd8))
    - Pin for (async)perf_event_array ([`b176967`](https://github.com/vadorovsky/aya/commit/b1769678f48f7abf6c987a1d686bbaffd5d1e664))
    - Merge pull request #843 from ajwerner/ringbuf-send-sync ([`931cd55`](https://github.com/vadorovsky/aya/commit/931cd55905d74192a80dbbf22a758a53135f8716))
    - Make RingBuf: Send + Sync ([`c06fcc3`](https://github.com/vadorovsky/aya/commit/c06fcc3edafe8efefc90d2eff1b4b4a5489fb9eb))
    - Extracting program and map names with the same function ([`15faca8`](https://github.com/vadorovsky/aya/commit/15faca8b2eddfad22594824cc634bfa1e540eeaa))
    - Add MapInfo struct following the same pattern as ProgramInfo ([`4d24d1c`](https://github.com/vadorovsky/aya/commit/4d24d1cfe8108365403d834e40efa3fa72983f6d))
    - Support loading a map by fd ([`36420d9`](https://github.com/vadorovsky/aya/commit/36420d929734beb7486cc5d14944fc7cf8e9b62a))
    - Make KernelVersion::code public ([`68ba020`](https://github.com/vadorovsky/aya/commit/68ba02002fbd3bcf157c72b8212a697551cae8e6))
    - Merge pull request #746 from dave-tucker/markdownlint ([`958931e`](https://github.com/vadorovsky/aya/commit/958931efcbfd86cab2220b36b7ebb2b34c18a842))
    - Add markdownlint ([`8780a50`](https://github.com/vadorovsky/aya/commit/8780a50be194f7d7c41f6886f1c5de8eee4e59d0))
    - Merge pull request #825 from aya-rs/dependabot/cargo/async-io-2.0 ([`67fe16e`](https://github.com/vadorovsky/aya/commit/67fe16e723c13b30fa4a2a73d58eda812d7ef517))
    - Update async-io requirement from 1.3 to 2.0 ([`c89b2d1`](https://github.com/vadorovsky/aya/commit/c89b2d156dbddd495f885edecbf71910cc61bba8))
    - Merge pull request #821 from Tuetuopay/fix-udeps ([`f037a94`](https://github.com/vadorovsky/aya/commit/f037a94c9f0f3ea4ccdfec631446384e188b64c5))
    - Fix unused async-io dependency linter error ([`984c08c`](https://github.com/vadorovsky/aya/commit/984c08cbad73c51a501b528c53e72f6130976639))
    - Merge pull request #629 from ajwerner/ringbuf ([`6284994`](https://github.com/vadorovsky/aya/commit/62849944f2d807e2214984f40ca0ee8193585f18))
    - Implement RingBuf ([`e2cf734`](https://github.com/vadorovsky/aya/commit/e2cf734490bc188bcedb1eac92d23d81123e42cd))
    - Move mmap from perf_buffer.rs to sys/mod.rs ([`4af9d1b`](https://github.com/vadorovsky/aya/commit/4af9d1bd3ea8dd638bddeb2ae2a8ccea6d11b249))
    - Impl From<obj::InvalidMapTypeError> for MapTypeError ([`b73c0a4`](https://github.com/vadorovsky/aya/commit/b73c0a46f572a77d6d05d96d65f638848ac9b132))
    - Merge pull request #814 from tamird/sort-variants-again ([`cb455fe`](https://github.com/vadorovsky/aya/commit/cb455febbbb350ae1ad15eeb465b5684077b5168))
    - Sort variants ([`8462b69`](https://github.com/vadorovsky/aya/commit/8462b69716d5918a599933bb9688fa7f57b8ee1d))
    ...
    - Merge pull request #813 from tamird/sort-variants ([`ae612a0`](https://github.com/vadorovsky/aya/commit/ae612a0a1061ea65237b62a7d9fa1f2f583dff36))
    - Merge pull request #811 from tamird/libc ([`b7ceee4`](https://github.com/vadorovsky/aya/commit/b7ceee4f51da23b124f4f500c7685b65d89d20d0))
    - Import types from std::ffi rather than libc ([`5cdd1ba`](https://github.com/vadorovsky/aya/commit/5cdd1baf291f7d98128257a6a73cf8df2c144908))
    - Sort variants ([`5e63707`](https://github.com/vadorovsky/aya/commit/5e637071c130fece2b26f6a7246bdef5f782fced))
    - Remove redundant keys ([`cc48523`](https://github.com/vadorovsky/aya/commit/cc48523347c2be5520779ef8eeadc6d3a68649d0))
    - Merge pull request #783 from astoycos/map_pin2 ([`ef27bce`](https://github.com/vadorovsky/aya/commit/ef27bce619981ef8be8b368ac39054f4ce0c5505))
    - Add pin() api ([`7b71c7e`](https://github.com/vadorovsky/aya/commit/7b71c7e1cd8d6948764d02afb0279151c6eae437))
    - Fix libbpf_pin_by_name ([`0bf97eb`](https://github.com/vadorovsky/aya/commit/0bf97eba64b44835300d8291cd4f78c220c3ad48))
    - Merge pull request #806 from vadorovsky/deprecate-syscall-prefix ([`66bd85a`](https://github.com/vadorovsky/aya/commit/66bd85a8de011acd207dd806ccafb6ec56a73500))
    - Deprecate `syscall_prefix` ([`bd6ba3a`](https://github.com/vadorovsky/aya/commit/bd6ba3ad8bae0537eee9eb78d20620592daa3c76))
    ...
    - Merge pull request #791 from nrxus/fix-kernel-code-on-submode-gt-255 ([`6786383`](https://github.com/vadorovsky/aya/commit/67863833ca87ddeb51e3dd7fd5ec87a22f7be63a))
    - Fix program loading on kernels with a patch > 255 ([`0a6a267`](https://github.com/vadorovsky/aya/commit/0a6a2674fa6cbfda986b20d76f64802f0f65c2f0))
    ...
    - Merge pull request #769 from astoycos/fix-loaded-at ([`c130500`](https://github.com/vadorovsky/aya/commit/c130500f18943b380e66ab6286c051f9548c47d0))
    - Fix load time and add test ([`dffff1c`](https://github.com/vadorovsky/aya/commit/dffff1ce6b6c4500b970dec53b57b7eb9c3ec717))
    ...
    - Use ProgramFd instead of impl AsRawFd ([`c6754c6`](https://github.com/vadorovsky/aya/commit/c6754c614ed3aca142bb27fae4e8d488aff72019))
    - Add documentation for XDP maps ([`9ed1d3d`](https://github.com/vadorovsky/aya/commit/9ed1d3d2811db89dc7314914d92922c54032382c))
    - Fix docstring missing trailing period ([`f7fbbcd`](https://github.com/vadorovsky/aya/commit/f7fbbcd0e5cad297ddc5407e201580f878b4c5ee))
    - Add support for chained xdp programs in {cpu,dev}map ([`0647927`](https://github.com/vadorovsky/aya/commit/0647927e32333de662c6a065d5f5b9761c429e68))
    ...
    - Update XDP maps implementations ([`ede3e91`](https://github.com/vadorovsky/aya/commit/ede3e91014075de01af02da624cad99861da2dad))
    - Implement XDP Map Types ([`ec8293a`](https://github.com/vadorovsky/aya/commit/ec8293ab8644cbf8f1c4e7b1c44b286bc0ae969a))
    - Merge pull request #790 from dave-tucker/no-map-pinned ([`42fd82e`](https://github.com/vadorovsky/aya/commit/42fd82e32b85715df78508ef77f79eb8c2edd890))
    - Make MapData::pin pub ([`938f979`](https://github.com/vadorovsky/aya/commit/938f979fe7a82f6d31c3b7e926682864c507e381))
    - Remove MapData::pinned ([`0f4021e`](https://github.com/vadorovsky/aya/commit/0f4021ec89ef2dc5c28355ecfde4b2c53b4b6429))
    - Merge pull request #782 from astoycos/prog-info ([`0b6ea31`](https://github.com/vadorovsky/aya/commit/0b6ea313ded3240715d1b30d3b247e2bc983659e))
    ...
    - Fix typos, avoid fallible conversions ([`0dacb34`](https://github.com/vadorovsky/aya/commit/0dacb34d449f71b1998b0a23cd58c0023277c2ef))
    - MapData::{obj, fd} are private ([`b4d5a1e`](https://github.com/vadorovsky/aya/commit/b4d5a1e8dbb82fc6fca543ad3b6e2f8175ae83b6))
    - `MapFd` and `SockMapFd` are owned ([`f415926`](https://github.com/vadorovsky/aya/commit/f41592663cda156082255b93db145cfdd19378e5))
    - Add program_info() api to program ([`6ab7475`](https://github.com/vadorovsky/aya/commit/6ab7475fa66d1b8155487dfc548645e2b8ee20c6))
    - Merge pull request #775 from aya-rs/perf-as-raw-fd ([`92d3056`](https://github.com/vadorovsky/aya/commit/92d3056db35df729efdbdf757ec389485ce7d8fd))
    - Merge pull request #774 from ajwerner/try_from_LruHash ([`8d3fc49`](https://github.com/vadorovsky/aya/commit/8d3fc49d68b5f75010451d8820a0239e538e41a7))
    - Support TryFrom for LRU hash maps ([`172859c`](https://github.com/vadorovsky/aya/commit/172859c66b25fbfa0d6d2af38ba7dd3f8e99d999))
    - Merge pull request #777 from ajwerner/ajwerner/TryFrom-macros ([`792f467`](https://github.com/vadorovsky/aya/commit/792f467d40dc4c6c543c62dda7a608863fc364dc))
    - Rework TryFrom macros ([`2a1bf60`](https://github.com/vadorovsky/aya/commit/2a1bf609b2b1239c9a789f1a1c814dfa888dfd1d))
    - Access inner through async ([`8b0c7f1`](https://github.com/vadorovsky/aya/commit/8b0c7f12046c2ebadcee5e7ab813d5a34ddc08c6))
    - Merge pull request #772 from aya-rs/link-owned ([`8668436`](https://github.com/vadorovsky/aya/commit/8668436787d3c6b0079a8841e69da3d1f654a650))
    - Merge pull request #771 from aya-rs/xdp-raw ([`c4d1d10`](https://github.com/vadorovsky/aya/commit/c4d1d1086a9fbcf907c260e5a6893bc71f712cfd))
    - ProgAttachLink and LircLink hold owned FDs ([`204d020`](https://github.com/vadorovsky/aya/commit/204d02022a94dab441029855e5d39d5143444204))
    - Use OwnedFd ([`cee0265`](https://github.com/vadorovsky/aya/commit/cee0265b5291acb747cf3a9532cfbf61c455f398))
    - Merge pull request #723 from nrxus/map-program-owned-fd ([`c4643b3`](https://github.com/vadorovsky/aya/commit/c4643b395f06d65876462e95f2988f773b725742))
    - Use AsFd when attaching fds to programs ([`6895b1e`](https://github.com/vadorovsky/aya/commit/6895b1e2ede8d571e7f7069a109932e917fd3ede))
    - Use BorrowedFd when using the program fd in sys/bpf.rs ([`d2e74e5`](https://github.com/vadorovsky/aya/commit/d2e74e562dfa601397b3570ece1a51f5013b9928))
    - Merge pull request #765 from aya-rs/more-utf8-fixes ([`461c275`](https://github.com/vadorovsky/aya/commit/461c2759c58f31af7a2ea396a477f8a8c0f8875f))
    - Support non-UTF8 probing ([`1ccfdbc`](https://github.com/vadorovsky/aya/commit/1ccfdbc17577a5f132ba0af2eb9b754e6e19ddca))
    ...
    - Avoid path UTF-8 assumptions ([`0bba9b1`](https://github.com/vadorovsky/aya/commit/0bba9b14b02a01ca33dbb1fa4a910b77a73a4d65))
    - Avoid lossy string conversions ([`572d047`](https://github.com/vadorovsky/aya/commit/572d047e37111b732be49ef3ad6fb16f70aa4063))
    - Merge pull request #763 from aya-rs/lints ([`ff8c124`](https://github.com/vadorovsky/aya/commit/ff8c124770104d04de78057ea33a35442f86671d))
    - Deny various allow-by-default lints ([`abda239`](https://github.com/vadorovsky/aya/commit/abda239d635e70c34898a425d119040d1bac39a5))
    - Merge pull request #764 from aya-rs/fix-docs ([`1fa1241`](https://github.com/vadorovsky/aya/commit/1fa1241ccb218c0809595bad3e6c65643d89aa43))
    - Fix docs build ([`9ff1bf3`](https://github.com/vadorovsky/aya/commit/9ff1bf3d3bb8f3d51ecaf625dbf3f8d2dbb51abc))
    ...
    - BloomFilter::insert takes &mut self ([`a31544b`](https://github.com/vadorovsky/aya/commit/a31544b6e77d6868d950820ad31fc1fe8ed3666b))
    - MapData::fd is non-optional ([`89bc255`](https://github.com/vadorovsky/aya/commit/89bc255f1d14d72a61064b9b40b641b58f8970e0))
    - Merge pull request #757 from aya-rs/attach-fd-owned ([`c7b5cd5`](https://github.com/vadorovsky/aya/commit/c7b5cd5eb5ca238781c30794fbe72e1794b89a23))
    - Use RAII to close FDs ([`3d68fa3`](https://github.com/vadorovsky/aya/commit/3d68fa32cba3dfadc6a611cf285c7f6733abd39a))
    - `ProgramData::attach_prog_fd` is owned ([`ae6526e`](https://github.com/vadorovsky/aya/commit/ae6526e59b2875807524d466667e2d89c4cd4b8e))
    - Merge pull request #744 from aya-rs/programfd-borrowed ([`e813a05`](https://github.com/vadorovsky/aya/commit/e813a054adfe8e62c13da6dc1ab95a53576d18f2))
    - `ProgramFd` is owned ([`504fd1d`](https://github.com/vadorovsky/aya/commit/504fd1df0a29a02f5a19185e302c3e305a1045c7))
    - Merge pull request #637 from astoycos/helpers ([`bcc9743`](https://github.com/vadorovsky/aya/commit/bcc97432548b19d14ea974b1a83969dc159c6af4))
    - Add helper methods for ProgramInfo ([`e1a5568`](https://github.com/vadorovsky/aya/commit/e1a556894c412daeb44c09c6aa2f9f4489952f34))
    - Merge pull request #702 from dave-tucker/mapdata-btffd ([`03c5012`](https://github.com/vadorovsky/aya/commit/03c5012db20fb0f9445c4464370ca339dc743c33))
    - Merge pull request #748 from aya-rs/btf_obj_fd-owned ([`7f98e41`](https://github.com/vadorovsky/aya/commit/7f98e419e623440b350d6e888b6794d1fb35ce01))
    - Plug attach_btf_obj_fd leak ([`d88ca62`](https://github.com/vadorovsky/aya/commit/d88ca62aaaff690335c18ac725164c82fd173be2))
    - Don't store bpf_fd in MapData ([`db975e9`](https://github.com/vadorovsky/aya/commit/db975e977813ed6961963f7052ae53bc6df69309))
    - Merge pull request #747 from aya-rs/helpers ([`5bc922a`](https://github.com/vadorovsky/aya/commit/5bc922af23f9b4fb08910f287622c0c486f162d9))
    - Refactor btf_obj_get_info_by_fd to share code ([`5ac1862`](https://github.com/vadorovsky/aya/commit/5ac186299b468e54f93b16393bae44b3d896c544))
    - Add map_ids to bpf_prog_get_info_by_fd ([`c7a19bc`](https://github.com/vadorovsky/aya/commit/c7a19bcefba25455279d9e718f6430dee7a84b74))
    - Merge pull request #743 from aya-rs/avoid-vec-ksyms ([`90cf131`](https://github.com/vadorovsky/aya/commit/90cf13163b73aa87f99be285f7a9e4bc98557c7b))
    - Avoid vector allocation when parsing ksyms ([`5138c73`](https://github.com/vadorovsky/aya/commit/5138c731a92a8e5107e41829573617fc624ea9c7))
    - Merge pull request #740 from addisoncrump/main ([`0c0cf70`](https://github.com/vadorovsky/aya/commit/0c0cf70deba630c7fedb12f4820a47e3fa76a135))
    - Nuclear option: no symbol resolution in the crate ([`ed77727`](https://github.com/vadorovsky/aya/commit/ed777273b187cc30afa573101a1fade14a4fb465))
    ...
    - Merge pull request #709 from nrxus/fd-link-owned-fd ([`bd5442a`](https://github.com/vadorovsky/aya/commit/bd5442a1de94f8d1359829d6f172cdd9f3452a09))
    - Use OwnedFd in FdLink. ([`8ebf0ac`](https://github.com/vadorovsky/aya/commit/8ebf0ac3279db08a6b71ae6fed42a135d627e576))
    ...
    - Extract trait SymbolResolver ([`d8709de`](https://github.com/vadorovsky/aya/commit/d8709de9f232483943132e6ffdf54ae8fdb0839d))
    - Merge pull request #718 from ajwerner/better-code ([`ef6308b`](https://github.com/vadorovsky/aya/commit/ef6308b640609743d7eb51453b605fe90a6aaf38))
    - Remove name from ProgramSection ([`cca9b8f`](https://github.com/vadorovsky/aya/commit/cca9b8f1a7e345a39d852bd18a43974871d3ed4b))
    - Refactor target resolution ([`81fb4e5`](https://github.com/vadorovsky/aya/commit/81fb4e5568b2521a61db2db839126a4b7df240df))
    - Merge pull request #717 from ajwerner/no-libc-in-integration-tests ([`de8604d`](https://github.com/vadorovsky/aya/commit/de8604d0119930491d602cb18d700191ac3e2e95))
    ...
    - Extract library path resolving ([`dcc6b84`](https://github.com/vadorovsky/aya/commit/dcc6b84a8803cfee37ab4e138c89616f1fc1b002))
    - Merge pull request #712 from aya-rs/loaded-links ([`368ddf1`](https://github.com/vadorovsky/aya/commit/368ddf10c470a8a3c0420eb0f09cd254801c333b))
    - Add links iterator ([`30faa5f`](https://github.com/vadorovsky/aya/commit/30faa5f68f362b385b9ca96ff300dffcfd774033))
    - Merge pull request #716 from aya-rs/prealloc-vec ([`b1bf61c`](https://github.com/vadorovsky/aya/commit/b1bf61ca61285bc2390b3b3d10ee6a91eabfef34))
    - Set BPF_F_SLEEPABLE for sleepable programs ([`71737f5`](https://github.com/vadorovsky/aya/commit/71737f55764f56a764a5b21de0e59b8ecc49477c))
    - Preallocate the vector ([`89ef97e`](https://github.com/vadorovsky/aya/commit/89ef97e8482d1d0c1bb243441d911f688e183315))
    - Plug file descriptor leak ([`7bb9b7f`](https://github.com/vadorovsky/aya/commit/7bb9b7f5a5f03e815a5274457a93d0b20677059f))
    - Push error construction up ([`b1404e9`](https://github.com/vadorovsky/aya/commit/b1404e9a73aee4cdf93e96b44d35057ae1f6f079))
    - Make `loaded_programs` opaque ([`a0af7e0`](https://github.com/vadorovsky/aya/commit/a0af7e0b2fddaf297887c3e4c7480ef625c88ada))
    - Extract common SyscallError ([`de8519a`](https://github.com/vadorovsky/aya/commit/de8519a38083e96f9a0c34f0577657b8050db8a8))
    - `sys_bpf` takes mut ref ([`4cb3ea6`](https://github.com/vadorovsky/aya/commit/4cb3ea6e8fa990b88c5e8a67f1c852355bc7d99a))
    - Merge pull request #714 from aya-rs/dry-btf-load ([`f095c59`](https://github.com/vadorovsky/aya/commit/f095c591af9010dcbf9e7e8e4c6f9e2741c8592b))
    - Avoid repeating BPF_BTF_LOAD dance ([`7ee6f52`](https://github.com/vadorovsky/aya/commit/7ee6f52a7442e97d81ef41bc75673c8560bec5b0))
    - Merge pull request #706 from aya-rs/reloc-tests ([`3692e53`](https://github.com/vadorovsky/aya/commit/3692e53ff0e5cb87983a9b2dd54624baad22d582))
    - S/assert!(.*) ==/assert_eq!\1,/ ([`6f3cce7`](https://github.com/vadorovsky/aya/commit/6f3cce75cf11af27a9267dd88a688fc24e6b17b5))
    - Merge pull request #707 from aya-rs/one-option-not-two ([`4c3219f`](https://github.com/vadorovsky/aya/commit/4c3219f754c79e00ae4e56e13b646123cde31c61))
    - Reduce state cardinality from 4 to 2 ([`0ec9afd`](https://github.com/vadorovsky/aya/commit/0ec9afdb07f42bc40e60c9a6af1908b23f5bf263))
    - Merge pull request #701 from nrxus/perf-event-owned-fd ([`445cb8b`](https://github.com/vadorovsky/aya/commit/445cb8b46318a13a94e10e11000232d4bd5b23af))
    - Return `OwnedFd` for `perf_event_open`. ([`dbfba18`](https://github.com/vadorovsky/aya/commit/dbfba18dac87cbd837820316d53ad09b27d0c469))
    ...
    - Merge pull request #696 from Tuetuopay/tests-netns ([`f705eab`](https://github.com/vadorovsky/aya/commit/f705eabe667d4abdfd0b895de586cc4145319cf0))
    - Add the possibility to run a test inside a network namespace ([`c74813f`](https://github.com/vadorovsky/aya/commit/c74813f8c545fca288094f47b20096e58eb5f46a))
    ...
    - Merge pull request #662 from nrxus/use-owned-fd-for-btf ([`13e83b2`](https://github.com/vadorovsky/aya/commit/13e83b24ee572009176b82840fb5cf1845fcf3dd))
    - Use Arc<OwnedFd> when loading BTF fd ([`ea96c29`](https://github.com/vadorovsky/aya/commit/ea96c29ccbae6c59a6a5bfc90f402ad307e22665))
    - Make SysResult generic on Ok variant ([`683a1cf`](https://github.com/vadorovsky/aya/commit/683a1cf2e4cdfba05ba35d708fecc4f43b0e83b3))
    - Replace std::os::unix::io for std::os::fd ([`c63d990`](https://github.com/vadorovsky/aya/commit/c63d9904f7e64349bd23c029a3bf31aaf1d97291))
    - Merge pull request #688 from aya-rs/get-fd-owned ([`53d36a3`](https://github.com/vadorovsky/aya/commit/53d36a3fe04b6828568603bfcfd9a588418abb1b))
    - Bpf_prog_get_fd_by_id returns OwnedFd ([`76c78e3`](https://github.com/vadorovsky/aya/commit/76c78e3bf82eb77c947dd125ed6624dfa6f4cc1c))
    ...
    - Merge pull request #671 from dave-tucker/misc-fixes ([`7ac808c`](https://github.com/vadorovsky/aya/commit/7ac808cf551154b73f0e471af8a1a2ab88258409))
    - Clippy fixes for latest nightly ([`764eb30`](https://github.com/vadorovsky/aya/commit/764eb309b082a2e54b0d98782bb9cecd1243ff42))
    ...
    - Handle WSL kernel version strings ([`35ed85a`](https://github.com/vadorovsky/aya/commit/35ed85a87ff467c7091c8749e48b8475cd1af592))
    ...
    - Merge pull request #584 from marysaka/fix/btf-kern-optional ([`0766e70`](https://github.com/vadorovsky/aya/commit/0766e705486df167b0d5cf736c1edc14880bce17))
    - Don't use env::tempdir ([`5407d4a`](https://github.com/vadorovsky/aya/commit/5407d4a9a1885806a0f74abfc8cfe17baf13e124))
    - Remove "async" feature ([`fa91fb4`](https://github.com/vadorovsky/aya/commit/fa91fb4f59be3505664f8088b6e3e8da2c372253))
    - Ignore embedded BTF error if not truely required ([`74b5468`](https://github.com/vadorovsky/aya/commit/74b546827cdde13872e141e9e5b6cc9ac39efe1e))
    - Fix build ([`242d8c3`](https://github.com/vadorovsky/aya/commit/242d8c33c4ff71f766f32f184f826d3216929faa))
    - Merge pull request #520 from astoycos/unsupported-map ([`eb60d65`](https://github.com/vadorovsky/aya/commit/eb60d6561362e57955b2963b9a6b0a818281aabf))
    - Merge pull request #560 from astoycos/fix-perf-link-pin ([`edb7baf`](https://github.com/vadorovsky/aya/commit/edb7baf9a37187027e4459a7c716b22c2204ca1f))
    - Add FdLink documentation and example ([`80b371f`](https://github.com/vadorovsky/aya/commit/80b371f6d134aeba0f31716bf091d03cc9ca13fe))
    - Merge pull request #644 from aya-rs/build-script ([`7def6d7`](https://github.com/vadorovsky/aya/commit/7def6d72183d786427b8232945e139bb8c84d2d2))
    - Implement FdLink conversions ([`58895db`](https://github.com/vadorovsky/aya/commit/58895db9b46f810d8dd1550951d490ff56dcb9b4))
    - Compile C probes using build.rs ([`8c61fc9`](https://github.com/vadorovsky/aya/commit/8c61fc9ea6d1d52b38a238541fb229bc850c82ac))
    ...
    - Type-erase KernelVersion::current error ([`a1e0130`](https://github.com/vadorovsky/aya/commit/a1e0130387390c148fc035ed1ae6b5665be4a96f))
    - Invert comparison ([`6bceb1c`](https://github.com/vadorovsky/aya/commit/6bceb1c3da2d0d71842073a2503810a666ef3caf))
    - Rewrite kernel version logic ([`6e570f0`](https://github.com/vadorovsky/aya/commit/6e570f0f14e615ccd0eeb80dfb68f3674f6ee74a))
    - Remove procfs dependency ([`cc2bc0a`](https://github.com/vadorovsky/aya/commit/cc2bc0acc183f178292d630789031aed0634f878))
    ...
    - Get verifier logs when loading programs ([`b45a5bb`](https://github.com/vadorovsky/aya/commit/b45a5bb71b485dbf05e21ddc4392bfda78f2e6f5))
    ...
    - Merge pull request #639 from aya-rs/test-no-bpftool ([`e93e3c4`](https://github.com/vadorovsky/aya/commit/e93e3c4a55c5c740f4b1d4ce52be709f218dae1b))
    - Remove dependency on bpftool in integration tests ([`ff86f13`](https://github.com/vadorovsky/aya/commit/ff86f1385c1c45ed8dadcf160f2d4ae67b39ec13))
    ...
    - Merge pull request #526 from dave-tucker/trie ([`76d35d1`](https://github.com/vadorovsky/aya/commit/76d35d10ce2ca86daee8646e701d42ceedfd9d06))
    - Remove iter_key from LPM Trie API ([`00c480d`](https://github.com/vadorovsky/aya/commit/00c480d2f95d4c47fc281173307c179220cc4452))
    - Merge pull request #633 from ajwerner/change-fd-import ([`5c6bd55`](https://github.com/vadorovsky/aya/commit/5c6bd5526096a5a4c10e95643365d16d0090cf8f))
    - Replace os::unix::prelude with os::fd ([`65d10f9`](https://github.com/vadorovsky/aya/commit/65d10f9ffcad065bd87c15aacc85cc4a0c2a03ee))
    ...
    - Update aya/src/bpf.rs ([`77cce84`](https://github.com/vadorovsky/aya/commit/77cce840f7957f12e29f29e1f05762173bb2b92b))
    ...
    - Fixups in response to alessandrod review ([`17930a8`](https://github.com/vadorovsky/aya/commit/17930a88c5ea08d0ae68ac8fecee59f425fd06a3))
    - Add Unsupported Map type ([`b5719c5`](https://github.com/vadorovsky/aya/commit/b5719c5b3fcb7e48896212bdc7ee82d40f838bc2))
    - Merge pull request #625 from FedericoPonzi/issue-534 ([`9cdae81`](https://github.com/vadorovsky/aya/commit/9cdae8126573e598284f7dc3f6fff2f97a48cc02))
    - Add syscall_prefix and syscall_fnname_add_prefix ([`987e848`](https://github.com/vadorovsky/aya/commit/987e8489d05c50b777272124a7ec6ef6f3db6145))
    - Merge pull request #622 from marysaka/fix/uprobe-416-lower ([`e5bac02`](https://github.com/vadorovsky/aya/commit/e5bac0295306a6627658e818939927c387442295))
    - Fix uprobe support on 4.16 and lower ([`49c6f5d`](https://github.com/vadorovsky/aya/commit/49c6f5d12253cccf6354f818bf6d3b190428dc29))
    - Merge pull request #621 from marysaka/fix/uprobe-debian-10 ([`41fe944`](https://github.com/vadorovsky/aya/commit/41fe944a1a60279705f5ed156b25675ea302e861))
    - Add support for old ld.so.cache format ([`8e9f395`](https://github.com/vadorovsky/aya/commit/8e9f395eab70b23b84b14e17d9b1518918b35ee6))
    - Merge pull request #619 from poliorcetics/relax-ordering-probe-alias ([`37b7c1e`](https://github.com/vadorovsky/aya/commit/37b7c1e6141c53fce195b01deafedb18a955e9e1))
    - Relax unnecessarily strict atomic ordering on probe event_alias ([`243986c`](https://github.com/vadorovsky/aya/commit/243986c1da440c763393a4a37d5b3922b6baa3cc))
    - Merge pull request #618 from marysaka/fix/aya-probe-event-alias-uniq ([`d56ed8f`](https://github.com/vadorovsky/aya/commit/d56ed8fd687453f248fa79b6459598d53e11f40a))
    - Make probe event_alias unique ([`e9be3d9`](https://github.com/vadorovsky/aya/commit/e9be3d9023478b0132779267dcd88222f69feef5))
    ...
    - Add a few tweak a code to fix libbpf's API change. ([`afb4aa1`](https://github.com/vadorovsky/aya/commit/afb4aa1c66b17d9e2b9a445f345c206764a9d391))
    - Fixed a typo in the per_cpu_hashmap documentation ([`3d1013d`](https://github.com/vadorovsky/aya/commit/3d1013d72981e673cbc3d24401d5855ab12f6a02))
    - Merge pull request #607 from Hanaasagi/fix-warning ([`d4bfd72`](https://github.com/vadorovsky/aya/commit/d4bfd72f578d24fb3a9bc5fb8177f08f98ef56d0))
    - Remove useless `any` `all` in cfg. ([`0e4aec4`](https://github.com/vadorovsky/aya/commit/0e4aec475ff2e9448196bce0b4598a983419974e))
    ...
    - Merge pull request #592 from probulate/update-bitflags ([`67f480e`](https://github.com/vadorovsky/aya/commit/67f480eb8e1798ddb6c025560bd77bb21f46650b))
    - Update bitflags requirement from 1.2.1 to 2.2.1 ([`ae8a95b`](https://github.com/vadorovsky/aya/commit/ae8a95b0ee513b220b0b5ff1332ca24059ed3e7e))
    ...
    - Merge pull request #525 from dave-tucker/borrow ([`ed14751`](https://github.com/vadorovsky/aya/commit/ed14751c791a0db4d01ec759a6dc21e2f6cc3312))
    - Merge pull request #579 from marysaka/fix/ubuntu-debian-kernel-version-code ([`1066c6c`](https://github.com/vadorovsky/aya/commit/1066c6c2e5607d4484591cbfb77efd9464d802b2))
    - Correctly set the kernel code version for Debian kernel ([`3aeeb81`](https://github.com/vadorovsky/aya/commit/3aeeb8167baa2edb511f39b3d396d9112443aa73))
    - Correctly set the kernel code version for Ubuntu kernel ([`f1d8918`](https://github.com/vadorovsky/aya/commit/f1d891836e73d503c1841f5e7aee199d2b223afa))
    ...
    - Merge pull request #580 from marysaka/fix/bpf_create_map_panic ([`edd9928`](https://github.com/vadorovsky/aya/commit/edd9928314baf6e53f091f06b166aad797fa7337))
    - Do not use unwrap with btf_fd in bpf_create_map ([`7c25fe9`](https://github.com/vadorovsky/aya/commit/7c25fe90a9611545aba047cd347ca431616130b6))
    ...
    - Program_section ([`17f497c`](https://github.com/vadorovsky/aya/commit/17f497ce4207c5c26023914d956c7c69411b25c1))
    - Merge pull request #557 from drewvis/main ([`b13070a`](https://github.com/vadorovsky/aya/commit/b13070a3429033700f8d13b4f01f81d4ede07fe1))
    - Make it possible to use set_global() with slices of Pod(s) ([`bcb2972`](https://github.com/vadorovsky/aya/commit/bcb2972a969f85e8c6c77e1213d89cc8198e8fe7))
    - Added code check comment ([`8f64cf8`](https://github.com/vadorovsky/aya/commit/8f64cf8cd5bf5d03445a6a79216775fda83179be))
    - Add check for empty tracefs mounts ([`3a2c0cd`](https://github.com/vadorovsky/aya/commit/3a2c0cd1dd7472feb77019dec3a4a8bc466167b7))
    - Revert "aya: make it possible to use set_global() with slices of Pod(s)" ([`8ef00c4`](https://github.com/vadorovsky/aya/commit/8ef00c4c637bb3f86f6cabb86f44d5e9a40d6506))
    - Make it possible to use set_global() with slices of Pod(s) ([`b614ffd`](https://github.com/vadorovsky/aya/commit/b614ffd603f4a276fd060659e14e5794bb26381f))
    - Merge pull request #548 from kriomant/feature-xdp-attach-by-index ([`d6319f9`](https://github.com/vadorovsky/aya/commit/d6319f95c91212218f4282aa025e3295166c9b7f))
    - Don't leak libc types ([`ce60854`](https://github.com/vadorovsky/aya/commit/ce60854934312c9ebb75178f44faf9369febf6ad))
    - Fix formatting ([`896e3ab`](https://github.com/vadorovsky/aya/commit/896e3ab3130c4de44e8c0f4f974163c13aa50ff0))
    - Rename method and fix comment ([`676b5cd`](https://github.com/vadorovsky/aya/commit/676b5cdc0df380471090153ab4ff2e641e4e1d03))
    - Allow to attach XDP probe by interface index ([`2e3c177`](https://github.com/vadorovsky/aya/commit/2e3c1779be03898dd6a01644012ef21b2475ad63))
    - Merge pull request #539 from marysaka/fix/map_data_clone ([`113e3ef`](https://github.com/vadorovsky/aya/commit/113e3ef0183acc69202fa6587643449f793cfff8))
    - Fix MapData Clone implementation ([`94049ec`](https://github.com/vadorovsky/aya/commit/94049ec661ed715e65fb4fb29c92d10d803699cc))
    - Merge pull request #524 from dave-tucker/prog_list ([`d9878a6`](https://github.com/vadorovsky/aya/commit/d9878a67917069e89e4ea974d116c8fdab3da4e5))
    - Add loaded_programs() API to list all loaded programs ([`de4905a`](https://github.com/vadorovsky/aya/commit/de4905a24bc0f665c40af964b56471c04434a8b4))
    - MapData should be Borrow, not AsRef ([`b1a70fc`](https://github.com/vadorovsky/aya/commit/b1a70fc6e40f7ad398bce9994f3bb2642267ca8b))
    - Merge pull request #523 from dave-tucker/fix_perf_link ([`56c1438`](https://github.com/vadorovsky/aya/commit/56c143831e8f056ac77bb5282a340c1a545eb0f2))
    - Fix is_perf_link_supported ([`ce79de7`](https://github.com/vadorovsky/aya/commit/ce79de7ff6b965efa25840b35b0d051c3087db0a))
    - Merge pull request #522 from dave-tucker/perf_link ([`d7d6442`](https://github.com/vadorovsky/aya/commit/d7d6442671a38098613b1a0accea0c08272d9fc0))
    - More discrete feature logging ([`7479c1d`](https://github.com/vadorovsky/aya/commit/7479c1dd6c1356bddb0401dbeea65618674524c9))
    - Enable bpf_link for perf_attach programs ([`d0b3d3b`](https://github.com/vadorovsky/aya/commit/d0b3d3b2fac955ed0e1e3d885fcd3ba67941dc8c))
    - Add probe for bpf_link_create for perf programs ([`763b92a`](https://github.com/vadorovsky/aya/commit/763b92a2e007a17cc2b6a17929dcb6a5c26c9f88))
    ...
    - Merge pull request #496 from dave-tucker/program-from-pinned3 ([`811ab29`](https://github.com/vadorovsky/aya/commit/811ab299deee19017fa8158b7b9e8eea88107c6a))
    - Add from_pin for Programs ([`7a720ab`](https://github.com/vadorovsky/aya/commit/7a720ab0c1061b7a6f4e8e7bf862d86550bbdc7b))
    - Merge pull request #515 from alessandrod/fix-lru-hash ([`cfa693b`](https://github.com/vadorovsky/aya/commit/cfa693bc3b4442a8c97cfcd24551ea6439f25e50))
    - Fix Lru and LruPerCpu hash maps ([`c22014c`](https://github.com/vadorovsky/aya/commit/c22014c757c88c40091e44a48e14920f6e6e0334))
    - Merge pull request #512 from astoycos/crucial-btf-fixes ([`27017ca`](https://github.com/vadorovsky/aya/commit/27017ca8a32e692d6226e11857d68e5c0acc249e))
    - Support BTF key/value specification for all maps ([`52e6250`](https://github.com/vadorovsky/aya/commit/52e625060e463c5b7b0ec0fe9f683b82d7227ad0))
    - Merge pull request #445 from anfredette/tc-link-recon ([`22d7931`](https://github.com/vadorovsky/aya/commit/22d79312f7f5d8afd97dfaa42d3cd063206772e3))
    - Address review comments from @alessandrod ([`7c24296`](https://github.com/vadorovsky/aya/commit/7c24296b5df73a5d9d07872a3832cf4e9aa9c76f))
    - Merge pull request #471 from banditopazzo/tracefs_mount_select ([`7e5637b`](https://github.com/vadorovsky/aya/commit/7e5637bb9c9a0c35424e17139eaf58c825aad08c))
    - Tracefs review fixes ([`48fdf5a`](https://github.com/vadorovsky/aya/commit/48fdf5a250ce74516a02c0f34b0f359f7f9a4d63))
    - Get_tracefs function ([`c6c4ac7`](https://github.com/vadorovsky/aya/commit/c6c4ac7eeaf7e6cfa31ab0b949aa93b136eda91b))
    - Updates after rebase due to changes in define_link_wrapper ([`d43879d`](https://github.com/vadorovsky/aya/commit/d43879d99177c33c5d33827d8a3c7572841dd9df))
    - Remove SchedClassifierLink description ([`6766532`](https://github.com/vadorovsky/aya/commit/6766532341803ab70501e0c522afc0656385e002))
    - Address review comments ([`2972d46`](https://github.com/vadorovsky/aya/commit/2972d462a505aaba8d9e40ddf2c6110e497283db))
    - Address review comments ([`65f5b76`](https://github.com/vadorovsky/aya/commit/65f5b76593f35b8ca09f5d868a4195086ddca831))
    - Rename SchedClassifierLink:new() to new_tc_link() ([`849796c`](https://github.com/vadorovsky/aya/commit/849796c4208b520cd12a7ac5de28857dc885c026))
    - Additional edits to SchedClassifierLink documentation. ([`67efc33`](https://github.com/vadorovsky/aya/commit/67efc33414df049853247e344dfaa37eeeafe602))
    - Combine updates to SchedClassifierLink example made by Dave Tucker ([`6563e6c`](https://github.com/vadorovsky/aya/commit/6563e6cc065d01270aad50d9c3449f9deb9f04d6))
    - Add example for SchedClassifierLink::new() ([`c3a8400`](https://github.com/vadorovsky/aya/commit/c3a8400e4d219eb72167ccaeb500d36ad924873d))
    - Support reconstruction of `SchedClassifierLink` ([`f46fd17`](https://github.com/vadorovsky/aya/commit/f46fd17cc31f7f900f01d8e97baebe6445c468d4))
    - Expose inner errors ([`1899d5f`](https://github.com/vadorovsky/aya/commit/1899d5f4fd3ec5d91e40a94d671a7756125a4487))
    - Merge pull request #484 from vadorovsky/update-tokio ([`bea0e83`](https://github.com/vadorovsky/aya/commit/bea0e83512cc6d45b3e4fb5c3f62432c434139b7))
    - Update Tokio and inventory ([`dad75f4`](https://github.com/vadorovsky/aya/commit/dad75f45ac357e86eebc92c4f95f6dd4e43d8496))
    ...
    - Btf relocs: don't panic on failed relocation ([`c6f93b1`](https://github.com/vadorovsky/aya/commit/c6f93b177511d3dfb0ab6cce4fa298d13707dedc))
    - Make btf::RelocationError private ([`aba99ea`](https://github.com/vadorovsky/aya/commit/aba99ea4b1f5694e115ae49e9dbe058d3e761fd8))
    - Fix regression computing pointer sizes ([`12e422b`](https://github.com/vadorovsky/aya/commit/12e422b21134e3f4fb1949b248ecfd2afd768e53))
    - Resolve symbol address for PIE executables ([`1a22792`](https://github.com/vadorovsky/aya/commit/1a22792ee75642a3998634cc16abda7d813b45bb))
    - Fix detaching links on drop ([`b3ae778`](https://github.com/vadorovsky/aya/commit/b3ae7786d335fd0294a6ddecf3f31ef28d56af9d))
    - Merge pull request #461 from FallingSnow/main ([`9f5d157`](https://github.com/vadorovsky/aya/commit/9f5d157628e1636390cc73fd5d21db62b1894a13))
    - Fix LpnTrieKeys -> LpmTrieKeys typo ([`10ac595`](https://github.com/vadorovsky/aya/commit/10ac5957c1a01dd5a41307c45e2824cf20021dff))
    - Merge pull request #466 from bpfdeploy-io/ml/cgroup-device ([`d1919a8`](https://github.com/vadorovsky/aya/commit/d1919a83ed21ec8156732b9bb34194c9c8a50bc1))
    - Fix doctest issue ([`925504f`](https://github.com/vadorovsky/aya/commit/925504f230db683f2728f72577c3c7f2504b6f16))
    - Fix CI, clippy and feedback ([`4b6d97e`](https://github.com/vadorovsky/aya/commit/4b6d97e4db4261921a43958366b66fa3e0da237b))
    - Add support for BPF_PROG_TYPE_CGROUP_DEVICE ([`8f1163a`](https://github.com/vadorovsky/aya/commit/8f1163a400b13010acf5353ddc43e9b81ca61d7a))
    - Fix formatting ([`a44f054`](https://github.com/vadorovsky/aya/commit/a44f054bec60c64c5254a9799ae0c92683dd8889))
    - Merge pull request #460 from Tuetuopay/owned-per-cpu-hash-map ([`66d435f`](https://github.com/vadorovsky/aya/commit/66d435fc7c6cf55a64263de3263f9864762f4f92))
    - Remove old test ([`1368eb9`](https://github.com/vadorovsky/aya/commit/1368eb94e7609e477a503da5b9fe94ed0f3cea93))
    - Add ability to iterate over lpmtrie key matches ([`9a3682e`](https://github.com/vadorovsky/aya/commit/9a3682e793e02ce16c83e5ba8dcfa89f44d6b434))
    - Fix lpmtrie iter returning nothing ([`8fe64ae`](https://github.com/vadorovsky/aya/commit/8fe64aef1fa13cc2796ab62889526745203cd579))
    - Add missing TryFrom<Map> for HashMap, PerCpuHashMap and LpmTrie ([`51bb50e`](https://github.com/vadorovsky/aya/commit/51bb50ed8e9726723b395515374053e59cd4c402))
    - Iterate lpmtrie ([`e4182a9`](https://github.com/vadorovsky/aya/commit/e4182a9eabe157e7b506111b0dda2d0dc15f0d8d))
    - Merge pull request #456 from dmitris/uninlined_format_args ([`16b029e`](https://github.com/vadorovsky/aya/commit/16b029ed3708470afd2a6d67615b30c8d30b5059))
    - Fix uninlined_format_args clippy issues ([`055d94f`](https://github.com/vadorovsky/aya/commit/055d94f58be4f80ada416b99278a22f600c71285))
    - Merge pull request #450 from aya-rs/dependabot/cargo/object-0.30 ([`1ded0e6`](https://github.com/vadorovsky/aya/commit/1ded0e61cd9d49007408584210c51521be2aad5f))
    - Update object requirement from 0.29 to 0.30 ([`1fe7bba`](https://github.com/vadorovsky/aya/commit/1fe7bba070cc74008cc8165030b01336cb9acbe1))
    - Merge pull request #452 from vadorovsky/fix-lint ([`9382de7`](https://github.com/vadorovsky/aya/commit/9382de75cc4cbf6e115a96fb33a40137fd70476a))
    - Fix clippy error ([`176d61a`](https://github.com/vadorovsky/aya/commit/176d61ae23c3977a8f2b6c9a41286604ebe9280e))
    - Merge pull request #418 from anfredette/tc-handle ([`7fef833`](https://github.com/vadorovsky/aya/commit/7fef833e3a94aef9eba7c9fa0f83e3fc9ba0e1ea))
    - Make doc fixes ([`abb75ba`](https://github.com/vadorovsky/aya/commit/abb75ba0293ca7b68abeff3d670dadc5997eb959))
    - Merge pull request #431 from 0b01/refs ([`88d7777`](https://github.com/vadorovsky/aya/commit/88d77775530341ec32ff4f764b729e53a48c0de0))
    - Fix formatting ([`76e417a`](https://github.com/vadorovsky/aya/commit/76e417a474ca6f89956dd3834e387928c328b44c))
    - Support both attach() and attach_with_options() for SchedClassifier ([`a3e3e80`](https://github.com/vadorovsky/aya/commit/a3e3e806986b6c3761b1072626825d7f58376c50))
    - Merge pull request #435 from vadorovsky/pin-fix-error-msg ([`3e089a6`](https://github.com/vadorovsky/aya/commit/3e089a61d19955440bdbd77d2ab62a2f68ccf99f))
    - Fix the error message in `MapData::pin()` ([`e0a9895`](https://github.com/vadorovsky/aya/commit/e0a98952601bf8244a1f046a106b6419313537b6))
    - Make sure everything is marked correctly ([`6ce60ad`](https://github.com/vadorovsky/aya/commit/6ce60ad21da48d98a47442d234b94e60b1449008))
    - Fix array ([`9525b1a`](https://github.com/vadorovsky/aya/commit/9525b1a370a0f3123bf97b31040ca6d07d315ef3))
    - Fix wrong bounds ([`575fea4`](https://github.com/vadorovsky/aya/commit/575fea4cb9a19540de82283855fb84fad8113dfd))
    - Cargo fmt ([`fbfbedb`](https://github.com/vadorovsky/aya/commit/fbfbedb6a89825bec107b2f0b8fc6fed8042321d))
    - Use & ([`9991ffb`](https://github.com/vadorovsky/aya/commit/9991ffb093bff3a10678c48f8c4c7610558ab809))
    - Add test case ([`e9ec257`](https://github.com/vadorovsky/aya/commit/e9ec257328299551a750883075095f8a60f1cce3))
    - Use Borrow<T> instead ([`1247ffc`](https://github.com/vadorovsky/aya/commit/1247ffc19b8d68d37c032a7b916e3f2b3531972f))
    - Use a struct for setting priority and handle in SchedClassfier attach ([`af3de84`](https://github.com/vadorovsky/aya/commit/af3de84b081941bd3139c7089618a53dfa37ac83))
    - Support using handle in tc programs ([`ac07608`](https://github.com/vadorovsky/aya/commit/ac07608b7922a545cd1de1996b66dcbdeb7fbbe1))
    - Merge pull request #397 from astoycos/refactor-map-api2 ([`d6cb1a1`](https://github.com/vadorovsky/aya/commit/d6cb1a16ad0f8df483e2234fb01ab55bdbeaa8b8))
    - Fix doc links, update rustdoc args ([`82edd68`](https://github.com/vadorovsky/aya/commit/82edd681c398f73de026a695837dd37643ed124a))
    - Make map APIs return an option ([`f3262e8`](https://github.com/vadorovsky/aya/commit/f3262e87bd6ff895537df47fcf5d17c598e564cc))
    - Fixups4 ([`4ddf260`](https://github.com/vadorovsky/aya/commit/4ddf2600b4084d224d66810f8372f42354dc40e0))
    - Fixups 3 ([`440097d`](https://github.com/vadorovsky/aya/commit/440097d7bc671c78fa33d13f890c3aa456530306))
    - Fixups 2 ([`939d16c`](https://github.com/vadorovsky/aya/commit/939d16cce5dcfeaebc5d571d21127105fc886186))
    - Fixups ([`8009361`](https://github.com/vadorovsky/aya/commit/8009361694a7f8967a31734d109f79a6b26516dc))
    - Implement Copy for MapData ([`893f9f4`](https://github.com/vadorovsky/aya/commit/893f9f44a22d4c78d86107cdac1204c4da65938a))
    - Use SockMapFd ([`898a14d`](https://github.com/vadorovsky/aya/commit/898a14d42559c7567f45e43fccdaa741a3ac9f27))
    - Core refactor of Map API ([`1aefa2e`](https://github.com/vadorovsky/aya/commit/1aefa2e5e6d22a600cc7339d289d64ab06f842e3))
    - Merge branch 'aya-rs:main' into integration-tests-cli-options ([`4183c7a`](https://github.com/vadorovsky/aya/commit/4183c7a7d21c655b71c6a62998d71d7ffe653f53))
    - Merge pull request #411 from abhijeetbhagat/fix-warnings ([`94bc93e`](https://github.com/vadorovsky/aya/commit/94bc93ea07664c682198389d42a14bfe58367967))
    - Fix all clippy warnings ([`6c813b8`](https://github.com/vadorovsky/aya/commit/6c813b8c38a172e8372d7009b50029d1cb8513e4))
    - Merge pull request #406 from dave-tucker/unused-deps ([`57ab0d7`](https://github.com/vadorovsky/aya/commit/57ab0d7978e211b16fece64be25edef28ab9441a))
    - Remove unused dependencies ([`ec2bd69`](https://github.com/vadorovsky/aya/commit/ec2bd690532cc21b22e07cfa1539a195bf5e149c))
    - Merge pull request #404 from dave-tucker/async-docs ([`14ba644`](https://github.com/vadorovsky/aya/commit/14ba644aa5ac4263062d6249420fb07b36ca5080))
    - Add labels for optional features ([`95e8c78`](https://github.com/vadorovsky/aya/commit/95e8c78db8fef4fcc12a9cbf0a52753049070e4b))
    - Merge pull request #398 from vadorovsky/fix-miri ([`3f2f3a8`](https://github.com/vadorovsky/aya/commit/3f2f3a8be038edd8944823b11ff772e924d3d962))
    - Disable miri warnings about integer-to-pointer conversions ([`43aff57`](https://github.com/vadorovsky/aya/commit/43aff5779390881d785a4d1c0d6c7bd681381dfe))
    - Avoid integer to pointer casts ([`2432677`](https://github.com/vadorovsky/aya/commit/2432677b2bafcfa4028f9315f6754b14c070b4dd))
    - Merge pull request #393 from aztecher/impl-set_max_entries ([`a93a975`](https://github.com/vadorovsky/aya/commit/a93a975cc63e4e47542289b8c9d8fb83fa135ef9))
    - Add BpfLoader::set_max_entries ([`2eccf1d`](https://github.com/vadorovsky/aya/commit/2eccf1d57da4c9bfa1ea4c0802bc34905c9b1f72))
    - Merge pull request #394 from vadorovsky/clippy ([`6eca4f5`](https://github.com/vadorovsky/aya/commit/6eca4f570990e0334281560be969505380445688))
    - Fix clippy warnings ([`5a4b5ff`](https://github.com/vadorovsky/aya/commit/5a4b5ff8d8bf8d3f36cb784d9e3af5284e388433))
    - Merge pull request #391 from dave-tucker/fix-387 ([`e696389`](https://github.com/vadorovsky/aya/commit/e696389837c1625de9f58ad9f77c56ecfb268b0c))
    - Rename from_pinned and from_path to from_pin ([`5693fb9`](https://github.com/vadorovsky/aya/commit/5693fb994123b88eb856af83c5b8f79afd1d789f))
    - Fix review comments from #387 ([`de6fa98`](https://github.com/vadorovsky/aya/commit/de6fa98963b7c5a311aafec6afe956ff716d68c5))
    - Merge pull request #387 from astoycos/map-from-prog ([`eb26a6b`](https://github.com/vadorovsky/aya/commit/eb26a6b116885fa19294c944080b42408f49bd30))
    - Add `from_pinned` and `from_fd` methods ([`8a9cbf1`](https://github.com/vadorovsky/aya/commit/8a9cbf179f62b68def7d30612cdffb576d062baa))
    - Merge pull request #378 from dave-tucker/pin-fixes-again ([`98e25ca`](https://github.com/vadorovsky/aya/commit/98e25ca5e6550526d35f783d74e6276f7aaf8a71))
    - Add integration test for pinning lifecycle ([`7c244e1`](https://github.com/vadorovsky/aya/commit/7c244e1f65fdb80f65c6a317773f3ff069255cd8))
    - Replace From<FdLink> for XdpLink with TryFrom ([`f961cbb`](https://github.com/vadorovsky/aya/commit/f961cbb3d43693e21a9c633d8b581c8a24fa7055))
    - Rename bpf_obj_get_info_by_id ([`6af2053`](https://github.com/vadorovsky/aya/commit/6af2053cf3fd36522642169710d2804feb1e20a5))
    - Merge pull request #376 from conectado/verifier-log-level ([`fe22b02`](https://github.com/vadorovsky/aya/commit/fe22b0210894e7f383566110f094acf6a738125e))
    - Fix miss doc period ([`3bed2c2`](https://github.com/vadorovsky/aya/commit/3bed2c2b94a47503ba32e9879c7a29fe9f8e9227))
    - Change  variant names ([`c30ae6e`](https://github.com/vadorovsky/aya/commit/c30ae6e0010adda3d3e3de792cf2919f3c1dcf32))
    - More pinning fixes ([`4b5b9ab`](https://github.com/vadorovsky/aya/commit/4b5b9ab3d92befe967709ad6cc55264fc0541b73))
    - Merge pull request #384 from aya-rs/codegen ([`7b99a57`](https://github.com/vadorovsky/aya/commit/7b99a5733084d4638e74327901bb442ce8b4333b))
    - [codegen] Update libbpf to efd33720cdf4a0049323403df5daad0e9e894b3dUpdate libbpf to efd33720cdf4a0049323403df5daad0e9e894b3d ([`ed849ff`](https://github.com/vadorovsky/aya/commit/ed849ffd18fd360fef9b5bfa636054a5f18f0170))
    - Merge pull request #381 from aya-rs/codegen ([`49c5a94`](https://github.com/vadorovsky/aya/commit/49c5a94aa0198897a9aef9a1cad4523bb63c56ee))
    - [codegen] Update libbpf to efd33720cdf4a0049323403df5daad0e9e894b3dUpdate libbpf to efd33720cdf4a0049323403df5daad0e9e894b3d ([`8e96011`](https://github.com/vadorovsky/aya/commit/8e96011c2da245090f8b8603bf6d57cf7c5902a4))
    - Merge pull request #379 from dave-tucker/fix-link-segfault ([`9451699`](https://github.com/vadorovsky/aya/commit/945169996c435815f0b9ef1a591c17a6fbec5a0d))
    - Fix segfault in define_link_wrapper ([`18584e2`](https://github.com/vadorovsky/aya/commit/18584e2259382bbb4e56007eacbe81dba25db05a))
    - Merge pull request #285 from dave-tucker/btf-redux ([`66b4f79`](https://github.com/vadorovsky/aya/commit/66b4f79ecafe9832fcc1e44373598774b9954514))
    - Improved BTF Type API ([`f34ebeb`](https://github.com/vadorovsky/aya/commit/f34ebeba99e409bb369a74687e1664a50c430c1e))
    - Update `VerifierLogLevel` to use bitflags ([`7b14319`](https://github.com/vadorovsky/aya/commit/7b143199fb61edd168f3efc860a8e8c1d4cd9136))
    - Merge pull request #366 from dave-tucker/pin-redux-2 ([`4826bf7`](https://github.com/vadorovsky/aya/commit/4826bf7f748722724536c7f9bbc3234262e35128))
    - Fix Link Pinning ([`4c1d645`](https://github.com/vadorovsky/aya/commit/4c1d645aa6e8150b50007ff42eb17e270a5b80af))
    - Merge pull request #371 from conectado/verifier-log-level ([`b95adc3`](https://github.com/vadorovsky/aya/commit/b95adc3135f9b9cc74d16052250b5d8611caf9dc))
    - Update `VerifierLogLevel` level variants ([`a602525`](https://github.com/vadorovsky/aya/commit/a6025255f56a941c2614d8bbf395e07b47588b75))
    - Use enum to set verifier log level ([`edd8039`](https://github.com/vadorovsky/aya/commit/edd80397dce46f6e2a4cc96bd951562987721e55))
    - Expose BPF verifier log level configuration ([`3211646`](https://github.com/vadorovsky/aya/commit/3211646aef48c7d388941a4a9e932e66bec87fd6))
    ...
    - Add support for setting priority for classifier programs ([`207c689`](https://github.com/vadorovsky/aya/commit/207c689f560de2963210d245ae718b1f09d9eaae))
    - Merge pull request #355 from dave-tucker/rm-map-pin-path ([`55a7e3c`](https://github.com/vadorovsky/aya/commit/55a7e3c4d0b92bc19ccb9705358b95a1f4bf448c))
    - Remove MapError::InvalidPinPath ([`03a15b9`](https://github.com/vadorovsky/aya/commit/03a15b98643a520269197e5db98cc48715a61577))
    - Merge pull request #343 from dave-tucker/pinning-redux ([`8e6c9ad`](https://github.com/vadorovsky/aya/commit/8e6c9ad0d279fd127f2453b948b6306600eb566d))
    - Use PinError for all pinning errors ([`34ba2bc`](https://github.com/vadorovsky/aya/commit/34ba2bc0482f9a16bc9c7ad138e9288c66e4bac4))
    - Implement FdLink::pin() ([`64f8a43`](https://github.com/vadorovsky/aya/commit/64f8a434d2a337578bde86c1983f46a3282e7f53))
    - Allow pin to be used on all programs ([`5726b6d`](https://github.com/vadorovsky/aya/commit/5726b6d044011b462b04e533f881e0dd26d60d0f))
    ...
    - Fix rlimit warning on for 32bit systems ([`c9e70a8`](https://github.com/vadorovsky/aya/commit/c9e70a8758ef10cfe1970e5f7a1e830e0ba5ec8e))
    - Merge pull request #140 from dave-tucker/btf-maps ([`73ee3cf`](https://github.com/vadorovsky/aya/commit/73ee3cff70db51d5bb2d4934c2767a1ab2f13eda))
    - Support BTF Maps ([`f976229`](https://github.com/vadorovsky/aya/commit/f97622947706a8efd06546c45860cc60cfe41a13))
    - Merge pull request #344 from vadorovsky/rlimit-v2 ([`fa4347a`](https://github.com/vadorovsky/aya/commit/fa4347aae4251f30f583cfa198584392b3853087))
    - Raise the RLIMIT_MEMLOCK warning only if failed to create a map ([`3d592d0`](https://github.com/vadorovsky/aya/commit/3d592d0f295b0a2c385e200bb0224c57c144f5ea))
    - Merge pull request #342 from vadorovsky/rlimit ([`a7fa938`](https://github.com/vadorovsky/aya/commit/a7fa938f1e96c81e941eaf543e8acef03bbcfc52))
    - Raise the warning when RMILIT_MEMLOCK is not RLIM_INFINITY ([`bebe98e`](https://github.com/vadorovsky/aya/commit/bebe98e6706ec4c149508f8aabdd44707d1c6d73))
    - Merge pull request #336 from dave-tucker/clippy ([`6188c9d`](https://github.com/vadorovsky/aya/commit/6188c9dee34ef603ca04cc7cf5b113a9e96c37d2))
    - Fix latest nightly lints ([`336faf5`](https://github.com/vadorovsky/aya/commit/336faf553e1ef8d21298a4f6e9835a22e29904ad))
    - Merge pull request #330 from aya-rs/dependabot/cargo/object-0.29 ([`f2fb211`](https://github.com/vadorovsky/aya/commit/f2fb2116344e3fed10cff1dd1a1474971204e799))
    - Update object requirement from 0.28 to 0.29 ([`661a215`](https://github.com/vadorovsky/aya/commit/661a21570f1154f4ae32c81a8a142913f7deec86))
    - Merge pull request #328 from drewkett/map-update-no-key ([`a301a56`](https://github.com/vadorovsky/aya/commit/a301a563167d27498c2eda1a9a87d07ba6475024))
    - Merge pull request #282 from dave-tucker/bpfd ([`e5f455f`](https://github.com/vadorovsky/aya/commit/e5f455f238e930dff476087085ba847bb82eca87))
    - Improve Extension Docs ([`004f3dd`](https://github.com/vadorovsky/aya/commit/004f3dd6644b0c0a2ff1e877093a5ee0610eb830))
    - Add Extension::attach_to_program() ([`9e85b92`](https://github.com/vadorovsky/aya/commit/9e85b923230bd1db18fb87a3a6bc4a5c60a6b405))
    - Replace ProgramFd trait with struct ([`b441332`](https://github.com/vadorovsky/aya/commit/b4413322e3730b183546fcfdfc4b12f0ffce4a9c))
    - Implement attach_to_link for XDP ([`fd52bfe`](https://github.com/vadorovsky/aya/commit/fd52bfeadc70020e4111bb4dda0ca4e361c3be43))
    - Add support for bpf_link_update ([`ccb1897`](https://github.com/vadorovsky/aya/commit/ccb189784f87d58bc397b22c04e976cabcbd8e00))
    - Have bpf_map_update_elem take Option<&K> for key ([`36edf09`](https://github.com/vadorovsky/aya/commit/36edf092541574633ff03f7deb8b95003b2bcdd2))
    - Add Map::fd() function to return a MapFd ([`623579a`](https://github.com/vadorovsky/aya/commit/623579a47f1fd169ba9503bd71550c3fcce76b21))
    - Merge pull request #320 from dave-tucker/moar-crabby-docs ([`ed3b690`](https://github.com/vadorovsky/aya/commit/ed3b690a6d0638eaa563704c9be45559205cffeb))
    - Add crabby, sync with aya/README.md ([`2b98259`](https://github.com/vadorovsky/aya/commit/2b98259be73865cf6b213de1b73d0b7b0086a22f))
    - Add crabby logo ([`713cd4e`](https://github.com/vadorovsky/aya/commit/713cd4e858d9474318104b2a1e4dee0a25e8c67a))
    - Merge pull request #315 from dave-tucker/sock ([`7549eb9`](https://github.com/vadorovsky/aya/commit/7549eb979c39555215edfc58fbf94cdf735dc949))
    - Implement BPF_PROG_TYPE_CGROUP_SOCK ([`7b21a2d`](https://github.com/vadorovsky/aya/commit/7b21a2d17eac57696352b2519bd76a4c7e9b1a2b))
    - Unload programs on drop ([`0cd1e51`](https://github.com/vadorovsky/aya/commit/0cd1e514763fd99dc287128317e9a36312ff6883))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 3 unique issues were worked on: [#256](https://github.com/vadorovsky/aya/issues/256), [#264](https://github.com/vadorovsky/aya/issues/264), [#268](https://github.com/vadorovsky/aya/issues/268)
 ...
 * **[#256](https://github.com/vadorovsky/aya/issues/256)**
    - Add support for BPF_PROG_TYPE_CGROUP_SYSCTL ([`f721021`](https://github.com/vadorovsky/aya/commit/f721021a0af2a31d9f7c8d63100fbaa6b23a4b1e))
 * **[#264](https://github.com/vadorovsky/aya/issues/264)**
    - Program unload API ([`e2685c9`](https://github.com/vadorovsky/aya/commit/e2685c98d8ff976610efea019d23d2f584f577c2))
 * **[#268](https://github.com/vadorovsky/aya/issues/268)**
    - Add support for BPF_PROG_TYPE_CGROUP_SOCKOPT ([`e68d734`](https://github.com/vadorovsky/aya/commit/e68d734c68c9adb5269c0174cd06d416d5e0f5fe))
 * **Uncategorized**
    - (cargo-release) version 0.11.0 ([`d85b36f`](https://github.com/vadorovsky/aya/commit/d85b36f6d80236f142395f1ab173acbed74af99b))
    - Merge pull request #306 from dave-tucker/take_link ([`4ae5bc4`](https://github.com/vadorovsky/aya/commit/4ae5bc4b9b4b41c04b15b74b3293df217f55c6f1))
    - Rename forget_link to take_link ([`b2a6f00`](https://github.com/vadorovsky/aya/commit/b2a6f00212997a997799c88ba9022a69d9a0b582))
    - Merge pull request #296 from aya-rs/codegen ([`de8ab7f`](https://github.com/vadorovsky/aya/commit/de8ab7f4153041a34f3c5d876b1d9b6fdf062110))
    - [codegen] Update libbpf to 4eb6485c08867edaa5a0a81c64ddb23580420340Update libbpf to 4eb6485c08867edaa5a0a81c64ddb23580420340 ([`bbb34b3`](https://github.com/vadorovsky/aya/commit/bbb34b328587faf41a0aba42ff7eb9a785149028))
    - Merge pull request #286 from nak3/add-BPF_MAP_TYPE_BLOOM_FILTER ([`1633700`](https://github.com/vadorovsky/aya/commit/16337001e4f7140ab33d84368027cf5cdea658a0))
    - Fix typo, take & to query the value ([`c192817`](https://github.com/vadorovsky/aya/commit/c192817a59fe33f52819ec235cefbf6cda353086))
    - Merge pull request #265 from dave-tucker/sklookup ([`a047354`](https://github.com/vadorovsky/aya/commit/a0473548ca045be8b0f00b9b430b00a7350c6128))
    - Add support for BPF_PROG_TYPE_SK_LOOKUP ([`2226b89`](https://github.com/vadorovsky/aya/commit/2226b89ceb94ea29beb71376c43f371d2830ef61))
    - Add support for BPF_MAP_TYPE_BLOOM_FILTER ([`c4262f7`](https://github.com/vadorovsky/aya/commit/c4262f793dbce8558c5823a94db257ac227a5a0b))
    - Merge pull request #281 from dave-tucker/export ([`7d8365c`](https://github.com/vadorovsky/aya/commit/7d8365c3513532300b21fb80987835cb24e3402c))
    - Export program modules ([`824baf9`](https://github.com/vadorovsky/aya/commit/824baf9d642424b891ae8380cc3741fffe795123))
    - Merge pull request #279 from aya-rs/codegen ([`de1559a`](https://github.com/vadorovsky/aya/commit/de1559ab7759bd941d7f4a3a3ba373d99a3ac77a))
    - [codegen] Update libbpf to 47595c2f08aece55baaf21ed0b72f5c5abf2cb5eUpdate libbpf to 47595c2f08aece55baaf21ed0b72f5c5abf2cb5e ([`4767664`](https://github.com/vadorovsky/aya/commit/4767664d5d78c854b143669d489e3a90d2cbaf74))
    - Merge pull request #278 from dave-tucker/riscv ([`b71fe64`](https://github.com/vadorovsky/aya/commit/b71fe64a105589c806609e1f755171e77e673085))
    - Riscv scaffolding for codegen ([`edaa70b`](https://github.com/vadorovsky/aya/commit/edaa70b5ba2427ef9496732ff46f5526eab02a4d))
    - Merge pull request #276 from dave-tucker/clippy ([`0d7fb44`](https://github.com/vadorovsky/aya/commit/0d7fb4472d72f468b4c438c0e6967b99d3ac81f2))
    - Fix new lints on nightly ([`4a32e7d`](https://github.com/vadorovsky/aya/commit/4a32e7d985de5b55f263cf9244791debb34cc00f))
    - Merge pull request #273 from dave-tucker/fix_sidebar ([`9904237`](https://github.com/vadorovsky/aya/commit/9904237ac1f7dba7ef5d39d6127cdf8c591235cd))
    - Add all crates to sidebar ([`ba312c4`](https://github.com/vadorovsky/aya/commit/ba312c48d561b5a414cdd1301c322266e38118a4))
    - Merge pull request #263 from nak3/cgroup-skb-attach-type ([`63b6286`](https://github.com/vadorovsky/aya/commit/63b6286bd92382da90b28fd23f6fe35ed932ea28))
    - Merge pull request #267 from aya-rs/codegen ([`aacf6ec`](https://github.com/vadorovsky/aya/commit/aacf6ec110b1b9a59a5d3e00f022a040088e32fb))
    - [codegen] Update libbpf to 86eb09863c1c0177e99c2c703092042d3cdba910Update libbpf to 86eb09863c1c0177e99c2c703092042d3cdba910 ([`7f7c78a`](https://github.com/vadorovsky/aya/commit/7f7c78ad6b4bb619c209e9e724aeed8d9ea9a00c))
    - Use map() ([`5d22869`](https://github.com/vadorovsky/aya/commit/5d228695a46ebcde0e2e351f7b8f691daa3634ea))
    - Merge pull request #261 from dave-tucker/cgroup_sock ([`8fd8816`](https://github.com/vadorovsky/aya/commit/8fd8816dfdf2951017e6ee79aa6d0f2dc39c6edb))
    - Add BPF_PROG_TYPE_CGROUP_SOCK_ADDR ([`af54b6c`](https://github.com/vadorovsky/aya/commit/af54b6c818c4f08d599df82beeb3661b8e26ca48))
    - Set attach type during load for BPF_PROG_TYPE_CGROUP_SKB ([`29c10fa`](https://github.com/vadorovsky/aya/commit/29c10fafb70148c32b978185622214318ac5ea66))
    - Merge pull request #253 from dave-tucker/forget ([`2fca4ae`](https://github.com/vadorovsky/aya/commit/2fca4aee4e98b78c928be0c7aeb4c2166d93548a))
    - Implement forget_link ([`8069ad1`](https://github.com/vadorovsky/aya/commit/8069ad14d0baad310f52b9f1f5a651b77566310f))
    - Merge pull request #254 from dave-tucker/clippy ([`e71e07f`](https://github.com/vadorovsky/aya/commit/e71e07f88e634157dbb9b8f863d52603447a557d))
    - Fix lint against latest nightly ([`cdaa3af`](https://github.com/vadorovsky/aya/commit/cdaa3af5ae12161e12db438282912f7b027ea277))
    - Merge pull request #252 from dave-tucker/multimap-relo ([`4afc5ea`](https://github.com/vadorovsky/aya/commit/4afc5ea7117c99d5fc16f5646344c984537f15d6))
    - Relocate maps using symbol_index ([`d1f2215`](https://github.com/vadorovsky/aya/commit/d1f22151935edebed13e0baaa04f25a96ddb30f0))
    - Revert version to 0.10.7 ([`4e57d1f`](https://github.com/vadorovsky/aya/commit/4e57d1fe32763f3016a454941b8295ece4b36f9e))
    - Merge pull request #251 from aya-rs/codegen ([`e1f448e`](https://github.com/vadorovsky/aya/commit/e1f448e6b715505fbf83baea257addf49a23e413))
    - [codegen] Update libbpf to 3a4e26307d0f9b227e3ebd28b443a1a715e4e17dUpdate libbpf to 3a4e26307d0f9b227e3ebd28b443a1a715e4e17d ([`d6ca3e1`](https://github.com/vadorovsky/aya/commit/d6ca3e1ae71c4081a98c3e6d4564cc68cfaa5817))
    - Merge pull request #249 from alessandrod/new-links ([`b039ac5`](https://github.com/vadorovsky/aya/commit/b039ac524e2ba732f48f1117f14eb9c69299e6a5))
    - Rework links ([`cb57d10`](https://github.com/vadorovsky/aya/commit/cb57d10d25611a35b2cc34523d95b9f331470958))
    - Merge pull request #181 from dave-tucker/multimap ([`5472ac0`](https://github.com/vadorovsky/aya/commit/5472ac035463e2d60e11f05a21f606f5242d2357))
    - Support multiple maps in map sections ([`f357be7`](https://github.com/vadorovsky/aya/commit/f357be7db45b7201be6864e83fb7eb7e78cd984a))
    - Merge pull request #243 from alessandrod/perf-reserve ([`a1d4499`](https://github.com/vadorovsky/aya/commit/a1d4499967d8949aad9cd4b4e07f7478d0c3ee9b))
    - Perf_buffer: call BytesMut::reserve() internally ([`ad1636d`](https://github.com/vadorovsky/aya/commit/ad1636d2e795212ed6e326bd7df0fc60794be115))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#111](https://github.com/vadorovsky/aya/issues/111)
 ...
 * **[#111](https://github.com/vadorovsky/aya/issues/111)**
    - Fix test warnings ([`761cb79`](https://github.com/vadorovsky/aya/commit/761cb79fe3b9006a4091dcc7d68604b671387194))
 * **Uncategorized**
    - (cargo-release) version 0.10.7 ([`f01497e`](https://github.com/vadorovsky/aya/commit/f01497e021aa6d2ab98141c53713a4457e6b2d68))
    - Fix lint errors ([`9a642d3`](https://github.com/vadorovsky/aya/commit/9a642d373f3bd3b96b1e0a031388a8161cae5143))
    - Merge pull request #228 from nak3/fix-socket_filter ([`d690710`](https://github.com/vadorovsky/aya/commit/d6907103376512249e28457e924d2ccdb5415237))
    - Merge pull request #229 from dave-tucker/fix_cgroup_skb_attach_v2 ([`3dc9308`](https://github.com/vadorovsky/aya/commit/3dc9308c8e7c4a263ab7d1a064655516b5016071))
    - Merge pull request #224 from Tuetuopay/pod-arrays ([`02c376c`](https://github.com/vadorovsky/aya/commit/02c376ceb7ff2a1704b3804fd7ef76d107bb0a6f))
    - Merge pull request #238 from vadorovsky/fix-doc-set-global ([`5269ab5`](https://github.com/vadorovsky/aya/commit/5269ab5b1cb2fc023b8cc38dddda778787fb858f))
    - Improve documentation of set_global method ([`7dd2e3d`](https://github.com/vadorovsky/aya/commit/7dd2e3d1f87559636ba33a7bbb76e57f20d43e8e))
    - Merge pull request #237 from hi120ki/fix-typo-fentry ([`7fdf37a`](https://github.com/vadorovsky/aya/commit/7fdf37ad51e993acf8b4ca4f936a0cedbadfa84a))
    - Fix typo in aya/src/programs/fentry.rs ([`ab46253`](https://github.com/vadorovsky/aya/commit/ab462533c7da6509bdc67d396517bc8113e37e6c))
    - Fix unit test ([`5725a97`](https://github.com/vadorovsky/aya/commit/5725a97648ada61813d4aec7b16e111ea628f730))
    - Fix socket_filter section match ([`9e41317`](https://github.com/vadorovsky/aya/commit/9e41317ca6f2834d9050632552f913eda9725848))
    - Merge pull request #234 from xonatius/patch-1 ([`e0d818f`](https://github.com/vadorovsky/aya/commit/e0d818ff2da62b7311dd99269cd47131b564093f))
    - Fix typo in aya/README.md ([`49e998d`](https://github.com/vadorovsky/aya/commit/49e998dc7eb248b5fe31a03bc1ca4db7e736bac7))
    - Fix Loading from cgroup/skb sections ([`5ee1321`](https://github.com/vadorovsky/aya/commit/5ee13217652216a3a01c82dd7d8a79ea8502ca12))
    - Merge pull request #222 from aya-rs/dependabot/cargo/parking_lot-0.12.0 ([`00e34ec`](https://github.com/vadorovsky/aya/commit/00e34ec29c120e44ea0bf6879f5630c664116b5c))
    - Implement Pod for arrays of Pod types ([`08211f6`](https://github.com/vadorovsky/aya/commit/08211f6132fd93493267e853139f5f5724e093b0))
    - Update parking_lot requirement from 0.11.1 to 0.12.0 ([`ab7eed2`](https://github.com/vadorovsky/aya/commit/ab7eed2759d062fbe267e7e96f84c7a3f477ef11))
    - Merge pull request #161 from nimrodshn/add_lpm_trie ([`2a18239`](https://github.com/vadorovsky/aya/commit/2a1823934671ced3c910a2e6f287ba569bea9c60))
    - Fix #128: Add support for BPF_MAP_TYPE_LPM_TRIE map ([`c6e66d8`](https://github.com/vadorovsky/aya/commit/c6e66d8080c8ca50917ced2d3d86ba1fb2af6758))
    - Merge pull request #179 from dave-tucker/btf_datasec_name ([`6316748`](https://github.com/vadorovsky/aya/commit/6316748ec1a6c0f5673d12f2d7e48ff607ad6af8))
    - Merge pull request #177 from alessandrod/ptr-relocs ([`b2182c6`](https://github.com/vadorovsky/aya/commit/b2182c6c4ed343d9d1e8d3180adf93199806846a))
    - Fix func_info/line_info offsets ([`f169a3f`](https://github.com/vadorovsky/aya/commit/f169a3fc6bb203d2a41de449472c1115b49ffe15))
    - Relocate .text references ([`8202105`](https://github.com/vadorovsky/aya/commit/8202105b7dd415fc028050daada44a75d2ed7202))
    - Replace / in DATASEC before load to kernel ([`825bb3a`](https://github.com/vadorovsky/aya/commit/825bb3ad2044e186f873acbbb0a53de8d2b6e6cc))
    - Merge pull request #175 from dave-tucker/merge_fixup_sanitize ([`1904aea`](https://github.com/vadorovsky/aya/commit/1904aeaef9aa1a450b7d319fc9df7f5e52f06793))
    - Fix match arms ([`99fa85e`](https://github.com/vadorovsky/aya/commit/99fa85eab899c807c76274663240a19b4df41371))
    - Add a test for each BTF fix ([`326825a`](https://github.com/vadorovsky/aya/commit/326825aab0b54898d9eb2e5338d70c8c663ed0e3))
    - Fix borrow check errors ([`4efc206`](https://github.com/vadorovsky/aya/commit/4efc2061a8aa0c25cb648a86cdc39ca44784de94))
    - Merge Fixup and Sanitzation to single step ([`a1b46ec`](https://github.com/vadorovsky/aya/commit/a1b46ece05e73896250f86815c4ad6df6095797d))
    - Merge pull request #164 from dave-tucker/btf_verifier ([`06f8938`](https://github.com/vadorovsky/aya/commit/06f89388082274155519e620cc046feeba7aab00))
    - Fix BTF verifier output ([`5d8b279`](https://github.com/vadorovsky/aya/commit/5d8b279265bd2715b83cbed871697bbc763a00a9))
    - Merge pull request #173 from alessandrod/func-proto-fixup ([`d9496df`](https://github.com/vadorovsky/aya/commit/d9496df3a7d6762732a5dad943e9c8cdf82de25a))
    - Merge pull request #174 from alessandrod/func-global-fix ([`f70ab2c`](https://github.com/vadorovsky/aya/commit/f70ab2caa746fd1f07213d9d02eb649d3fb8f948))
    - Fix sanitization if BTF_FUNC_GLOBAL is not supported ([`7ad0524`](https://github.com/vadorovsky/aya/commit/7ad0524283006fce221910df4c1817af503b5b61))
    - Fixup func protos ([`9ba2e14`](https://github.com/vadorovsky/aya/commit/9ba2e147a1a82e97849cc8b7ca524550803ec3a9))
    - Run fixup in place ([`89b5dd3`](https://github.com/vadorovsky/aya/commit/89b5dd32ede08d3aeb5a07cf980f8af8ff326445))
    - Merge pull request #168 from dave-tucker/decl_tag ([`b45a160`](https://github.com/vadorovsky/aya/commit/b45a160bb0018529a006cfe6f58a73d671116a4c))
    - Merge pull request #172 from dave-tucker/name_trunc ([`b93188f`](https://github.com/vadorovsky/aya/commit/b93188fefebcdae19b7856d6009918386bf55e10))
    - Fix name truncation ([`8f9a32f`](https://github.com/vadorovsky/aya/commit/8f9a32ff10a13d414ff95edc2f5645a7a5162732))
    - Merge pull request #171 from dave-tucker/nametoolong ([`dccdc45`](https://github.com/vadorovsky/aya/commit/dccdc45ccd91452f511f18147cb84da8b9e6dd2b))
    - Truncate long program names ([`437432c`](https://github.com/vadorovsky/aya/commit/437432cdd60bbe11e7021f52297e459fd14ff069))
    - Add support for BTF_TYPE_KIND_{TAG,DECL_TAG} ([`5d9ff70`](https://github.com/vadorovsky/aya/commit/5d9ff70498785ea1becbc347c6798f76be11036f))
    - Merge pull request #169 from dave-tucker/fix_array_relo ([`1492d85`](https://github.com/vadorovsky/aya/commit/1492d85a7bad7749fc06fea32ceafdcd12d34107))
    - Merge pull request #157 from dave-tucker/doc-aya ([`6a91fdf`](https://github.com/vadorovsky/aya/commit/6a91fdf5a7f0bbce94e679a41d2f9b7f5fbaa41c))
    - Fix BTF type resolution for Arrays and Ints ([`686ce45`](https://github.com/vadorovsky/aya/commit/686ce45f930cef68f6fdfb73dc5ebc2d259d5954))
    - Merge pull request #167 from aya-rs/codegen ([`0118773`](https://github.com/vadorovsky/aya/commit/01187735f0c5ecdb3c632a5ed3b8508309ca0ee4))
    - Update libbpf to be89b28f96be426e30a2b0c5312d13b30ee518c7 ([`324c679`](https://github.com/vadorovsky/aya/commit/324c679a41ba7e5448092a0e5b1ca7e06adb78e2))
    - Maps: rename from_pinned() to open_pinned() ([`4e9bc32`](https://github.com/vadorovsky/aya/commit/4e9bc32a3dee903f8bfe71430c03b1c664607c5d))
    - Merge pull request #165 from dave-tucker/prog_pinned ([`f12054a`](https://github.com/vadorovsky/aya/commit/f12054a00dbd48e0aa66d818a818690769c4a10b))
    - Retrieve program from pinned path ([`abc8d27`](https://github.com/vadorovsky/aya/commit/abc8d27440de76cf5ed2ca4aa56883bc07d3afc4))
    - Merge pull request #163 from aya-rs/codegen ([`353b5f9`](https://github.com/vadorovsky/aya/commit/353b5f9cb170394b8a8742a3e6c65d4c086648e2))
    - Update libbpf to 22411acc4b2c846868fd570b2d9f3b016d2af2cb ([`0619f80`](https://github.com/vadorovsky/aya/commit/0619f8009085090c2afd0614701e74dd6fc669f5))
    - Merge pull request #158 from dave-tucker/btf-fix ([`001348a`](https://github.com/vadorovsky/aya/commit/001348a301372a08e62d274fb2ead5d110d1d79e))
    - Allocate func/line_info buffers outside if ([`83cfe56`](https://github.com/vadorovsky/aya/commit/83cfe56fe7690e752ebb646509bd282db227af2b))
    - Document the public api ([`bca0158`](https://github.com/vadorovsky/aya/commit/bca01580e722a20e5c6026a744c92c5423f6437b))
    - Merge pull request #127 from dave-tucker/ext ([`c5a10f8`](https://github.com/vadorovsky/aya/commit/c5a10f8fbe1c2b27651f9b11d077399612b8318f))
    - Add fixup for PTR types from Rust ([`877c760`](https://github.com/vadorovsky/aya/commit/877c76043a6d313391159523dc40046426800c43))
    - Add BPF_PROG_TYPE_EXT ([`5c6131a`](https://github.com/vadorovsky/aya/commit/5c6131afba02e22531fa82d8f40444311aeec5c9))
    - Add Btf::to_bytes ([`379bb31`](https://github.com/vadorovsky/aya/commit/379bb313b13dd259a26fe3513ae6784bb85291ef))
    - Merge pull request #146 from dave-tucker/ro-maps ([`faa3676`](https://github.com/vadorovsky/aya/commit/faa36763f78d3190492508ce9ed40d98eca81750))
    - Mark .rodata maps as readonly and freeze on load ([`65a0b83`](https://github.com/vadorovsky/aya/commit/65a0b832057a007f8a64eb5c2e3de712e502d634))
    - Merge pull request #145 from aya-rs/codegen ([`3a4c84f`](https://github.com/vadorovsky/aya/commit/3a4c84fe17f0f308c618788da9a88269ab10560f))
    - Fix for rename of BPF_ -> BPF_CORE_ ([`2b7dda7`](https://github.com/vadorovsky/aya/commit/2b7dda766f3b002fc96915366d560c0a279106e3))
    - Update libbpf to 19656636a9b9a2de1f71fa3135709295c16701cc ([`05d4bc3`](https://github.com/vadorovsky/aya/commit/05d4bc39ea4dd6897aa6685cec37e57e0f039577))
    - Support for fentry and fexit programs ([`7e2fcd1`](https://github.com/vadorovsky/aya/commit/7e2fcd1d6d86af4c818f2140e23061154430f33f))
    - Update object requirement from 0.27 to 0.28 ([`54b0c67`](https://github.com/vadorovsky/aya/commit/54b0c677958b07fb2a8ece28fd55251b74dcebc8))
    - Merge pull request #136 from nimrodshn/add_impl_pod_for_u128 ([`6313ddf`](https://github.com/vadorovsky/aya/commit/6313ddfe0cae7d7581a473a3f942856e3e2e4fc9))
    - Implement Pod for u128 ([`24a292f`](https://github.com/vadorovsky/aya/commit/24a292f605220c4df11e54c93c76819b3dd42909))
    - Merge pull request #134 from aya-rs/codegen ([`f34b76c`](https://github.com/vadorovsky/aya/commit/f34b76c8d3bc55c3671252bb54e3d4d64ba21ddd))
    - Update libbpf to 93e89b34740c509406e948c78a404dd2fba67b8b ([`17d43cd`](https://github.com/vadorovsky/aya/commit/17d43cd6f8b7894ef3741bbb2b51f726a879e2b2))
    - Merge pull request #125 from dave-tucker/btf ([`26d188c`](https://github.com/vadorovsky/aya/commit/26d188c659e905d4121bc97a574f961172593889))
    - Merge pull request #131 from eero-thia/thia/safe_iter ([`441a660`](https://github.com/vadorovsky/aya/commit/441a660b3e6b540de82377c46f4d6f2709b7462c))
    - Remove unnecessary unsafe markers on map iteration. ([`1897036`](https://github.com/vadorovsky/aya/commit/18970369e27228c45117b125724a22d8999ec1fc))
    - Merge pull request #120 from eero-thia/thia/dedup ([`07a6016`](https://github.com/vadorovsky/aya/commit/07a6016ebb370bc3d37c2865ed65bd0028f1eeb2))
    - Eliminate name duplication in maps and programs. ([`f56dd0a`](https://github.com/vadorovsky/aya/commit/f56dd0a70b36a97036eb9447efa20f0e1c93c8d7))
    - Merge pull request #130 from wg/main ([`a340c2a`](https://github.com/vadorovsky/aya/commit/a340c2a9fa1a01a237d1c0bb2f53c463c8719470))
    - Use correct program name when relocating ([`bb8a813`](https://github.com/vadorovsky/aya/commit/bb8a813eefd86fbdb218174ccb7bfd2578ab9692))
    - Improve section detection ([`e4d9774`](https://github.com/vadorovsky/aya/commit/e4d9774bf780eee5c3740d153df0682265089307))
    - Merge pull request #115 from eero-thia/thia/impl_trait ([`a03426f`](https://github.com/vadorovsky/aya/commit/a03426f1947ce82227431392d20a905a1347bcd8))
    - Remove unnecessary usage of &dyn trait in favor of impl trait. ([`daa7ea6`](https://github.com/vadorovsky/aya/commit/daa7ea6d0dad1895768d3a1cdc62911b15c72a94))
    - Merge pull request #116 from eero-thia/thia/close ([`98b36b2`](https://github.com/vadorovsky/aya/commit/98b36b23bc7b52fae4dce98b905be52adf12167f))
    - Merge pull request #121 from eero-thia/thia/programs_mut ([`2955ca1`](https://github.com/vadorovsky/aya/commit/2955ca1d1f350a0fc266410c464dbefcb6a42e2f))
    - Programs_mut iterator to complement programs. ([`c7f8db9`](https://github.com/vadorovsky/aya/commit/c7f8db9a0b4e632233561fdd075cf201ae7cccb5))
    - Merge pull request #122 from eero-thia/thia/include_bytes_aligned ([`a6bf554`](https://github.com/vadorovsky/aya/commit/a6bf554a74bf7a82bae9d97050505a03b241ef61))
    - Close file descriptors on Map drop. ([`1584bc4`](https://github.com/vadorovsky/aya/commit/1584bc47bd027455b07e456683c0fb97920a5314))
    - Expand include_bytes_aligned to accept expressions. ([`f8f17a0`](https://github.com/vadorovsky/aya/commit/f8f17a09fbf1b87d14735e015c55d387a6ed048b))
    - Merge pull request #108 from deverton/kprobe-debugfs ([`6db30fa`](https://github.com/vadorovsky/aya/commit/6db30fad9ca8151abe51d1ccfafc3e90f9fd4adc))
    - Refactoring after feedback. ([`0e84610`](https://github.com/vadorovsky/aya/commit/0e84610976c3148e1912f337e1589104373f0a96))
    - Support pid filtering in debugfs ([`606c326`](https://github.com/vadorovsky/aya/commit/606c3267c42a1a3b7e20dba193bb6fbcbc114105))
    - Handle probe entry offsets ([`1dc7554`](https://github.com/vadorovsky/aya/commit/1dc75542b4f500d43c158f1bc4dc4db142c612f2))
    - Merge branch 'main' into kprobe-debugfs ([`4e6aeb2`](https://github.com/vadorovsky/aya/commit/4e6aeb2e6959a4872f55283e1968053dfa5e02e8))
    - Merge pull request #109 from deverton/dynamic-kver ([`b82d7f0`](https://github.com/vadorovsky/aya/commit/b82d7f0515a8d7ffab1f61edd5d843b7f6b2dccc))
    - Updates based on feedback ([`3dff6e8`](https://github.com/vadorovsky/aya/commit/3dff6e855521a3bdbf11f6d4da98d1ea5d7536a3))
    - Use current kernel version as default if not specified ([`4277205`](https://github.com/vadorovsky/aya/commit/4277205e9d4f6a28a1f38aa8a990bdd97e683af1))
    - Functional detach of debugfs probes. ([`42c9737`](https://github.com/vadorovsky/aya/commit/42c9737d47f35f4b6f9d7e65be590d53a7c69e35))
    - Fix event_alias comparison when looking in event list ([`a4faabc`](https://github.com/vadorovsky/aya/commit/a4faabcf93400ae0ee85c49b92ed6343dae3aee8))
    - Don't duplicate perf_attach code and formatting ([`84fa219`](https://github.com/vadorovsky/aya/commit/84fa2197ec42305fb5366995b28fb720bc819041))
    - Attempt auto detach of probe for debugfs ([`d0321bd`](https://github.com/vadorovsky/aya/commit/d0321bd1ee92ce7157ce948eebe54845b447c378))
    - Support k/uprobes on older kernels. ([`34aa790`](https://github.com/vadorovsky/aya/commit/34aa790a917512783fa50c60527b2e694fb93ce3))
    - Merge pull request #107 from deverton/skip-map-name ([`5b0e518`](https://github.com/vadorovsky/aya/commit/5b0e5186414749c6e135aa6c1ceb7d67259fc4a1))
    - Formatting ([`07e3824`](https://github.com/vadorovsky/aya/commit/07e3824aa4972fee73bbb0c9e3b96a417615aafb))
    - Stub `kernel_version` for tests ([`49f6a8e`](https://github.com/vadorovsky/aya/commit/49f6a8e81949e127559d7f5698abe19fca4be853))
    - Fix lint issues ([`d966881`](https://github.com/vadorovsky/aya/commit/d966881e46ce191bb29d624fed9c740f3078567e))
    - Make maps compatible with kernel <= 4.14 ([`fc08611`](https://github.com/vadorovsky/aya/commit/fc0861105a632deb15b17855160e0b375d7c5305))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.10.6 ([`182182d`](https://github.com/vadorovsky/aya/commit/182182d8404fefaf9b34f432c4b06c14ef4f78f8))
    - Merge pull request #104 from dave-tucker/fix_skskb_load ([`daf8630`](https://github.com/vadorovsky/aya/commit/daf863013360c834428bef8ecbe82b9f71dd023e))
    - Fix name parsing for sk_skb sections ([`352e54b`](https://github.com/vadorovsky/aya/commit/352e54b72405b5e9f21a947ff0146f3ba162b78a))
    - Merge pull request #98 from aya-rs/codegen ([`f632f81`](https://github.com/vadorovsky/aya/commit/f632f81db152fd1185047550ec819926a83b0eae))
    - Update libbpf to 16dfb4ffe4aed03fafc00e0557b1ce1310a09731 ([`4a7f47d`](https://github.com/vadorovsky/aya/commit/4a7f47d93a4e392072df06c8c2f3bbb9aaee6df7))
    - Merge pull request #94 from tklauser/netlink-ext-ack-libc ([`563d4ba`](https://github.com/vadorovsky/aya/commit/563d4ba1c38a420e408ae17df9c73acd5d244eb3))
    - Netlink: use NETLINK_EXT_ACK from libc crate ([`2136f05`](https://github.com/vadorovsky/aya/commit/2136f0546161adb55947c1a3ad002b236106b737))
    - Merge pull request #90 from willfindlay/fix-bss ([`dd7e1de`](https://github.com/vadorovsky/aya/commit/dd7e1de348fc14e6e1e40e6498ccc5488f8b1456))
    - Fix incorrect section size for .bss ([`1e6b1af`](https://github.com/vadorovsky/aya/commit/1e6b1afbe42b191f18bef28e9dc3adff9c739eae))
    - Merge pull request #89 from willfindlay/errors ([`3a8e4fe`](https://github.com/vadorovsky/aya/commit/3a8e4fe9b91538a0fafd8c91ae96185c1a017651))
    - Improve map errors to be more descriptive ([`27d803b`](https://github.com/vadorovsky/aya/commit/27d803b634d3f540fa36163c6f6eb146ffdb7e27))
    - Merge pull request #85 from willfindlay/tp_btf ([`17b730c`](https://github.com/vadorovsky/aya/commit/17b730c717b3696196b3a7c1562991f880d921a0))
    - Pass Btf by reference instead of loading new Btf in Lsm::load ([`6b6d4af`](https://github.com/vadorovsky/aya/commit/6b6d4af932a31632e8b1ee0a23be4ec6636194fb))
    - Implement btf tracepoint programs ([`6539cbb`](https://github.com/vadorovsky/aya/commit/6539cbb555fc7e597c814f56b3ef8bacd2bcd895))
    - Merge pull request #68 from vadorovsky/lsm ([`140005d`](https://github.com/vadorovsky/aya/commit/140005d9e30818e86bc27ff79767075d0cca62ff))
    - Add support for raw tracepoint and LSM programs ([`169478c`](https://github.com/vadorovsky/aya/commit/169478c863adea838ef9a73a8b3323b4815b4ee2))
    - Merge pull request #78 from willfindlay/main ([`56fd09c`](https://github.com/vadorovsky/aya/commit/56fd09c443e1d1e00ffba18497d786b71a6b5292))
    - Fix include_bytes_aligned! macro to work in some corner cases ([`99f6f9e`](https://github.com/vadorovsky/aya/commit/99f6f9e14d4cdcdd53b3df3cf107d041e662ea06))
    - Merge pull request #76 from willfindlay/load_include_bytes ([`a947747`](https://github.com/vadorovsky/aya/commit/a94774755f3198d972d5ddd5225beef614b2fc5d))
    - Introduce include_bytes_aligned!() macro ([`4df4e9c`](https://github.com/vadorovsky/aya/commit/4df4e9c14eb1019a8c2299c48b15420ee7f20855))
    - Bump libbpf to 92c1e61a605410b16d6330fdd4a7a4e03add86d4 ([`03e9935`](https://github.com/vadorovsky/aya/commit/03e993535827aa4b654ca489726da3cc6b275408))
    - Update object requirement from 0.26 to 0.27 ([`c99dcfb`](https://github.com/vadorovsky/aya/commit/c99dcfb9d33ba762ed005ac6d53a2290901a83d7))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.10.5 ([`4152e8b`](https://github.com/vadorovsky/aya/commit/4152e8b1a43f24d005870cb68a0ef3dbd76169c7))
    - Fix call relocation bug ([`59a1854`](https://github.com/vadorovsky/aya/commit/59a1854a6bd74845e3c45227ade757399a376897))
    - Disable Stacked Borrows and skip some tests ([`dc4b928`](https://github.com/vadorovsky/aya/commit/dc4b928ec5a1a40fa19af5a4f8f5141fa7f91425))
    - Fix clippy ([`52c5189`](https://github.com/vadorovsky/aya/commit/52c51895ba1fdcd2ee627e7b7d3d8bb4622c2a1d))
    - Improve docs a bit and make BpfLoader default to loading BTF if available ([`64e3fb4`](https://github.com/vadorovsky/aya/commit/64e3fb4cc82eb944327a4decc46c66d85305a564))
    - Loader: take BTF info as reference ([`5f8f18e`](https://github.com/vadorovsky/aya/commit/5f8f18e3a1b13b2452294d6c8a33dde961fa511c))
    - Implement Pinning For Programs and Maps ([`9426f36`](https://github.com/vadorovsky/aya/commit/9426f36f79101e296ec3ffc4bbef8913a1130eff))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.10.4 ([`a7f5b37`](https://github.com/vadorovsky/aya/commit/a7f5b3775d27c89e226c49c4a2f21d0e90b08591))
    - Bump obj to 0.26 ([`a10a7b3`](https://github.com/vadorovsky/aya/commit/a10a7b3bf2a7719e2c08c7474b7b89b1f5b4a35a))
    - Minor PerfEvent API tweaks ([`98361a4`](https://github.com/vadorovsky/aya/commit/98361a4c931cbfe5190da64d3efc70547219a877))
    - Run xtask codegen aya ([`b0a05e7`](https://github.com/vadorovsky/aya/commit/b0a05e759e49a164eead2990d93c793ca494f7c6))
    - Add support for PerfEvent programs. ([`c39dff6`](https://github.com/vadorovsky/aya/commit/c39dff602530b757367f93099a867a4307a7d519))
    - Only consider Text symbols as relocatable functions ([`c56a6b1`](https://github.com/vadorovsky/aya/commit/c56a6b16aa3fdafeb531c280c7a5d8dae7a4612a))
    - Fix bug with nested call relocations ([`d9fc0f4`](https://github.com/vadorovsky/aya/commit/d9fc0f484ffbe17a5a8b8e7b697ee9de4d46ff65))
    - Make Clippy Happy ([`e9bad0b`](https://github.com/vadorovsky/aya/commit/e9bad0b61d95afb3ffc119be7a6fd9a109758a7b))
    - Update authors and repository link ([`9c27910`](https://github.com/vadorovsky/aya/commit/9c27910f76d7152091973dfe99c37ae448c25541))
    - Remove docs. Update URLs to aya-rs ([`8acb92d`](https://github.com/vadorovsky/aya/commit/8acb92d61cd21ebaaf7a529b977947ef7e10abfc))
    - Fix size of Unknown variant ([`4e1ce25`](https://github.com/vadorovsky/aya/commit/4e1ce2534c23a51a67cd3e56fe389e207bdcf3b3))
    - Add some tests for reading btf data ([`569b8ca`](https://github.com/vadorovsky/aya/commit/569b8ca39ed0aac5b814f86d6f54ed44dc6295c4))
    - Add bindings for BTF_KIND_FLOAT ([`753a683`](https://github.com/vadorovsky/aya/commit/753a683704f685582da37b0290a66cf37e1092d7))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 3 unique issues were worked on: [#18](https://github.com/vadorovsky/aya/issues/18), [#31](https://github.com/vadorovsky/aya/issues/31), [#32](https://github.com/vadorovsky/aya/issues/32)
 ...
 * **[#18](https://github.com/vadorovsky/aya/issues/18)**
    - Add minimum kernel version for each map and program type ([`35f15f7`](https://github.com/vadorovsky/aya/commit/35f15f70e0d83f5e19153c9d2917add10c154d1e))
 * **[#31](https://github.com/vadorovsky/aya/issues/31)**
    - Pass BTF object by reference in order to allow multiple eBPF programs to share it and save memory (closes #30). ([`b4b019e`](https://github.com/vadorovsky/aya/commit/b4b019e447c9829a0405b0fd40f1f2f66652db8f))
 * **[#32](https://github.com/vadorovsky/aya/issues/32)**
    - Implement query for lirc programs ([`81e07e9`](https://github.com/vadorovsky/aya/commit/81e07e96611652b1b1ec4bb9121732862692cf2d))
 * **Uncategorized**
    - (cargo-release) version 0.10.3 ([`f30abca`](https://github.com/vadorovsky/aya/commit/f30abca15e77ea841643f31a4bab0c30113dcda4))
    - Programs: tweak LircMode2::query doc. ([`66a12ff`](https://github.com/vadorovsky/aya/commit/66a12ffcf70b2702a9eee7f89cabe64aa9c46126))
    - Netlink: fix clippy lint ([`8c03ba0`](https://github.com/vadorovsky/aya/commit/8c03ba052a168d390c9d997f4bbf32d610864042))
    - Fix clippy warnings ([`fa2cbe2`](https://github.com/vadorovsky/aya/commit/fa2cbe2f825cc0c257e983793af58aa63aea6287))
    - Tc: add qdisc_detach_program ([`c2a90c2`](https://github.com/vadorovsky/aya/commit/c2a90c2c010e69508c5704542f1133d82f793aa0))
    - Netlink: fix alignment when writing attributes ([`0a9d021`](https://github.com/vadorovsky/aya/commit/0a9d02140acdaa35c5f5c7e17ea08a6823922e20))
    - Netlink: fix handling of multipart messages ([`abb199e`](https://github.com/vadorovsky/aya/commit/abb199e6f436b67485ed77211daca3e990ca6c0d))
    - Tc: clean up netlink code a bit ([`9185f32`](https://github.com/vadorovsky/aya/commit/9185f32f6f7bb33c160ded526e7122462fef77dd))
    - Fix formatting ([`d996a88`](https://github.com/vadorovsky/aya/commit/d996a88de47d60053504695036a14157ce6b3aa6))
    - Fix clippy warnings ([`0878c45`](https://github.com/vadorovsky/aya/commit/0878c4505a95931c745b6b0bdbcb5413579acd85))
    - Obj: improve parse_map_def tests ([`21e01df`](https://github.com/vadorovsky/aya/commit/21e01df242376d4a9d4f67664277263f0dc8d173))
    - Don't error out parsing padded map sections ([`b657930`](https://github.com/vadorovsky/aya/commit/b657930a3ee61f88ada0630afdac6b1c77459244))
    - Added support for armv7-unknown-linux-gnueabi and armv7-unknown-linux-gnueabihf ([`8311abf`](https://github.com/vadorovsky/aya/commit/8311abfdcbbe70da6abdd67b78b831d53998aad5))
    - Tc: make qdisc_add_clsact return io::Error ([`9c8e78b`](https://github.com/vadorovsky/aya/commit/9c8e78b7d4192b376ec2e532d9ddcf81c3c5182e))
    - Aya, aya-bpf-bindings: regenerate bindings ([`122a530`](https://github.com/vadorovsky/aya/commit/122a5306e72c7560629bcef160e7f676b84eabd7))
    - Kprobe: remove pid argument ([`08c71df`](https://github.com/vadorovsky/aya/commit/08c71dfeb19b2b4358d75baf5b95f8d4e6521935))
    - Add missing load() in kprobe example ([`bb15e82`](https://github.com/vadorovsky/aya/commit/bb15e82c1d8373700dda52f69d6c4bf6f5489a03))
    - Support both bpf_map_def layout variants ([`d8d3117`](https://github.com/vadorovsky/aya/commit/d8d311738c974f3b6fad22006ab2b827d0925ce8))
    - Netlink: tc: use ptr::read_unaligned instead of deferencing a potentially unaligned ptr ([`5f0ff16`](https://github.com/vadorovsky/aya/commit/5f0ff1698a12141ffe50e160de252f664773c140))
    - Netlink: port TC code to using new nlattr utils ([`7f2ceaf`](https://github.com/vadorovsky/aya/commit/7f2ceaf12e3aeadd81a55a75c268f254192cf866))
    - Netlink: refactor nlattr writing code ([`d9b5ab5`](https://github.com/vadorovsky/aya/commit/d9b5ab575f6e2cbca793881094e1846a39332fa1))
    - Netlink: introduce NestedAttrs builder and switch XDP to it ([`c240a2c`](https://github.com/vadorovsky/aya/commit/c240a2c73381a6864f343c79069abfd5f9e9b729))
    - Refactor program section parsing ([`bb595c4`](https://github.com/vadorovsky/aya/commit/bb595c4e69ff0c72c8327e7f64d43ca7a4bc16a3))
    - Fix tracepoint prefix in a couple more places ([`0188622`](https://github.com/vadorovsky/aya/commit/018862258064a39f5613ecc81c1e257bea2c4e74))
    - Fix trace point section name ([`a0151dd`](https://github.com/vadorovsky/aya/commit/a0151dd48520ac801042da3c26bf4739b549d1b1))
    - Merge pull request #4 from seanyoung/doctest ([`521ef09`](https://github.com/vadorovsky/aya/commit/521ef09463278588004bcec8dcd22d4f8caeb1ab))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.10.2 ([`d70e291`](https://github.com/vadorovsky/aya/commit/d70e29158037a083d5886d30d2029bd054974af5))
    - Tc: fix QdiscRequest layout ([`fee71b4`](https://github.com/vadorovsky/aya/commit/fee71b42f16e4d1f683e94f64b038f6e8b2f4f0a))
    - Fix doctest and run them during CI ([`1196ba1`](https://github.com/vadorovsky/aya/commit/1196ba1dccebfb0953d0e4d5244f81612600fdb0))
    - Merge pull request #3 from seanyoung/lirc ([`59cfbc5`](https://github.com/vadorovsky/aya/commit/59cfbc51c824d576ae9c0ea0815ad44d40107ac4))
    - Add support for lirc programs ([`b49ba69`](https://github.com/vadorovsky/aya/commit/b49ba69d09576a4dd34fbc703a938acd50cb6e7a))
</details>
 ...
 * **Uncategorized**
    - (cargo-release) version 0.10.1 ([`304abfb`](https://github.com/vadorovsky/aya/commit/304abfbfeb05058be40a8832d5f7682f46a81fa0))
    - Merge pull request #1 from aquarhead/fix-load-file ([`cdc7374`](https://github.com/vadorovsky/aya/commit/cdc737490df927b131de5b5868eeb43c6ecaa58a))
    - Fix Bpf::load_file when BTF doesn't exist ([`f1fc304`](https://github.com/vadorovsky/aya/commit/f1fc30411d7d0b65b52a7e9312c8fd20340bd2d2))
</details>
 ...
 * **Uncategorized**
    - Copy readme into aya/ ([`94b5e2e`](https://github.com/vadorovsky/aya/commit/94b5e2e4e6a535ca74113c5f62c4bd1a7f265469))
    - Add more fields to Cargo.toml ([`7694bac`](https://github.com/vadorovsky/aya/commit/7694bacf04f5ba3cf58b4e432ff746ce2987d67d))
    - Doc fixes ([`be0b7bb`](https://github.com/vadorovsky/aya/commit/be0b7bbd832a0321018c78b0c008a4280bd1da6e))
    - Bump version to 0.10 ([`9f7b017`](https://github.com/vadorovsky/aya/commit/9f7b017d5d4a4eb63c98c258e3b382628e711253))
    - Add doc aliases for maps and programs ([`768640d`](https://github.com/vadorovsky/aya/commit/768640dd4696eaf8c76d7a8b15ab195b3979b281))
    - More docs ([`293e66a`](https://github.com/vadorovsky/aya/commit/293e66af65566942b424bbc0c9e5a2cd1be69599))
    - Refactor tc code a bit and add docs ([`ad58e17`](https://github.com/vadorovsky/aya/commit/ad58e171ff1645d02998b399db6535a226b5a5ec))
    - More docs ([`11e21e8`](https://github.com/vadorovsky/aya/commit/11e21e83bedc8de2b7290d5546b36f47a981266a))
    - More doc fixes ([`6c7df27`](https://github.com/vadorovsky/aya/commit/6c7df27bd03e658ebe7855d865377c2cc6e57e52))
    - Improve async perf map docs ([`28158e6`](https://github.com/vadorovsky/aya/commit/28158e6028b12efad61d159c3b505d58a03bfd8a))
    - Tweak PerfEventArray docs ([`6ecf7da`](https://github.com/vadorovsky/aya/commit/6ecf7dabf35f22869a95a8cd176b6f217ee57b05))
    - ProgramArray: more doc fixes ([`6772595`](https://github.com/vadorovsky/aya/commit/6772595f3ea2d0178e02efc97a2fe2a789a04b24))
    - ProgramArray: tweak docs ([`4bde0c5`](https://github.com/vadorovsky/aya/commit/4bde0c54bdcf6f749f6b6034874cf1bfecb0b08f))
    - Implement ProgramFd for CgroupSkb ([`2cda5db`](https://github.com/vadorovsky/aya/commit/2cda5dbbe74e5d41ce7e2c895678b853d2867001))
    - Fix CgroupSkb docs ([`2d7b9b2`](https://github.com/vadorovsky/aya/commit/2d7b9b2e904e2435527d6640e631195ffbd7e050))
    - Programs: add support for BPF_PROG_TYPE_CGROUP_SKB programs ([`08a68fa`](https://github.com/vadorovsky/aya/commit/08a68faf8a8baa344dd6fee64529ad2dcc0a0846))
    - Programs: fix detaching programs attached with bpf_prog_attach ([`fb3e2f7`](https://github.com/vadorovsky/aya/commit/fb3e2f7f9d06b22c7fe44eccefc2ce94ad322ed0))
    - Programs: fix syscall name in errors ([`6658025`](https://github.com/vadorovsky/aya/commit/665802594c2181ae890b3655867944a3fef11508))
    - Handle reordered functions ([`81a0b61`](https://github.com/vadorovsky/aya/commit/81a0b61164079ca276d23e0f31f2853087650198))
    - Improve call relocation error messages ([`b92b1e1`](https://github.com/vadorovsky/aya/commit/b92b1e18a97135684907d238578146f7aabacc84))
    - BpfError: set the #[source] attribute for RelocationErrors ([`20b2d4c`](https://github.com/vadorovsky/aya/commit/20b2d4c77dbc1597f68e6ae16a55d129e42b5c5d))
    - Add support for attaching and detaching TC programs ([`6974d34`](https://github.com/vadorovsky/aya/commit/6974d349e8f86c98f450122788efeedecbf61970))
    - Add support for Stack and Queue maps ([`31f8d71`](https://github.com/vadorovsky/aya/commit/31f8d71604f4eddd7981cd72e1deb01d2076f7f4))
    - Add id and pinning fields to bpf_map_def ([`40b7da6`](https://github.com/vadorovsky/aya/commit/40b7da6655aca6aed5dfe72a0db80bf0e67c2ce1))
    - Netlink: improve error messages ([`dc4e020`](https://github.com/vadorovsky/aya/commit/dc4e020f29acc544bb49a74bbad4c553f370d0f3))
    - Add support for BPF_PROG_TYPE_SCHED_CLS programs ([`5effc97`](https://github.com/vadorovsky/aya/commit/5effc972ac04960d0346e1f5504b595a206fc019))
    - Perf_map: fix bug when max_entries=0 ([`4222b14`](https://github.com/vadorovsky/aya/commit/4222b140ec594e99e77cda8539b16f21820ae155))
    - Update generated bindings ([`3b7ffd0`](https://github.com/vadorovsky/aya/commit/3b7ffd0048a5250ca160f8a7b584bf0ea73eb249))
    - Xdp: fix detaching on kernels older than 5.7 ([`30d2b25`](https://github.com/vadorovsky/aya/commit/30d2b25f1173904b2542a25792d7dff5b97b837f))
    - Xdp: set flags when attaching with netlink ([`607cf68`](https://github.com/vadorovsky/aya/commit/607cf68a692be60eb9f44d26352c513ea6295456))
    - Fix BpfError display strings ([`bb7728a`](https://github.com/vadorovsky/aya/commit/bb7728a2c5905923534e51bd53d8d5720f7319e1))
    - Fix warnings ([`9e12c93`](https://github.com/vadorovsky/aya/commit/9e12c9324c623bf751053ff874bc47055343753e))
    - Programs: rework load_program() retry code a bit ([`9a24f20`](https://github.com/vadorovsky/aya/commit/9a24f20e6f85d9ff2e438dddb3530b88e9583851))
    - Programs: add support for SkMsg programs ([`1441754`](https://github.com/vadorovsky/aya/commit/144175434f5b07ac7379be6e30a4b613c225f21b))
    - Maps: add SockHash ([`dad300c`](https://github.com/vadorovsky/aya/commit/dad300c88bdfade10f8318fcbbe9a8b5e4de89ce))
    - Add support for SockOps programs ([`ca4b3bf`](https://github.com/vadorovsky/aya/commit/ca4b3bfc0462b445f2aae56f9d4c2a80581eda39))
    - Add support BPF_PROG_TYPE_SK_SKB programs and SockMaps ([`b57cace`](https://github.com/vadorovsky/aya/commit/b57cace941333910891462127ce0199ae01c3c7c))
    - Fix program array key size ([`b6cd813`](https://github.com/vadorovsky/aya/commit/b6cd813af5fbd290a1f2e80b08c170ab868dfb3f))
    - Small doc fixes ([`0b3e532`](https://github.com/vadorovsky/aya/commit/0b3e532d7a4a8fe575b41f64d94cfedab10c36ea))
    - More docs ([`79f1b38`](https://github.com/vadorovsky/aya/commit/79f1b385a5366cc6f9a6a84172ab131850028a87))
    - Consolidate errors into ProgramError::SyscallError ([`683a58e`](https://github.com/vadorovsky/aya/commit/683a58ea6dfaeb65d00ea3cf63b215cd82fd3d5a))
    - Split aya::programs::probe into ::kprobe and ::uprobe & add docs ([`ae863bc`](https://github.com/vadorovsky/aya/commit/ae863bc663bde69eb71d5c1ec265b0d4c205f7ff))
    - Add maps::StackTraceMap ([`d9634ae`](https://github.com/vadorovsky/aya/commit/d9634ae945ba09bedfc10c748e4e35a6ca3bfde8))
    - Add util::kernel_symbols() ([`67c9cc0`](https://github.com/vadorovsky/aya/commit/67c9cc03597e6f00bb6917a493cd9bb405a05b4d))
    - Add bpf_map_lookup_elem_ptr ([`2cdb10e`](https://github.com/vadorovsky/aya/commit/2cdb10e7f2734d85bd8ab115a081f4d1a8b2e2ed))
    - Tweak docs ([`ad6d059`](https://github.com/vadorovsky/aya/commit/ad6d0596ab076aac84c12425ab493e6b6f24477d))
    - Rename ProgramArray::unset to ProgramArray::clear_index ([`f464279`](https://github.com/vadorovsky/aya/commit/f4642797408d31c8375562ead9f4480e8579f59d))
    - Rename ProgramArray::keys to ProgramArray::indices ([`9ad2a5e`](https://github.com/vadorovsky/aya/commit/9ad2a5e72d269724953f0f311e803a88637af2ee))
    - Maps: add PerCpuArray ([`b0364f7`](https://github.com/vadorovsky/aya/commit/b0364f76aba500464470628f719b5ca7aab4b36a))
    - Rework IterableMap and ProgramArray ([`74d5f17`](https://github.com/vadorovsky/aya/commit/74d5f17559036c2eb42d4679ff98fe2ab7e76d4f))
    - PerCpuKernelMem doesn't need to be public ([`aa3a30d`](https://github.com/vadorovsky/aya/commit/aa3a30d1965d96f3b6fc345be763561e6270f2ae))
    - Add aya::maps::Array ([`1746bbf`](https://github.com/vadorovsky/aya/commit/1746bbf5b83a5b392f39eefe02fc3731db77d893))
    - Add aya::maps::array and move ProgramArray under it ([`c3b9021`](https://github.com/vadorovsky/aya/commit/c3b902137becc48b72091ba59a9a4e297ba56d33))
    - Hash_map: add doc aliases for HASH and LRU_HASH ([`6cec8be`](https://github.com/vadorovsky/aya/commit/6cec8be564a590717e9af7eb007f3f5d10ffff0e))
    - Per_cpu_hash_map: add support for BPF_MAP_TYPE_LRU_PERCPU_HASH ([`7a989b4`](https://github.com/vadorovsky/aya/commit/7a989b43b9ee5b4807f53001c2d7d8824a162a34))
    - Maps: introduce MapError::KeyNotFound ([`635dcd4`](https://github.com/vadorovsky/aya/commit/635dcd44b9135dd75d958909f76da28676e6efe7))
    - Rename MapError::NotFound to MapError::MapNotFound ([`fd142e4`](https://github.com/vadorovsky/aya/commit/fd142e467c32b6aa4b0d2e8d62816a63c1fa4220))
    - Add PerCpuHashMap ([`3a5b289`](https://github.com/vadorovsky/aya/commit/3a5b28916385b35824bc2a05606808e5e8c1968a))
    - Move hash_map.rs to hash_map/hash_map.rs ([`d5098c9`](https://github.com/vadorovsky/aya/commit/d5098c9e575b7d5447506648ebeae146192eeda1))
    - Hash_map: factor out common hash code ([`6a12a48`](https://github.com/vadorovsky/aya/commit/6a12a48f0360456452c34737c5d52cd289ce23e8))
    - Fix warnings ([`ac83273`](https://github.com/vadorovsky/aya/commit/ac83273da86c5d10100f58563a9d764a79183367))
    - Don't export VerifierLog ([`46e0a2e`](https://github.com/vadorovsky/aya/commit/46e0a2ede4e423e620acd55f3ed4f755aa8c8b38))
    - HashMap: add support for LRU maps ([`7c6ae76`](https://github.com/vadorovsky/aya/commit/7c6ae769756a9605f7823e36243b69a3a88a1370))
    - More docs ([`04fde46`](https://github.com/vadorovsky/aya/commit/04fde468556ace883009b4abe63840aa7b89f29f))
    - Tweak docs ([`eea27f5`](https://github.com/vadorovsky/aya/commit/eea27f52f3d6455d97838e833b36f6c846c99cb7))
    - Rename perf map and add docs ([`5aa9cb1`](https://github.com/vadorovsky/aya/commit/5aa9cb12ade0014d64582864e66bbeae593f6edc))
    - Maps: add docs and make the hash_map and program_array modules public ([`d94bfde`](https://github.com/vadorovsky/aya/commit/d94bfde29521fa6fc1d661d1976d4800dd10b1d8))
    - Add HashMap docs ([`ce3f83a`](https://github.com/vadorovsky/aya/commit/ce3f83acb11388f2c0b07a8b1de95c7df22b97f9))
    - Make HashMap::new private ([`e28da88`](https://github.com/vadorovsky/aya/commit/e28da8812ed5d9e76e764fbc28312e8588aff2af))
    - Add ProgramArray docs ([`24f7c37`](https://github.com/vadorovsky/aya/commit/24f7c37158ede0217354d8c6305904737980f292))
    - Make ProgramArray::new private ([`3fddc81`](https://github.com/vadorovsky/aya/commit/3fddc8165c6e2c28c4fda19e72156b640da4a0c7))
    - Remove pop() ([`6682a5f`](https://github.com/vadorovsky/aya/commit/6682a5ff395d8fbea20393ff81140adcfc2a0c09))
    - Add some docs for the crate and `Bpf` ([`1bbbf61`](https://github.com/vadorovsky/aya/commit/1bbbf616b6bedef4a6d42cd630ecd7e3b9366dc5))
    - Maps: group syscall errors into MapError::SyscallError ([`563ce46`](https://github.com/vadorovsky/aya/commit/563ce46118258805892bdff97f0e57b2838e0de8))
    - Fix bindings for PERF_EVENT_IOC_{ENABLE|DISABLE|SET_BPF} ([`f9554d6`](https://github.com/vadorovsky/aya/commit/f9554d6db5c1fe3c906c798bc9b2a9c28fb0db7b))
    - Remove TryInto magic from program()/program_mut() too ([`a92bfeb`](https://github.com/vadorovsky/aya/commit/a92bfebf50df2c56bca242c6a9c3dedd04135675))
    - Remove TryInto cleverness from map() and map_mut() ([`42e0a65`](https://github.com/vadorovsky/aya/commit/42e0a659b2f82cca537d70f906e0a475f0ab6b03))
    - Fix some badly completed match arms ([`d3482c0`](https://github.com/vadorovsky/aya/commit/d3482c063ca888a6465f3e8866d5d3de93cbbd99))
    - Fix verifier log handling ([`ee05f9d`](https://github.com/vadorovsky/aya/commit/ee05f9d9497ea83ee9cfffbaa0d1b87d9d57c26e))
    - Add support for function calls ([`92b4ed2`](https://github.com/vadorovsky/aya/commit/92b4ed2664264b4af36b29c7b08d13505eae9b08))
    - Section: collecting relocations can't fail anymore ([`8b0eee3`](https://github.com/vadorovsky/aya/commit/8b0eee317d71f0139ec030b1f0583edf8670c296))
    - Obj: rename symbol_table to symbols_by_index ([`318c16c`](https://github.com/vadorovsky/aya/commit/318c16cea32731613339d22fad11a29be8d79976))
    - Add Program::name() and make ::prog_type() public ([`286e117`](https://github.com/vadorovsky/aya/commit/286e117fe0bab8542f2e1d5fd309562689d88c00))
    - Bpf: Add Bpf::programs() ([`0199e4b`](https://github.com/vadorovsky/aya/commit/0199e4b29704df4cebf65d3d5f09ab1af6982cbd))
    - Bpf: remove lifetime param from previous signature ([`dcb5121`](https://github.com/vadorovsky/aya/commit/dcb5121985113e1b90a5e50a43d71b4f00826ebe))
    - Maps: add Map::name() and Map::map_type() ([`ed53f74`](https://github.com/vadorovsky/aya/commit/ed53f7470b386f3a870e34399bbb52c6ea72d07d))
    - Add Bpf::maps() to get all the maps ([`0a493ba`](https://github.com/vadorovsky/aya/commit/0a493baed6b4d020ed7d5d87191d912662eb2159))
    - Switch to rustified enums ([`29f2d9b`](https://github.com/vadorovsky/aya/commit/29f2d9b2d9e4265d0d0d2f13c314ef27d5c4ebcf))
    - Generate code with xtask ([`59ed237`](https://github.com/vadorovsky/aya/commit/59ed237343c16ba0b96f917991a7ec2f971ecd5d))
    - Xdp BPF_LINK_CREATE was added in 5.9 ([`8327ffb`](https://github.com/vadorovsky/aya/commit/8327ffbb8d77e39046f851ca0f38ed153e140715))
    - Obj: implement sane defaults for license and kernel version ([`1e779c5`](https://github.com/vadorovsky/aya/commit/1e779c520a90daa642a67cf3b986536aa50ad5ef))
    - Implement missing bit of retprobes ([`f11df77`](https://github.com/vadorovsky/aya/commit/f11df77f859feee2a88a69b96da4a1a22839c45a))
    - Sys: fix warning ([`b7369d2`](https://github.com/vadorovsky/aya/commit/b7369d2763fe8c7061071986c41d1bcb0682f5a7))
    - Rename gen-bindings to gen-bindings.sh ([`82bcef3`](https://github.com/vadorovsky/aya/commit/82bcef37906472e7a32fa602cf26a97387590057))
    - Tweak error display ([`245cd46`](https://github.com/vadorovsky/aya/commit/245cd46baba5e1b532c7bf8b3eb732ab398bb529))
    - Fix build with musl ([`3e8a279`](https://github.com/vadorovsky/aya/commit/3e8a279a5910badd4720c06f2a046e47e6a6f657))
    - Support max_entries=0 ([`68a633f`](https://github.com/vadorovsky/aya/commit/68a633fe51299ab6feaea370fd7b86740d284731))
    - Add possible_cpus() ([`f56c32b`](https://github.com/vadorovsky/aya/commit/f56c32b46bdd4c634b1ce6136ecab3c88d202040))
    - Format fixes ([`a3ab2ef`](https://github.com/vadorovsky/aya/commit/a3ab2eff57c55faf323d9663e9198851abdc3e2f))
    - Enable only the std feature for the futures crate ([`0cf5d17`](https://github.com/vadorovsky/aya/commit/0cf5d17e383d240a27d463c89bec5d3a19854e4f))
    - Fix RawFd import paths ([`3abe9bb`](https://github.com/vadorovsky/aya/commit/3abe9bb859320063484c5d222f8322bf8392fec2))
    - Add explicit BTF argument to the load API ([`2cec04c`](https://github.com/vadorovsky/aya/commit/2cec04c5781bc7b03c601dbb0cb1c23f3df22385))
    - Add support for attaching with custom xdp flags ([`55d8bcf`](https://github.com/vadorovsky/aya/commit/55d8bcf3860d2cf5db7f59b8b5caaa32de6e668d))
    - Rework ProgramError a bit ([`d326038`](https://github.com/vadorovsky/aya/commit/d326038cf4b0a6fe7966de038054966bf3016380))
    - Add internal API to create links ([`f88ca1f`](https://github.com/vadorovsky/aya/commit/f88ca1f1f1449db1a4a323a67edf0ac5a4878ee1))
    - Fail new() for high level wrappers if the underlying map hasn't been created ([`ba992a2`](https://github.com/vadorovsky/aya/commit/ba992a2414430387737e76db2e10b04c98f56847))
    - Trim deps a bit more ([`873691d`](https://github.com/vadorovsky/aya/commit/873691d050e5156c9f4fb271d6b13a25d0952564))
    - The futures crate is only needed when async is enabled ([`f1da541`](https://github.com/vadorovsky/aya/commit/f1da5412342e6839e80555912f08a13a9e3a976c))
    - Remove unused methods ([`14c9845`](https://github.com/vadorovsky/aya/commit/14c98455a940d6cead424b7e30a62845c256ae26))
    - Fix warnings ([`a5e19fc`](https://github.com/vadorovsky/aya/commit/a5e19fc4ac3cd53ca8f1d1d43fbc0dfa08aa8d55))
    - Add AsyncPerfMap ([`fdc4dad`](https://github.com/vadorovsky/aya/commit/fdc4dad5ff88a419d982f67568f5271c69e73f0a))
    - Split in sub modules ([`4be0c45`](https://github.com/vadorovsky/aya/commit/4be0c45305f0b0c639bfb6b645848fd4e1e0774f))
    - Implement AsRawFd ([`95a24c6`](https://github.com/vadorovsky/aya/commit/95a24c6f8b2483f05afabb0b3afaacfea4ebe061))
    - Add IOError variants to PerfMapError and PerfBufferError ([`5d6fe8b`](https://github.com/vadorovsky/aya/commit/5d6fe8bdf4f31bbb694b83c83127cf9f598f3716))
    - Make aya::maps::perf_map public ([`b9be2f1`](https://github.com/vadorovsky/aya/commit/b9be2f1a9b61631df0189b40881b778e9e278e43))
    - Change the suffix of errors from *Failed to *Error ([`160e0be`](https://github.com/vadorovsky/aya/commit/160e0be6d6aec27a31c6108810fc4853f25f6a53))
    - Bpf, perf_map: make maps usable from multiple threads ([`d4e2825`](https://github.com/vadorovsky/aya/commit/d4e282535b9a780006786758a4b91856b401ac77))
    - Make online_cpus() util public ([`d7c91ef`](https://github.com/vadorovsky/aya/commit/d7c91efb2deb77f1a76489375888d01b27f0e710))
    - Generate arch  specific bindings ([`2215e20`](https://github.com/vadorovsky/aya/commit/2215e202f431fc25449541fcbbdb65ff096f3132))
    - Add src/generated/netlink_bindings.rs to repo ([`1de3929`](https://github.com/vadorovsky/aya/commit/1de392964b8f447615579d231a36e3bb9260b027))
    - Turn the project into a workspace, move code under aya/ ([`af8f769`](https://github.com/vadorovsky/aya/commit/af8f769b509e4a002c3bd3138fe745ae962de2db))
</details>
